...
import { t as f } from "./channel-Sh0HKanG.js";
import { H as p, c as m, h, i as g } from "./chunk-S3R3BYOJ-qZRxmO84.js";
import { t as _ } from "./line-xAZ3WWpC.js";
import { t as v } from "./chunk-HN2XXSSU-C17-XOpQ.js";
import { t as y } from "./chunk-CVBHYZKI-pVtBnPKQ.js";
import { a as b, n as x } from "./chunk-JA3XYJ7Z-ByUEKWPH.js";
import { t as S } from "./chunk-FMBD7UC4-DPlkUf_Q.js";
import { t as C } from "./graphlib-BolwGYrB.js";
import { t as w } from "./clone-Bf-ZG9ye.js";
var T = (function () {
...
var E = T,
  ...
  te = o(),
  N = new Map(),
  ne = t((e) => u.sanitizeText(e, te), `sanitizeText`),
  re = t(function (e, t = ``) {
    let n = N.get(e);
  ...
  ae = t(function (e, t) {
    e.split(`,`).forEach(function (e) {
      ...
      if (n === void 0) {
        let t = e.trim();
        ((n = { id: t, type: `na`, children: [] }), D.set(t, n));
      }
...
var de = 0,
  fe = {
    getConfig: t(() => d().block, `getConfig`),
    typeStr2Type: ce,
    edgeTypeStr2Type: le,
    edgeStrToEdgeData: ue,
    getLogger: t(() => e, `getLogger`),
    getBlocksFlat: t(() => [...D.values()], `getBlocksFlat`),
    getBlocks: t(() => P || [], `getBlocks`),
    getEdges: t(() => O, `getEdges`),
    setHierarchy: t((e) => {
      ((F.children = e), oe(e, F), (P = F.children));
    }, `setHierarchy`),
    getBlock: t((e) => D.get(e), `getBlock`),
    setBlock: t((e) => {
      D.set(e.id, e);
    }, `setBlock`),
    getColumns: t((e) => {
  ...
  .labelBkg {
    background-color: ${I(e.edgeLabelBackground, 0.5)};
    // background-color:
  }

  .node .cluster {
    // fill: ${I(e.mainBkg, 0.5)};
    fill: ${I(e.clusterBkg, 0.5)};
    stroke: ${I(e.clusterBorder, 0.2)};
...
var ve = t((t) => {
  ...
  for (let i of t.children) {
    ...
    (e.debug(
      ...
      i.type !== `space` &&
        (a > n && (n = a / (t.widthInColumns ?? 1)), o > r && (r = o)));
  }
  ...
  if (t.children?.length > 0) {
    ...
    for (let n of t.children)
      n.size &&
        ...
        (n.size.width =
          a * (n.widthInColumns ?? 1) + L * ((n.widthInColumns ?? 1) - 1)),
        (n.size.height = o),
        (n.size.x = 0),
        (n.size.y = 0),
        e.debug(
    ...
    if (f < r) {
      ...
      (e.debug(`Size indata abc88`, t.id, `childWidth`, n, `maxWidth`, a),
        ...
        e.debug(`Size indata abc88 xSize`, u, `padding`, L));
...
function z(t, n) {
  ...
  if (
    ...
    let i = t?.children[0]?.size?.width ?? 0,
      a = t.children.length * i + (t.children.length - 1) * L;
    e.debug(`widthOfChildren 88`, a, `posX`);
    let o = 0;
    e.debug(`abc91 block?.size?.x`, t.id, t?.size?.x);
    let s = t?.size?.x ? t?.size?.x + (-t?.size?.width / 2 || 0) : -L,
      c = 0;
    for (let i of t.children) {
      let a = t;
      if (!i.size) continue;
      let { width: l, height: u } = i.size,
        { px: d, py: f } = _e(r, o);
      if (
        (f != c &&
          ((c = f),
          (s = t?.size?.x ? t?.size?.x + (-t?.size?.width / 2 || 0) : -L),
          e.debug(`New row in layout for block`, t.id, ` and child `, i.id, c)),
        e.debug(
          `abc89 layout blocks (child) id: ${i.id} Pos: ${o} (px, py) ${d},${f} (${a?.size?.x},${a?.size?.y}) parent: ${a.id} width: ${l}${L}`,
        ),
        a.size)
      ) {
        let t = l / 2;
        ((i.size.x = s + L + t),
          e.debug(
            `abc91 layout blocks (calc) px, pyid:${i.id} startingPos=X${s} new startingPosX${i.size.x} ${t} padding=${L} width=${l} halfWidth=${t} => x:${i.size.x} y:${i.size.y} ${i.widthInColumns} (width * (child?.w || 1)) / 2 ${(l * (i?.widthInColumns ?? 1)) / 2}`,
          ),
          (s = i.size.x + t),
          (i.size.y = a.size.y - a.size.height / 2 + f * (u + L) + u / 2 + L),
          e.debug(
            `abc88 layout blocks (calc) px, pyid:${i.id}startingPosX${s}${L}${t}=>x:${i.size.x}y:${i.size.y}${i.widthInColumns}(width * (child?.w || 1)) / 2${(l * (i?.widthInColumns ?? 1)) / 2}`,
          ));
      }
      i.children && z(i, n);
      let p = i?.widthInColumns ?? 1;
      (r > 0 && (p = Math.min(p, r - (o % r))),
        (o += p),
        e.debug(`abc88 columnsPos`, i, o));
    }
  }
  e.debug(
...
t(be, `addHtmlLabel`);
var H = t(async (t, n, r, i) => {
    let a = t || ``;
    typeof a == `object` && (a = a[0]);
    let s = o();
    if (l(s.flowchart.htmlLabels))
      return (
        (a = a.replace(/\\n|\n/g, `<br />`)),
        e.debug(`vertexText` + a),
        be(
          {
            isNode: i,
            label: await b(g(a)),
  ...
  we = t(async (e, t) => {
    let r = o(),
      i = l(r.flowchart.htmlLabels),
      a =
        t.labelType === `markdown`
          ? x(
              e,
              t.label,
              { style: t.labelStyle, useHtmlLabels: i, addSvgBackground: !0 },
              r,
            )
          : await H(t.label, t.labelStyle),
      s = e.insert(`g`).attr(`class`, `edgeLabel`),
      c = s.insert(`g`).attr(`class`, `label`);
    ...
    if (t.startLabelLeft) {
      ...
      (i.attr(
        ...
        W[t.id] || (W[t.id] = {}),
        (W[t.id].startLeft = r),
        G(d, t.startLabelLeft));
    }
    if (t.startLabelRight) {
      let n = await H(t.startLabelRight, t.labelStyle),
        r = e.insert(`g`).attr(`class`, `edgeTerminals`),
        i = r.insert(`g`).attr(`class`, `inner`);
      ...
      (i.attr(
        ...
        W[t.id] || (W[t.id] = {}),
        (W[t.id].startRight = r),
        G(d, t.startLabelRight));
    }
    if (t.endLabelLeft) {
      let n = await H(t.endLabelLeft, t.labelStyle),
        r = e.insert(`g`).attr(`class`, `edgeTerminals`),
        i = r.insert(`g`).attr(`class`, `inner`);
      d = i.node().appendChild(n);
      let a = n.getBBox();
    ...
    if (t.endLabelRight) {
      let n = await H(t.endLabelRight, t.labelStyle),
        r = e.insert(`g`).attr(`class`, `edgeTerminals`),
        i = r.insert(`g`).attr(`class`, `inner`);
      d = i.node().appendChild(n);
      let a = n.getBBox();
...
var Te = t((t, n) => {
    ...
    let r = n.updatedPath ? n.updatedPath : n.originalPath,
      { subGraphTitleTotalMargin: i } = y(o());
    if (t.label) {
      let a = U[t.id],
        o = t.x,
        s = t.y;
    ...
    if (t.startLabelLeft) {
      let e = W[t.id].startLeft,
        n = t.x,
        i = t.y;
      if (r) {
        let e = h.calcTerminalLabelPosition(
  ...
  ke = t(function (t, n, i, a, s, c, l) {
    ...
    (m?.intersect &&
      ...
      i.toCluster &&
        ...
        (u = Oe(i.points, a[i.toCluster].node)),
        (d = !0)),
      i.fromCluster &&
        (e.debug(`from cluster abc88`, a[i.fromCluster]),
        (u = Oe(u.reverse(), a[i.fromCluster].node).reverse()),
        (d = !0)));
    let h = u.filter((e) => !Number.isNaN(e.y)),
      g = p;
    ...
    let C = t
        ...
        .attr(`style`, i.style),
      w = ``;
    ((o().flowchart.arrowMarkerAbsolute || o().state.arrowMarkerAbsolute) &&
      (w = r(!0)),
      xe(C, i, w, l, s));
    let T = {};
...
var K = {
  ...
  q = t(async (e, r, a, s) => {
    let c = o(),
      u,
      d = r.useHtmlLabels || l(c.flowchart.htmlLabels);
    u = a || `node default`;
    let f = e
        .insert(`g`)
        .attr(`class`, u)
        .attr(`id`, r.domId || r.id),
      p = f.insert(`g`).attr(`class`, `label`).attr(`style`, r.labelStyle),
      m;
    m =
      r.labelText === void 0
        ? ``
        : typeof r.labelText == `string`
          ? r.labelText
          : r.labelText[0];
    let h = p.node(),
      _;
    _ =
      r.labelType === `markdown`
        ...
        : h.appendChild(await H(i(g(m), c), r.labelStyle, !1, s));
    let v = _.getBBox(),
      y = r.padding / 2;
    ...
    return (
      d
        ...
        : p.attr(`transform`, `translate(0, ` + -v.height / 2 + `)`),
      r.centerLabel &&
        p.attr(
          `transform`,
          `translate(` + -v.width / 2 + `, ` + -v.height / 2 + `)`,
      ...
      { shapeSvg: f, bbox: v, halfPadding: y, label: p }
    );
  }, `labelHelper`),
  J = t((e, t) => {
...
var at = t(async (t, r) => {
    ...
    let a = t
      ...
      c = a.insert(`line`),
      u = a.insert(`g`).attr(`class`, `label`),
      d = r.labelText.flat ? r.labelText.flat() : r.labelText,
      f = ``;
    ((f = typeof d == `object` ? d[0] : d),
      e.info(`Label text abc79`, f, d, typeof d == `object`));
    let p = u.node().appendChild(await H(f, r.labelStyle, !0, !0)),
      m = { width: 0, height: 0 };
    ...
    e.info(`Text 2`, d);
    let h = d.slice(1, d.length),
      g = p.getBBox(),
      _ = u
        .node()
        .appendChild(
          await H(h.join ? h.join(`<br/>`) : h, r.labelStyle, !0, !0),
        );
    if (l(o().flowchart.htmlLabels)) {
      let e = _.children[0],
        t = n(_);
    ...
    return (
      n(_).attr(
        `transform`,
        `translate( ` +
          (m.width > g.width ? 0 : (g.width - m.width) / 2) +
          `, ` +
          (g.height + v + 5) +
          `)`,
      ),
      ...
      u.attr(
        `transform`,
        `translate(` + -m.width / 2 + `, ` + (-m.height / 2 - v + 3) + `)`,
      ),
      s
        .attr(`class`, `outer title-state`)
        .attr(`x`, -m.width / 2 - v)
        .attr(`y`, -m.height / 2 - v)
        .attr(`width`, m.width + r.padding)
        .attr(`height`, m.height + r.padding),
      c
        .attr(`class`, `divider`)
        .attr(`x1`, -m.width / 2 - v)
        .attr(`x2`, m.width / 2 + v)
        .attr(`y1`, -m.height / 2 - v + g.height + v)
        .attr(`y2`, -m.height / 2 - v + g.height + v),
      J(r, s),
    ...
    class_box: t(async (e, t) => {
      ...
      let a = e
        ...
        g = t.classData.annotations[0]
          ...
          : ``,
        _ = p.node().appendChild(await H(g, t.labelStyle, !0, !0)),
        v = _.getBBox();
      if (l(o().flowchart.htmlLabels)) {
        let e = _.children[0],
          t = n(_);
      ...
      (t.classData.members.forEach(async (e) => {
        ...
        let a = p
            .node()
            .appendChild(
              await H(i, r.cssStyle ? r.cssStyle : t.labelStyle, !0, !0),
            ),
          s = a.getBBox();
        if (l(o().flowchart.htmlLabels)) {
          let e = a.children[0],
...
async function _t(e, t, n) {
  ...
  n.getBlock(r.id).type !== `space` &&
    (await pt(e, r, { config: d() }), (t.intersect = r?.intersect), mt(r));
}
...
async function bt(e, t, n, r, i) {
  let a = new C({ multigraph: !0, compound: !0 });
  a.setGraph({
    rankdir: `TB`,
    nodesep: 10,
    ranksep: 10,
      ...
      if (t?.size && o?.size) {
        ...
        (ke(
          ...
          n.label &&
            ...
            Te({ ...n, x: c[1].x, y: c[1].y }, { originalPath: c })));
      }
    }
}
t(bt, `insertEdges`);
var xt = {
  ...
  renderer: {
    draw: t(async function (t, r, i, a) {
      let { securityLevel: o, block: c } = d(),
        l = a.db,
        u;
      o === `sandbox` && (u = n(`#i` + r));
      let f = n(o === `sandbox` ? u.nodes()[0].contentDocument.body : `body`),
        p = o === `sandbox` ? f.select(`[id="${r}"]`) : n(`[id="${r}"]`);
      ge(p, [`point`, `circle`, `cross`], a.type, r);
      let m = l.getBlocks(),
        h = l.getBlocksFlat(),
        g = l.getEdges(),
        _ = p.insert(`g`).attr(`class`, `block`);
      await vt(_, m, l);
      let v = ye(l);
