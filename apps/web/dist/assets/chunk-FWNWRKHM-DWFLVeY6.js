import {
  ...
  s,
  t as c,
} from "./chunk-FPAJGGOC-Ccs3hkso.js";
var l = class extends c {
    static {
      t(this, `TreemapTokenBuilder`);
    }
    constructor() {
      super([`treemap`]);
    }
...
var p = class {
  ...
  m = {
    parser: {
      TokenBuilder: t(() => new l(), `TokenBuilder`),
      ValueConverter: t(() => new d(), `ValueConverter`),
    },
    validation: { TreemapValidator: t(() => new p(), `TreemapValidator`) },
  };
function h(t = o) {
  let a = i(n(t), s),
    c = i(r({ shared: a }), e, m);
  return (a.ServiceRegistry.register(c), f(c), { shared: a, Treemap: c });
}
