...
import { a as C, i as w, n as T, r as E, t as D } from "./linear-CavJTP_n.js";
import { t as O } from "./init-6zo3nO5-.js";
import { h as k } from "./chunk-S3R3BYOJ-qZRxmO84.js";
import { t as ee } from "./dist-sj4ly5hH.js";
function A(e, t) {
  let n;
  if (t === void 0)
    for (let t of e)
...
function pe(e, t) {
  ...
  function f(f) {
    var p = r ?? (t.ticks ? t.ticks.apply(t, n) : t.domain()),
      m = i ?? (t.tickFormat ? t.tickFormat.apply(t, n) : ne),
      h = Math.max(a, 0) + s,
      g = t.range(),
      _ = +g[0] + c,
      v = +g[g.length - 1] + c,
      y = (t.bandwidth ? de : ue)(t.copy(), c),
    ...
    ((x = x.merge(
      ...
      (E = E.merge(
        w
          ...
          .attr(u, l * h)
          .attr(`dy`, e === re ? `0em` : e === ae ? `0.71em` : `0.32em`),
      )),
      f !== b &&
        ((x = x.transition(f)),
        (S = S.transition(f)),
      ...
      b
        ...
        .attr(`text-anchor`, e === ie ? `start` : e === oe ? `end` : `middle`),
      b.each(function () {
        this.__axis = y;
      }));
  }
...
function Ee(e) {
  ...
  var t = je(e.r),
    n = je(e.g),
    i = je(e.b),
    a = Oe((0.2225045 * t + 0.7168786 * n + 0.0606169 * i) / be),
    o,
    s;
  return (
    t === n && n === i
      ? (o = s = a)
      : ((o = Oe((0.4360747 * t + 0.3850649 * n + 0.1430804 * i) / ye)),
        (s = Oe((0.0139322 * t + 0.0971045 * n + 0.7141733 * i) / xe))),
    new j(116 * a - 16, 500 * (o - a), 200 * (a - s), e.opacity)
  );
}
function De(e, t, n, r) {
  ...
  a(u, {
    ...
    rgb() {
      ...
      return (
        ...
        (n = xe * ke(n)),
        new r(
          Ae(3.1338561 * t - 1.6168667 * e - 0.4906146 * n),
          Ae(-0.9787684 * t + 1.9161415 * e + 0.033454 * n),
          Ae(0.0719453 * t - 0.2289914 * e + 1.4052427 * n),
          this.opacity,
        )
      );
    },
...
function Me(e) {
  ...
  if ((e instanceof j || (e = Ee(e)), e.a === 0 && e.b === 0))
...
function Fe(e) {
  return function (t, r) {
    var i = e((t = Ne(t)).h, (r = Ne(r)).h),
      a = n(t.c, r.c),
      o = n(t.l, r.l),
      s = n(t.opacity, r.opacity);
    return function (e) {
      return (
        (t.h = i(e)),
        (t.c = a(e)),
...
function V(e) {
  return N(
    ...
    (e, t) =>
      (t - e - (t.getTimezoneOffset() - e.getTimezoneOffset()) * I) / Be,
  );
}
var Ye = V(0),
  Xe = V(1),
...
var [ut, dt] = lt(K, ct, tt, Je, Ke, We),
  [ft, pt] = lt(G, st, Ye, B, Ge, Ue);
function mt(e) {
  if (0 <= e.y && e.y < 100) {
      ...
      if (
        ...
        (`w` in r || (r.w = 1),
          `Z` in r
            ? ((a = ht(gt(r.y, 0, 1))),
              (o = a.getUTCDay()),
              (a = o > 4 || o === 0 ? nt.ceil(a) : nt(a)),
              (a = qe.offset(a, (r.V - 1) * 7)),
              (r.y = a.getUTCFullYear()),
              (r.m = a.getUTCMonth()),
              (r.d = a.getUTCDate() + ((r.w + 6) % 7)))
            : ((a = mt(gt(r.y, 0, 1))),
              (o = a.getDay()),
              (a = o > 4 || o === 0 ? Xe.ceil(a) : Xe(a)),
        ...
        (`W` in r || `U` in r) &&
          ...
          (o =
            `Z` in r
              ? ht(gt(r.y, 0, 1)).getUTCDay()
              : mt(gt(r.y, 0, 1)).getDay()),
          (r.m = 0),
          (r.d =
            `W` in r
              ? ((r.w + 6) % 7) + r.W * 7 - ((o + 5) % 7)
              : r.w + r.U * 7 - ((o + 6) % 7)));
      return `Z` in r
        ? ((r.H += (r.Z / 100) | 0), (r.M += r.Z % 100), ht(r))
        : mt(r);
    };
  }
  function w(e, t, n, r) {
...
function Bn() {
  return O.apply(
    zn(ft, pt, G, st, Ye, B, Ge, Ue, z, Fn).domain([
      new Date(2e3, 0, 1),
      new Date(2e3, 0, 2),
    ]),
    arguments,
            ...
            switch (T[0]) {
              ...
              case 2:
                ...
                (k &&
                  ...
                  i.push(D.$),
                  a.push(D._$),
                  (ee = o[n[n.length - 2]][n[n.length - 1]]),
                  n.push(ee));
                break;
              case 3:
                return !0;
...
Xn.parser = Xn;
var Zn = Xn;
(Y.default.extend(Kn.default),
  Y.default.extend(qn.default),
  Y.default.extend(Jn.default));
var Qn = { friday: 5, saturday: 6 },
  X = ``,
  $n = ``,
  er = void 0,
  tr = ``,
  ...
  sr = ``,
  cr = ``,
  lr = [`active`, `done`, `crit`, `milestone`, `vert`],
  ur = [],
  dr = !1,
  fr = !1,
  pr = `sunday`,
  ...
  Xr = s(function (e, t) {
    ...
    return (
      a &&
        ((i.endTime = qr(i.startTime, X, a, dr)),
  ...
  ni = s(function (e, t) {
    let n = { section: sr, type: sr, description: e, task: e, classes: [] },
      r = Xr(Qr, t);
    ...
    let e = s(function (e) {
        ...
        switch (Z[e].raw.startTime.type) {
          case `prevTaskEnd`:
            ...
            break;
          case `getStartDate`:
            ((n = Gr(void 0, X, Z[e].raw.startTime.startData)),
              n && (Z[e].startTime = n));
            break;
        }
        return (
          Z[e].startTime &&
            ((Z[e].endTime = qr(Z[e].startTime, X, Z[e].raw.endTime.data, dr)),
            Z[e].endTime &&
              ((Z[e].processed = !0),
  ...
  ii = s(function (e, t) {
    let n = t;
    (v().securityLevel !== `loose` && (n = (0, Gn.sanitizeUrl)(t)),
  ...
  ci = {
    ...
    setExcludes: Nr,
    getExcludes: Pr,
    setClickEvent: s(function (e, t, n) {
      (e.split(`,`).forEach(function (e) {
        oi(e, t, n);
      }),
        ai(e, `clickable`));
...
var ui = s(function () {
  ...
  mi = {
    ...
    renderer: {
      setConf: ui,
      draw: s(function (e, t, n, r) {
        let i = v().gantt,
          a = v().securityLevel,
          c;
        a === `sandbox` && (c = l(`#i` + t));
        let u = l(a === `sandbox` ? c.nodes()[0].contentDocument.body : `body`),
          d = a === `sandbox` ? c.nodes()[0].contentDocument : document,
          f = d.getElementById(t);
        (($ = f.parentElement.offsetWidth),
          $ === void 0 && ($ = 1200),
          i.useWidth !== void 0 && ($ = i.useWidth));
        let p = r.db.getTasks(),
          m = [];
        ...
        function C(e, t, n) {
          let a = i.barHeight,
            ...
            l = D()
              ...
              .range([`#00B9FA`, `#F95002`])
              .interpolate(Ie);
          (T(o, s, c, t, n, e, r.db.getExcludes(), r.db.getIncludes()),
            O(c, s, t, n),
            w(e, o, s, c, a, l, t, n),
            k(o, s, c, a, l),
            ee(c, s, t, n));
          ...
          _.append(`g`)
            ...
            .attr(`class`, function (e) {
              for (let [t, n] of m.entries())
                if (e.type === n)
                  return `section section` + (t % i.numberSectionStyles);
              return `section section0`;
            })
            .enter();
          let f = _.append(`g`).selectAll(`rect`).data(e).enter(),
            h = r.db.getLinks();
          if (
            (f
              .append(`rect`)
              ...
              .attr(`y`, function (e, t) {
                return (
                  (t = e.order),
                  e.vert ? i.gridLineStartPadding : t * n + a
                );
              })
              ...
              .attr(`height`, function (e) {
                return e.vert
                  ? p.length * (i.barHeight + i.barGap) + i.barHeight * 2
                  : s;
              })
              ...
              .attr(`class`, function (e) {
                ...
                let n = 0;
                for (let [t, r] of m.entries())
                  e.type === r && (n = t % i.numberSectionStyles);
                let r = ``;
                return (
                  e.active
                    ? e.crit
            ...
            f
              ...
              .attr(`x`, function (e) {
                ...
                if (
                  ...
                  return x(e.startTime) + o;
                let r = this.getBBox().width;
                return r > n - t
                  ? n + r + 1.5 * i.leftPadding > u
                    ? t + o - 5
                    : n + o + 5
                  : (n - t) / 2 + t + o;
              })
              .attr(`y`, function (e, t) {
                return e.vert
                  ? i.gridLineStartPadding +
                      p.length * (i.barHeight + i.barGap) +
                      60
                  : ((t = e.order),
                    t * n + i.barHeight / 2 + (i.fontSize / 2 - 2) + a);
              })
              .attr(`text-height`, s)
              .attr(`class`, function (e) {
                let t = x(e.startTime),
                ...
                let o = 0;
                for (let [t, n] of m.entries())
                  e.type === n && (o = t % i.numberSectionStyles);
                let c = ``;
                return (
                  e.active &&
                  ...
                  r > n - t
                    ? n + r + 1.5 * i.leftPadding > u
                      ? a + ` taskTextOutsideLeft taskTextOutside` + o + ` ` + c
                      : a +
                        ...
                        ` width-` +
                        r
                    : a + ` taskText taskText` + o + ` ` + c + ` width-` + r
                );
              }),
            ...
            f.filter(function (e) {
              ...
              (a.setAttribute(`xlink:href`, h.get(e.id)),
        ...
        function T(e, t, n, a, s, c, l, u) {
          ...
          let p = r.db.getDateFormat(),
            m = [],
            h = null,
            g = (0, Y.default)(d);
          for (; g.valueOf() <= f; )
            (r.db.isInvalidDate(g, p, l, u)
              ? h
                ? (h.end = g)
                : (h = { start: g, end: g })
              : (h &&= (m.push(h), null)),
          ...
          _.append(`g`)
            ...
            .attr(`x`, (e) => x(e.start.startOf(`day`)) + n)
            .attr(`y`, i.gridLineStartPadding)
            .attr(
              `width`,
              (e) => x(e.end.endOf(`day`)) - x(e.start.startOf(`day`)),
            )
            .attr(`height`, s - t - i.gridLineStartPadding)
            .attr(`transform-origin`, function (t, r) {
              return (
                (x(t.start) + n + 0.5 * (x(t.end) - x(t.start))).toString() +
                `px ` +
                (r * e + 0.5 * s).toString() +
                `px`
              );
        ...
        function O(e, t, n, a) {
          let s = r.db.getDateFormat(),
            c = r.db.getAxisFormat(),
            l;
          l = c || (s === `D` ? `%d` : (i.axisFormat ?? `%Y-%m-%d`));
          let u = he(x)
              .tickSize(-a + t + i.gridLineStartPadding)
              .tickFormat(Fn(l)),
            d =
          ...
          if (d !== null) {
            ...
            if (isNaN(e) || e <= 0)
              ...
              if (l > pi)
                o.warn(
                  `The tick interval "${e}${t}" would generate ${l} ticks, which exceeds the maximum allowed (${pi}). This may indicate an invalid date or time range. Skipping custom tick interval.`,
                );
              else
                switch (t) {
                  case `millisecond`:
          ...
          if (
            (_.append(`g`)
              .attr(`class`, `grid`)
              .attr(`transform`, `translate(` + e + `, ` + (a - 50) + `)`)
              .call(u)
              .selectAll(`text`)
        ...
        function k(e, t) {
          let n = 0,
            r = Object.keys(h).map((e) => [e, h[e]]);
          _.append(`g`)
            .selectAll(`text`)
            .data(r)
            .enter()
            .append(function (e) {
              let t = e[0].split(b.lineBreakRegex),
                n = -(t.length - 1) / 2,
                r = d.createElementNS(`http://www.w3.org/2000/svg`, `text`);
              r.setAttribute(`dy`, n + `em`);
              for (let [e, n] of t.entries()) {
                let t = d.createElementNS(
            ...
            .attr(`class`, function (e) {
              for (let [t, n] of m.entries())
                if (e[0] === n)
                  return (
                    `sectionTitle sectionTitle` + (t % i.numberSectionStyles)
                  );
              return `sectionTitle`;
            });
        }
        ...
        function ee(e, t, n, a) {
          ...
          if (o === `off`) return;
          let s = _.append(`g`).attr(`class`, `today`),
            c = new Date(),
            l = s.append(`line`);
          (l
            .attr(`x1`, x(c) + e)
