      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <button
            ...
            className="relative flex size-11 items-center justify-center rounded-lg border border-transparent opacity-75 transition-colors motion-press active:scale-[0.96] hover:bg-sidebar-accent/50 hover:opacity-100 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-sidebar-ring/35"
          >
            <UserInitials
              user={{ fullName: name }}
              hideLastSeen
