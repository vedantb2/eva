...
function MainContent({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    >
      <div className="h-full overflow-hidden bg-background lg:m-3 lg:ml-0 lg:rounded-2xl lg:border lg:border-border/50 lg:bg-card lg:shadow-xs lg:backdrop-blur-sm">
        {children}
      </div>
    </div>
  );
