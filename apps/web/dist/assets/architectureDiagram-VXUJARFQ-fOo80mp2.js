...
import { g as n, h as r, p as i } from "./src-BAB06iur.js";
import {
  B as a,
  C as o,
  G as s,
...
import { r as _, s as v } from "./chunk-S3R3BYOJ-qZRxmO84.js";
import { t as y } from "./chunk-EXTU4WIE-B-MXTPDr.js";
import { i as b, n as x, o as S, r as C } from "./chunk-JA3XYJ7Z-ByUEKWPH.js";
import { t as w } from "./chunk-4BX2VUAB-CnQ3oZnC.js";
import { t as T } from "./mermaid-parser.core-Cg-_l7W8.js";
import { t as E } from "./cytoscape.esm-CVrJG8E_.js";
var D = t((e, t) => {
    (function (n, r) {
  ...
  re = r((e) => e.data(), `edgeData`),
  U = r((e) => e.data(), `nodeData`),
  W = p.architecture,
  G = class {
    constructor() {
      ((this.nodes = {}),
...
`,
    ...
    await Promise.all(
      t.edges().map(async (t) => {
        let {
          ...
          { x: b, y: S } = t[0].midpoint(),
          { x: C, y: w } = t[0].targetEndpoint(),
          T = r + 4;
        if (
          (u &&
            (F(c) ? (_ += c === `L` ? -T : T) : (y += c === `T` ? -T : T + 18)),
          h &&
            (F(p) ? (C += p === `L` ? -T : T) : (w += p === `T` ? -T : T + 18)),
          !u &&
            n.getNode(i)?.type === `junction` &&
            (F(c) ? (_ += c === `L` ? a : -a) : (y += c === `T` ? a : -a)),
          !h &&
            n.getNode(d)?.type === `junction` &&
            (F(p) ? (C += p === `L` ? a : -a) : (w += p === `T` ? a : -a)),
          ...
          if (
            (t
              .insert(`path`)
              .attr(`d`, `M ${_},${y} L ${b},${S} L${C},${w} `)
              .attr(`class`, `edge`)
              .attr(`id`, v(i, d, { prefix: `L` })),
            l)
          ) {
            let e = F(c) ? M[c](_, o) : _ - s,
              n = I(c) ? M[c](y, o) : y - s;
            t.insert(`polygon`)
              .attr(`points`, j[c](o))
          ...
          if (g) {
            ...
            if (
              ...
              r.attr(`transform`, `translate(` + b + `, ` + S + `)`);
            else if (e === `Y`)
              r.attr(
                `transform`,
                `translate(` + b + `, ` + S + `) rotate(-90)`,
              );
            else if (e === `XY`) {
              let e = B(c, p);
              if (e && R(e)) {
      ...
      t.nodes().map(async (t) => {
        ...
        if (o.type === `group`) {
          ...
          if (o.icon) {
            let e = p.append(`g`);
            (e.html(
              `<g>${await C(o.icon, { height: r, width: r, fallbackPrefix: Y.prefix })}</g>`,
            ),
              e.attr(
                `transform`,
  ...
  oe = r(async function (e, t, n) {
    ...
    for (let i of n) {
      ...
      if (i.icon)
        o.html(
          `<g>${await C(i.icon, { height: a, width: a, fallbackPrefix: Y.prefix })}</g>`,
        );
      else if (i.iconText) {
        o.html(
          `<g>${await C(`blank`, { height: a, width: a, fallbackPrefix: Y.prefix })}</g>`,
        );
        let e = o
            .append(`g`)
