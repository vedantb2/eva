...
function ButtonGroupText({
  ...
  return (
    <Comp
      className={cn(
        "bg-secondary/85 flex items-center gap-2 rounded-lg border border-border/70 px-4 text-sm font-medium [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none",
        className,
      )}
      {...props}
    />
