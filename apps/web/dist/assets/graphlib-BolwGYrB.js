...
import { n as _, t as v } from "./isEmpty-D802w2WA.js";
import {
  C as y,
  E as b,
  S as x,
...
function U(e, r, a, s, l, u) {
  ...
  if (h) {
    ...
    if (g == V || g == z || (v && !l)) {
      if (((d = p || v ? {} : n(e)), !f))
        return p ? pe(e, de(d, e)) : fe(e, ue(d, e));
    } else {
      if (!H[g]) return l ? e : {};
      d = Me(e, g, f);
    }
  ...
  Y = class {
    constructor(e = {}) {
      ((this._isDirected = Object.prototype.hasOwnProperty.call(e, `directed`)
        ...
        (this._isCompound = Object.prototype.hasOwnProperty.call(e, `compound`)
          ...
          : !1),
        (this._label = void 0),
        (this._defaultNodeLabelFn = u(void 0)),
        (this._defaultEdgeLabelFn = u(void 0)),
        (this._nodes = {}),
        this._isCompound &&
          ((this._parent = {}),
          (this._children = {}),
    ...
    setParent(e, t) {
      ...
      if (K(t)) t = q;
        ...
        t += ``;
        for (var n = t; !K(n); n = this.parent(n))
          if (n === e)
            throw Error(
    ...
    edge(e, t, n) {
      var r =
        arguments.length === 1
          ? $(this._isDirected, arguments[0])
          : Q(this._isDirected, e, t, n);
