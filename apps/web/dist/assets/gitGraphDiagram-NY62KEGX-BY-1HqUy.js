...
import { h as m, p as h, r as g } from "./chunk-S3R3BYOJ-qZRxmO84.js";
import { t as _ } from "./chunk-4BX2VUAB-CnQ3oZnC.js";
import { t as te } from "./mermaid-parser.core-Cg-_l7W8.js";
import { t as ne } from "./chunk-QZHKN3VN-eSXZzBEB.js";
var v = { NORMAL: 0, REVERSE: 1, HIGHLIGHT: 2, MERGE: 3, CHERRY_PICK: 4 },
  re = u.gitGraph,
  y = t(() => g({ ...re, ...p().gitGraph }), `getConfig`),
  b = new ne(() => {
    let e = y(),
      t = e.mainBranchName,
      n = e.mainBranchOrder;
...
var ie = t(function (e) {
  ...
  se = t(function (t) {
    ...
    let o = y();
    ((r = d.sanitizeText(r, o)),
      (n = d.sanitizeText(n, o)),
      (a = a?.map((e) => d.sanitizeText(e, o))));
    let s = {
    ...
    ((b.records.head = s),
      ...
      b.records.commits.has(s.id) && e.warn(`Commit ID ${s.id} already exists`),
      b.records.commits.set(s.id, s),
      b.records.branches.set(b.records.currBranch, s.id),
      e.debug(`in pushCommit ` + s.id));
  }, `commit`),
  ce = t(function (t) {
    let n = t.name,
      r = t.order;
    if (((n = d.sanitizeText(n, y())), b.records.branches.has(n)))
      throw Error(
        `Trying to create an existing branch. (Help: Either use a new name if you want create a new branch or try using "checkout ${n}")`,
      );
    (b.records.branches.set(
      n,
      b.records.head == null ? null : b.records.head.id,
    ),
      b.records.branchConfig.set(n, { name: n, order: r }),
      C(n),
  ...
  le = t((t) => {
    ...
    let s = b.records.branches.get(b.records.currBranch),
      c = b.records.branches.get(n),
      l = s ? b.records.commits.get(s) : void 0,
      u = c ? b.records.commits.get(c) : void 0;
    if (l && u && l.branch === n)
    ...
    if (l === void 0 || !l) {
      let e = Error(
        `Incorrect usage of "merge". Current branch (${b.records.currBranch})has no commits`,
      );
      throw (
        (e.hash = {
          text: `merge ${n}`,
    ...
    ((b.records.head = p),
      b.records.commits.set(p.id, p),
      b.records.branches.set(b.records.currBranch, p.id),
      e.debug(b.records.branches),
  ...
  ue = t(function (t) {
    ...
    if (
      ((n = d.sanitizeText(n, o)),
      (r = d.sanitizeText(r, o)),
      (i = i?.map((e) => d.sanitizeText(e, o))),
      (a = d.sanitizeText(a, o)),
      !n || !b.records.commits.has(n))
    ) {
      let e = Error(
    ...
    if (!r || !b.records.commits.has(r)) {
      ...
      if (t === void 0 || !t) {
        let e = Error(
          `Incorrect usage of "cherry-pick". Current branch (${b.records.currBranch})has no commits`,
        );
        throw (
          (e.hash = {
            text: `cherryPick ${n} ${r}`,
      ...
      let l = {
        ...
        tags: i
          ? i.filter(Boolean)
          : [`cherry-pick:${s.id}${s.type === v.MERGE ? `|parent:${a}` : ``}`],
      };
      ((b.records.head = l),
        b.records.commits.set(l.id, l),
        b.records.branches.set(b.records.currBranch, l.id),
        e.debug(b.records.branches),
  ...
  C = t(function (e) {
    if (((e = d.sanitizeText(e, y())), b.records.branches.has(e))) {
      ...
      t === void 0 || !t
        ? (b.records.head = null)
        : (b.records.head = b.records.commits.get(t) ?? null);
    } else {
      let t = Error(
...
function T(t) {
  ...
  let i = [r, n.id, n.seq];
  for (let e in b.records.branches)
    b.records.branches.get(e) === n.id && i.push(e);
  if (
    (e.debug(i.join(` `)),
...
var de = t(function () {
  ...
  pe = t(function () {
    return [...b.records.branchConfig.values()]
      .map((e, t) =>
  ...
  O = t((e, t) => {
    (_(e, t), e.dir && t.setDirection(e.dir));
    for (let n of e.statements) k(n, t);
  }, `populate`),
  k = t((n, r) => {
    let i = {
      Commit: t((e) => r.commit(A(e)), `Commit`),
      Branch: t((e) => r.branch(j(e)), `Branch`),
      Merge: t((e) => r.merge(M(e)), `Merge`),
      Checkout: t((e) => r.checkout(N(e)), `Checkout`),
      CherryPicking: t((e) => r.cherryPick(P(e)), `CherryPicking`),
    }[n.$type];
  ...
  j = t((e) => ({ name: e.name, order: e.order ?? 0 }), `parseBranch`),
  M = t(
    (e) => ({
      branch: e.branch,
      id: e.id ?? ``,
  ...
  ve = t((e, t, n) => {
    ...
    (e.forEach((e) => {
      ...
      (n.parents.length ? ((r = be(n)), (i = Math.max(r, i))) : a.push(n),
        xe(n, r));
    }),
      (r = i),
      a.forEach((e) => {
  ...
  be = t((e) => ye(e) + R, `calculateCommitPosition`),
  xe = t((e, t) => {
  ...
  we = t((e, t, n, r) => {
    if (
      t.type !== v.CHERRY_PICK &&
      ((t.customId && t.type === v.MERGE) || t.type !== v.MERGE) &&
      I?.showCommitLabel
    ) {
      let i = e.append(`g`),
      ...
      if (
        ...
        J === `TB` || J === `BT`
          ? (a.attr(`x`, n.x - (s.width + 4 * z + 5)).attr(`y`, n.y - 12),
            o.attr(`x`, n.x - (s.width + 4 * z)).attr(`y`, n.y + s.height - 12))
    ...
    (J === `BT` && (c && ve(u, n, o), (u = u.reverse())),
      u.forEach((e) => {
        ...
        if (r) {
          ...
          (Ce(i, t, s, e, H.get(t.branch)?.index ?? 0, n),
            we(a, t, s, o),
            Te(a, t, s, o));
        }
        (J === `TB` || J === `BT`
          ? U.set(t.id, { x: s.x, y: s.posWithOffset })
          : U.set(t.id, { x: s.posWithOffset, y: s.y }),
          (o = J === `BT` && c ? o + R : o + R + L),
          o > q && (q = o));
      }));
  }, `drawCommits`),
  ...
  ke = t((e, t, n, r) => {
    ...
    if (o) {
      ((s = `A 10 10, 0, 0, 0,`),
        ...
        (l = 10),
        (u = 10));
      let e = i.y < a.y ? $(i.y, a.y) : $(a.y, i.y),
        n = i.x < a.x ? $(i.x, a.x) : $(a.x, i.x);
      J === `TB`
        ? i.x < a.x
      ...
      ((s = `A 20 20, 0, 0, 0,`),
        ...
        J === `TB`
          ? (i.x < a.x &&
              (f =
                n.type === v.MERGE && t.id !== n.parents[0]
  ...
  je = t((e, t) => {
    ...
    t.forEach((e, t) => {
      ...
      (a.attr(`x1`, 0),
        ...
        J === `TB`
          ? (a.attr(`y1`, W), a.attr(`x1`, i), a.attr(`y2`, q), a.attr(`x2`, i))
          : J === `BT` &&
            (a.attr(`y1`, q),
            a.attr(`x1`, i),
            a.attr(`y2`, W),
      ...
      (c
        ...
        J === `TB`
          ? (c.attr(`x`, i - u.width / 2 - 10).attr(`y`, 0),
            l.attr(`transform`, `translate(` + (i - u.width / 2 - 5) + `, 0)`))
          : J === `BT`
...
`,
        ...
        (l.forEach((e, t) => {
          ...
          a(void 0, u, I.diagramPadding, I.useMaxWidth));
      }, `draw`),
    },
    styles: t(
      (e) => `
