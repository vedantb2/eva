...
>(({ className, children, side = "left", hideCloseButton, ...props }, ref) => (
  <SheetPortal>
    ...
    >
      {children}
      {!hideCloseButton && (
        <DialogPrimitive.Close className="absolute right-3 top-3 inline-flex h-7 w-7 items-center justify-center rounded-md text-muted-foreground transition-colors motion-press active:scale-[0.94] hover:text-foreground focus:outline-hidden focus:ring-2 focus:ring-ring/35 after:absolute after:inset-[-6px]">
