import { g as e, h as t } from "./src-BAB06iur.js";
import { b as n } from "./chunk-ABZYJK2D-BcBvUh_0.js";
import "./chunk-S3R3BYOJ-qZRxmO84.js";
import "./chunk-HN2XXSSU-C17-XOpQ.js";
import { t as r } from "./chunk-CVBHYZKI-pVtBnPKQ.js";
...
import {
  ...
  t as l,
  u,
} from "./chunk-JZLCHNYA-DexENr_S.js";
import {
  a as d,
  i as f,
  n as p,
  r as m,
  t as h,
} from "./chunk-QXUST7PY-B--XlkK4.js";
import { a as g } from "./flatten-CUhNQmdn.js";
import { n as _, t as v } from "./graphlib-BolwGYrB.js";
import { t as y } from "./clone-Bf-ZG9ye.js";
import { t as b } from "./dagre-CF1oBap_.js";
function x(e) {
  var t = {
    options: {
...
var w = new Map(),
  ...
  I = t((t, n) => {
    ...
    for (let i of r)
      if (
        ...
        let a = new v({ multigraph: !0, compound: !0 })
          .setGraph({
            rankdir: r,
            nodesep: 50,
            ranksep: 50,
  ...
  z = t(async (n, c, l, f, h, g) => {
    ...
    (c.nodes()
      ? e.info(`Recursive render XXX`, c.nodes())
      : e.info(`No nodes found for`, c),
      c.edges().length > 0 && e.info(`Recursive edges`, c.edge(c.edges()[0])));
    let y = v.insert(`g`).attr(`class`, `clusters`),
      S = v.insert(`g`).attr(`class`, `edgePaths`),
      C = v.insert(`g`).attr(`class`, `edgeLabels`),
      T = v.insert(`g`).attr(`class`, `nodes`);
    (await Promise.all(
      c.nodes().map(async function (t) {
        let n = c.node(t);
        if (h !== void 0) {
...
Parent cluster`,
            ...
            c.setNode(h.id, n),
            c.parent(t) ||
              (e.trace(`Setting parent`, t, h.id), c.setParent(t, h.id, n)));
        }
        if (
          (e.info(`(Insert) Node XXX` + t + `: ` + JSON.stringify(c.node(t))),
          n?.clusterNode)
        ) {
          e.info(`Cluster identified XBX`, t, n.width, c.node(t));
          let { ranksep: r, nodesep: i } = c.graph();
          n.graph.setGraph({ ...n.graph.graph(), ranksep: r + 25, nodesep: i });
          let a = await z(T, n.graph, l, f, c.node(t), g),
            o = a.elem;
          (u(n, o),
            (n.diff = a.diff || 0),
            e.info(
          ...
          c.children(t).length > 0
            ? (e.trace(
              ...
              e.trace(N(n.id, c)),
              w.set(n.id, { id: N(n.id, c), node: n }))
            : (e.trace(`Node - the non recursive path XAX`, t, T, c.node(t), _),
              await i(T, c.node(t), { config: g, dir: _ }));
      }),
    ),
      await t(async () => {
      ...
      e.info(`Graph before layout:`, JSON.stringify(x(c))),
      e.info(`############################################# XXX`),
      e.info(`###                Layout                 ### XXX`),
      e.info(`############################################# XXX`),
      b(c),
      e.info(`Graph after layout:`, JSON.stringify(x(c))));
    let E = 0,
      { subGraphTitleTotalMargin: D } = r(g);
    return (
      await Promise.all(
        R(c).map(async function (t) {
          let n = c.node(t);
          if (
            (e.info(
              `Position XBX => ` + t + `: (` + n.x,
            ...
            let r = n?.padding / 2 || 0,
              ...
              a = i - r || 0;
            (e.debug(`OffsetY`, a, `labelHeight`, i, `halfPadding`, r),
              await o(y, n),
              (w.get(n.id).node = n));
          } else {
      ...
      c.edges().forEach(function (t) {
        ...
        (e.info(`Edge ` + t.v + ` -> ` + t.w + `: ` + JSON.stringify(n), n),
          ...
          d(n, p(S, n, w, l, c.node(t.v), c.node(t.w), f)));
      }),
  ...
  B = t(async (t, r) => {
    let i = new v({ multigraph: !0, compound: !0 })
        .setGraph({
          rankdir: t.direction,
          nodesep:
      ...
      a = r.select(`g`);
    (f(a, t.markers, t.type, t.diagramId),
      c(),
      h(),
      l(),
      D(),
      t.nodes.forEach((e) => {
        (i.setNode(e.id, { ...e }),
          e.parentId && i.setParent(e.id, e.parentId));
      }),
      ...
      t.edges.forEach((e) => {
        if (e.start === e.end) {
          ...
          ((o.label = ``),
            ...
            i.setEdge(t, n, o, t + `-cyclic-special-0`),
            i.setEdge(n, r, s, t + `-cyclic-special-1`),
            i.setEdge(r, t, c, t + `-cyc<lic-special-2`));
        } else i.setEdge(e.start, e.end, { ...e }, e.id);
      }),
      e.warn(`Graph at first:`, JSON.stringify(x(i))),
      F(i),
      e.warn(`Graph after XAX:`, JSON.stringify(x(i))));
    let o = n();
