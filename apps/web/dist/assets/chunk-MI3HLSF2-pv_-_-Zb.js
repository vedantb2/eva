...
(e(b, `Schema$1`),
  (b.prototype.extend = e(function (e) {
    var t = [],
      n = [];
    ...
    return (
      ...
      (r.compiledImplicit = ee(r, `implicit`)),
      (r.compiledExplicit = ee(r, `explicit`)),
      (r.compiledTypeMap = te(r.compiledImplicit, r.compiledExplicit)),
      r
    );
  }, `extend`)));
var ne = new b({
...
var we = new y(`tag:yaml.org,2002:float`, {
  ...
  Te = ne.extend({ implicit: [oe, ue, _e, we] }),
  Ee = Te,
  De = RegExp(`^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$`),
  Oe = RegExp(
...
function Ae(e) {
  var t,
    ...
    d,
    f;
  if (((t = De.exec(e)), t === null && (t = Oe.exec(e)), t === null))
...
var Pe = new y(`tag:yaml.org,2002:merge`, { kind: `scalar`, resolve: Ne }),
...
var $e = new y(`tag:yaml.org,2002:set`, {
  ...
  et = Ee.extend({ implicit: [Me, Pe], explicit: [Be, Ge, Ye, $e] }),
...
var yt = {
  YAML: e(function (e, t, n) {
    var r, i, a;
    (e.version !== null && j(e, `duplication of %YAML directive`),
      n.length !== 1 && j(e, `YAML directive accepts exactly one argument`),
      (r = /^([0-9]+)\.([0-9]+)$/.exec(n[0])),
      r === null && j(e, `ill-formed argument of the YAML directive`),
      (i = parseInt(r[1], 10)),
      (a = parseInt(r[2], 10)),
      i !== 1 && j(e, `unacceptable YAML version of the document`),
      (e.version = n[0]),
      (e.checkLineBreaks = a < 2),
      a !== 1 && a !== 2 && M(e, `unsupported YAML version of the document`));
  }, `handleYamlDirective`),
  TAG: e(function (e, t, n) {
    var r, i;
    (n.length !== 2 && j(e, `TAG directive accepts exactly two arguments`),
      (r = n[0]),
      (i = n[1]),
      ct.test(r) ||
...
function bt(e, t, n, r) {
  ...
  for (
    ...
    ((a = i[o]), x.call(t, a) || ((t[a] = n[a]), (r[a] = !0)));
}
e(bt, `mergeMappings`);
function P(e, t, n, r, i, a, o, s, c) {
  ...
  if (Array.isArray(i))
    for (i = Array.prototype.slice.call(i), l = 0, u = i.length; l < u; l += 1)
      (Array.isArray(i[l]) &&
        j(e, `nested arrays are not supported inside keys`),
        typeof i == `object` &&
          ut(i[l]) === `[object Object]` &&
          (i[l] = `[object Object]`));
  if (
    (typeof i == `object` &&
      ut(i) === `[object Object]` &&
    ...
    if (Array.isArray(a))
      for (l = 0, u = a.length; l < u; l += 1) bt(e, t, a[l], n);
    else bt(e, t, a, n);
  else
    (!e.json &&
      !x.call(n, i) &&
...
function I(e, t, n) {
  for (var r = 0, i = e.input.charCodeAt(e.position); i !== 0; ) {
    ...
    if (T(i))
      for (
        F(e), i = e.input.charCodeAt(e.position), r++, e.lineIndent = 0;
        i === 32;
      )
  ...
  return (
    n !== -1 && r !== 0 && e.lineIndent < n && M(e, `deficient indentation`),
    r
  );
}
...
function xt(e, t, n) {
  ...
  if (
    ...
    p === 96 ||
    ((p === 63 || p === 45) &&
      ((i = e.input.charCodeAt(e.position + 1)), D(i) || (n && O(i))))
  )
    return !1;
  for (
    ...
    if (p === 58) {
      if (((i = e.input.charCodeAt(e.position + 1)), D(i) || (n && O(i))))
        break;
    } else if (p === 35) {
    ...
    ((s &&= (N(e, a, o, !1), R(e, e.line - c), (a = o = e.position), !1)),
      E(p) || (o = e.position + 1),
      (p = e.input.charCodeAt(++e.position)));
  }
...
function St(e, t) {
  ...
  for (
    ...
    if (n === 39)
      ...
      T(n)
        ? (N(e, r, i, !0), R(e, I(e, !1, t)), (r = i = e.position))
        : e.position === e.lineStart && L(e)
...
function Ct(e, t) {
  ...
  for (
    ...
    if (s === 34) return (N(e, n, e.position, !0), e.position++, !0);
    else if (s === 92) {
      if (
        (N(e, n, e.position, !0), (s = e.input.charCodeAt(++e.position)), T(s))
      )
        I(e, !1, t);
      ...
      T(s)
        ? (N(e, n, r, !0), R(e, I(e, !1, t)), (n = r = e.position))
        : e.position === e.lineStart && L(e)
...
function wt(e, t) {
  ...
  for (
    ...
    if ((I(e, !0, t), (v = e.input.charCodeAt(e.position)), v === u))
      return (
        e.position++,
        (e.tag = o),
        (e.anchor = c),
...
function Tt(e, t) {
  ...
  for (; f !== 0; ) {
    for (
      F(e), e.lineIndent = 0, f = e.input.charCodeAt(e.position);
...
function Et(e, t, n) {
  ...
  for (
    ...
    if (
      ...
      (v === 63
        ? (g && (P(e, d, f, p, m, null, o, s, c), (p = m = h = null)),
          (_ = !0),
          (g = !0),
          (i = !0))
        : g
    ...
    if (
      ((e.line === a || e.lineIndent > t) &&
        ...
        B(e, t, C, !0, i) && (g ? (m = e.result) : (h = e.result)),
        g || (P(e, d, f, p, m, h, o, s, c), (p = m = h = null)),
        I(e, !0, -1),
        (v = e.input.charCodeAt(e.position))),
...
function kt(e) {
  ...
  return (
    ...
    x.call(e.anchorMap, n) || j(e, `unidentified alias "` + n + `"`),
...
function B(e, t, n, r, i) {
  ...
  if (
    ...
    (c === 1 || C === n) &&
      ...
      c === 1
        ? (s && (z(e, g) || Et(e, g, h))) || wt(e, h)
          ? (u = !0)
          : ((o && Tt(e, h)) || St(e, h) || Ct(e, h)
              ? (u = !0)
              : kt(e)
                ? ((u = !0),
...
function At(e) {
  ...
  if (
    ...
    e.input.charCodeAt(e.position + 2) === 45
      ...
      : a && j(e, `directives end mark is expected`),
    B(e, e.lineIndent - 1, C, !1, !0),
    I(e, !0, -1),
    e.checkLineBreaks &&
      ot.test(e.input.slice(t, e.position)) &&
...
`),
  ...
  var n = new _t(e, t),
    r = e.indexOf(`\0`);
  for (
    r !== -1 && ((n.position = r), j(n, `null byte is not allowed in input`)),
      n.input += `\0`;
...
function sn(e, t) {
  ...
  for (n = {}, r = Object.keys(t), i = 0, a = r.length; i < a; i += 1)
    ((o = r[i]),
      ...
      c && Ft.call(c.styleAliases, s) && (s = c.styleAliases[s]),
      (n[o] = s));
  return n;
}
...
var ln = 1,
  K = 2;
function un(e) {
  ((this.schema = e.schema || et),
    (this.indent = Math.max(1, e.indent || 2)),
    (this.noArrayIndent = e.noArrayIndent || !1),
    (this.skipInvalid = e.skipInvalid || !1),
    (this.flowLevel = s.isNothing(e.flowLevel) ? -1 : e.flowLevel),
    (this.styleMap = sn(this.schema, e.styles || null)),
    (this.sortKeys = e.sortKeys || !1),
    (this.lineWidth = e.lineWidth || 80),
    (this.noRefs = e.noRefs || !1),
    (this.noCompatMode = e.noCompatMode || !1),
    (this.condenseFlow = e.condenseFlow || !1),
    (this.quotingType = e.quotingType === `"` ? K : ln),
...
function Cn(t, n, r, i, a) {
  t.dump = (function () {
    ...
    if (!t.noCompatMode && (an.indexOf(n) !== -1 || on.test(n)))
      return t.quotingType === K ? `"` + n + `"` : `'` + n + `'`;
    ...
    switch (
      (e(l, `testAmbiguity`),
      Sn(n, c, t.indent, s, l, t.quotingType, t.forceQuotes && !i, a))
    ) {
      case vn:
        return n;
      case yn:
        return `'` + n.replace(/'/g, `''`) + `'`;
      case bn:
        return `|` + wn(n, t.indent) + Tn(dn(n, o));
      case xn:
        return `>` + wn(n, t.indent) + Tn(dn(En(n, s), o));
      case Z:
        return `"` + On(n) + `"`;
      default:
  ...
  for (o = 0, s = n.length; o < s; o += 1)
    ((c = n[o]),
      ...
      (Q(e, t + 1, c, !0, !0, !1, !0) ||
        ...
        ((!r || i !== ``) && (i += q(e, t)),
        e.dump && U === e.dump.charCodeAt(0) ? (i += `-`) : (i += `- `),
        (i += e.dump)));
  ((e.tag = a), (e.dump = i || `[]`));
}
  ...
  for (s = 0, c = o.length; s < c; s += 1)
    ((p = ``),
      ...
      Q(e, t + 1, l, !0, !0, !0) &&
        ...
        f && (e.dump && U === e.dump.charCodeAt(0) ? (p += `?`) : (p += `? `)),
        (p += e.dump),
        f && (p += q(e, t)),
        Q(e, t + 1, d, !0, f) &&
    ...
    if (
      ...
      if (
        ...
        if (
          ...
          Pt.call(s.represent) === `[object Function]`)
        )
          r = s.represent(t, c);
  ...
  if (
    ...
    if (
      ...
      r && Object.keys(e.dump).length !== 0
        ? (Mn(e, t, e.dump, i), p && (e.dump = `&ref_` + f + e.dump))
      ...
      r && e.dump.length !== 0
        ...
        : (kn(e, t, e.dump), p && (e.dump = `&ref_` + f + ` ` + e.dump));
