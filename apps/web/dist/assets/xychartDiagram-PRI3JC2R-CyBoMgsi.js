...
import { t as m } from "./linear-CavJTP_n.js";
import { t as h } from "./ordinal-7mduGgT1.js";
import { t as g } from "./init-6zo3nO5-.js";
import { r as _ } from "./chunk-S3R3BYOJ-qZRxmO84.js";
import { t as v } from "./line-xAZ3WWpC.js";
import { t as y } from "./chunk-EXTU4WIE-B-MXTPDr.js";
import { t as b } from "./chunk-JA3XYJ7Z-ByUEKWPH.js";
function x(e, t, n) {
  ((e = +e),
    (t = +t),
...
var O = class {
  ...
  j = class {
    ...
    recalculateOuterPaddingToDrawBar() {
      (k * this.getTickDistance() > this.outerPadding * 2 &&
        (this.outerPadding = Math.floor((k * this.getTickDistance()) / 2)),
        this.recalculateScale());
    }
  ...
  M = class extends j {
    ...
    constructor(e, t, n, r, i) {
      (super(e, r, i, t),
        (this.categories = n),
        (this.scale = S().domain(this.categories).range(this.getRange())));
    }
    setRange(e) {
      super.setRange(e);
    }
  ...
  ee = class extends j {
    ...
    constructor(e, t, n, r, i) {
      (super(e, r, i, t),
        (this.domain = n),
        (this.scale = m().domain(this.domain).range(this.getRange())));
    }
    getTickValues() {
    ...
    recalculateScale() {
      ...
      (this.axisPosition === `left` && e.reverse(),
        (this.scale = m().domain(e).range(this.getRange())));
    }
    getScaleValue(e) {
      return this.scale(e);
    }
...
function N(e, t, n, r) {
  let i = new O(r);
  return E(e)
    ? new M(t, n, e.categories, e.title, i)
    : new ee(t, n, [e.min, e.max], e.title, i);
}
t(N, `getAxis`);
var te = class {
  constructor(e, t, n, r) {
...
var oe = class {
    ...
    calculateVerticalSpace() {
      ...
      ((e -= o.width),
        ...
        this.chartData.plots.some((e) => T(e)) &&
  ...
  R = U(),
  z = G(),
  B = R.plotColorPalette.split(`,`).map((e) => e.trim()),
  V = !1,
  H = !1;
function U() {
  let e = a(),
...
function J(e) {
  e === `horizontal`
    ? (L.chartOrientation = `horizontal`)
    : (L.chartOrientation = `vertical`);
}
t(J, `setOrientation`);
function Y(e) {
...
t(Y, `setXAxisTitle`);
function X(e, t) {
  ((z.xAxis = { type: `linear`, title: z.xAxis.title, min: e, max: t }),
    (V = !0));
}
...
t(le, `setYAxisTitle`);
function ue(e, t) {
  ((z.yAxis = { type: `linear`, title: z.yAxis.title, min: e, max: t }),
    (H = !0));
}
...
function de(e) {
  let t = Math.min(...e),
    n = Math.max(...e),
    r = D(z.yAxis) ? z.yAxis.min : 1 / 0,
    i = D(z.yAxis) ? z.yAxis.max : -1 / 0;
  z.yAxis = {
    type: `linear`,
    title: z.yAxis.title,
    min: Math.min(r, t),
...
function Z(e) {
  ...
  if (!V) {
    let t = D(z.xAxis) ? z.xAxis.min : 1 / 0,
      n = D(z.xAxis) ? z.xAxis.max : -1 / 0;
    X(Math.min(t, 1), Math.max(n, e.length));
  }
  if (
    (H || de(e),
    E(z.xAxis) && (t = z.xAxis.categories.map((t, n) => [t, e[n]])),
    D(z.xAxis))
  ) {
    let n = z.xAxis.min,
      r = z.xAxis.max,
...
function fe(e, t) {
  let n = Z(t);
  (z.plots.push({ type: `line`, strokeFill: Q(F), strokeWidth: 2, data: n }),
    F++);
}
t(fe, `setLineData`);
function pe(e, t) {
  let n = Z(t);
  (z.plots.push({ type: `bar`, fill: Q(F), data: n }), F++);
}
t(pe, `setBarData`);
function me() {
  if (z.plots.length === 0)
  ...
  renderer: {
    draw: t((n, r, i, a) => {
      let o = a.db,
        ...
        c = o.getChartConfig(),
        u = o.getXYChartData().plots[0].data.map((e) => e[1]);
      function d(e) {
      ...
      (t(p, `getTextTransformation`),
        e.debug(
          `Rendering xychart chart
` + n,
        ));
      let m = y(r),
        h = m.append(`g`).attr(`class`, `main`),
        g = h
          .append(`rect`)
          .attr(`width`, c.width)
          .attr(`height`, c.height)
          .attr(`class`, `background`);
      (l(m, c.height, c.width, !0),
        m.attr(`viewBox`, `0 0 ${c.width} ${c.height}`),
        g.attr(`fill`, s.backgroundColor),
        o.setTmpSVGG(m.append(`g`).attr(`class`, `mermaid-tmp-group`)));
        ...
        switch (e.type) {
          case `rect`:
            if (
              ...
              if (c.chartOrientation === `horizontal`) {
                ...
                let i = 0.7,
                  a = e.data
                    .map((e, t) => ({ data: e, label: u[t].toString() }))
          ...
          case `text`:
            n.selectAll(`text`)
              ...
              .attr(`dominant-baseline`, (e) => d(e.verticalPos))
              .attr(`text-anchor`, (e) => f(e.horizontalPos))
              .attr(`transform`, (e) => p(e))
              .text((e) => e.text);
            break;
          case `path`:
            n.selectAll(`path`)
