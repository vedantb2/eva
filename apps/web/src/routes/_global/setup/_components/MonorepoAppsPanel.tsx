    ...
    <>
        ...
        return (
          ...
          >
            <div className="flex items-center gap-2 min-w-0">
              <IconFolder className="w-4 h-4 text-muted-foreground shrink-0" />
            ...
            {addedRepos.has(key) ? (
              <span className="flex items-center gap-1 text-success text-xs shrink-0">
      ...
      <div className="flex items-center gap-2 pt-2">
        <input
          ...
          className="min-w-0 flex-1 rounded-control border border-border bg-background px-2 py-1.5 text-sm"
        />
        <Button
          size="sm"
          variant="secondary"
