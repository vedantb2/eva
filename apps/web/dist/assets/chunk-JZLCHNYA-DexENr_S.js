...
import { f as p, i as m, l as h, n as g } from "./chunk-S3R3BYOJ-qZRxmO84.js";
import { t as _ } from "./chunk-CVBHYZKI-pVtBnPKQ.js";
import { a as v, i as y, r as b, t as x } from "./chunk-ATLVNIR6-BjpTnV3z.js";
import { n as S, r as C } from "./chunk-JA3XYJ7Z-ByUEKWPH.js";
function w(e, t, n) {
  if (e && e.length) {
    let [r, i] = t,
      a = (Math.PI / 180) * n,
...
var B = `none`,
  ...
  H = t(async (e, r, a) => {
    let o,
      s = r.useHtmlLabels || u(c()?.htmlLabels);
    o = a || `node default`;
    let d = e
        .insert(`g`)
        .attr(`class`, o)
        .attr(`id`, r.domId || r.id),
      f = d.insert(`g`).attr(`class`, `label`).attr(`style`, h(r.labelStyle)),
      g;
    g =
      r.label === void 0
        ? ``
    ...
    return (
      ...
      { shapeSvg: d, bbox: v, halfPadding: y, label: f }
    );
  }, `labelHelper`),
  He = t(async (e, t, r) => {
    let a = r.useHtmlLabels || u(c()?.flowchart?.htmlLabels),
      o = e
        .insert(`g`)
        .attr(`class`, `label`)
    ...
    return (
      ...
      { shapeSvg: e, bbox: l, halfPadding: d, label: o }
    );
  }, `insertLabel`),
  U = t((e, t) => {
...
var qe = t(async (t, n, r, i) => {
  ...
  Je = t(async (t, r) => {
    ...
    let i = c(),
      ...
      g = u(i.flowchart.htmlLabels),
      b = h.insert(`g`).attr(`class`, `cluster-label `),
      x = await S(b, r.label, {
        style: r.labelStyle,
        useHtmlLabels: g,
        isNode: !0,
    ...
    r.width <= C.width + r.padding
      ? (r.diff = (w - r.width) / 2 - r.padding)
      : (r.diff = -r.padding);
    let T = r.height,
      E = r.x - w / 2,
      D = r.y - T / 2;
    ...
    if (r.look === `handDrawn`) {
      ...
      ((O = h.insert(
        ...
        O.select(`path`).attr(`style`, m.join(`;`).replace(`fill`, `stroke`)));
    } else
    ...
    if (
      (b.attr(
        `transform`,
        `translate(${r.x - C.width / 2}, ${r.y - r.height / 2 + k})`,
      ),
      d)
    ) {
      let e = b.select(`span`);
    ...
    return (
      ...
      (r.width = A.width),
      (r.height = A.height),
      (r.offsetY = C.height - r.padding / 2),
  ...
  Ye = {
    ...
    roundedWithTitle: t(async (e, t) => {
      let r = c(),
        ...
        h = f.append(`rect`),
        g = m.node().appendChild(await qe(t.label, t.labelStyle, void 0, !0)),
        _ = g.getBBox();
      ...
      return (
        m.attr(
          `transform`,
          `translate(${t.x - _.width / 2}, ${w + 1 - (u(r.flowchart.htmlLabels) ? 0 : 3)})`,
        ),
...
function lt(t, n) {
  ...
  let o = t
    ...
    { cssStyles: s } = n,
    c = V.svg(o),
    l = v(n, { fill: `black`, stroke: `none`, fillStyle: `solid` });
  n.look !== `handDrawn` && (l.roughness = 0);
  let u = c.circle(0, 0, 2, l),
    d = o.insert(() => u, `:first-child`);
  return (
    d.attr(`class`, `anchor`).attr(`style`, h(s)),
    U(n, d),
...
async function mt(t, n, r) {
  ...
  n.labelStyle = i;
  let { shapeSvg: o, bbox: s, halfPadding: c } = await H(t, n, W(n)),
    l = r?.padding ?? c,
    u = s.width / 2 + l,
    d,
    { cssStyles: f } = n;
  if (n.look === `handDrawn`) {
    ...
    ((d = o.insert(() => r, `:first-child`)),
      d.attr(`class`, `basic label-container`).attr(`style`, h(f)));
  } else
    d = o
...
async function _t(e, t) {
  ...
  return (
    x.insert(() => b, `:first-child`).attr(`stroke-opacity`, 0),
    x.insert(() => g, `:first-child`),
    x.attr(`class`, `text`),
    u && t.look !== `handDrawn` && x.selectAll(`path`).attr(`style`, u),
    r && t.look !== `handDrawn` && x.selectAll(`path`).attr(`style`, r),
    x.attr(`transform`, `translate(${l}, 0)`),
    o.attr(
      `transform`,
...
async function bt(e, t) {
  ...
  return (
    ...
    l && t.look !== `handDrawn` && x.selectChildren(`path`).attr(`style`, l),
    r && t.look !== `handDrawn` && x.selectChildren(`path`).attr(`style`, r),
    x.attr(`transform`, `translate(${-o / 2}, ${-s / 2})`),
    U(t, x),
    (t.intersect = function (e) {
...
async function Et(t, n) {
  let { labelStyles: r, nodeStyles: i } = y(n);
  n.labelStyle = r;
  let { shapeSvg: a, bbox: o, halfPadding: s } = await H(t, n, W(n)),
    c = o.width / 2 + s + 5,
    l = o.width / 2 + s,
    u,
    { cssStyles: d } = n;
  if (n.look === `handDrawn`) {
    ...
    ((u = a.insert(`g`, `:first-child`)),
      u.attr(`class`, h(n.cssClasses)).attr(`style`, h(d)),
...
async function Ot(t, n) {
  let { labelStyles: r, nodeStyles: i } = y(n);
  n.labelStyle = r;
  let { shapeSvg: a, bbox: o, label: s } = await H(t, n, W(n)),
...
async function At(t, n) {
  let { labelStyles: r, nodeStyles: i } = y(n);
  n.labelStyle = r;
  let { shapeSvg: a, bbox: o } = await H(t, n, W(n)),
  ...
  return (
    ...
    (n.intersect = function (t) {
      return (
        e.info(`Pill intersect`, n, { radius: l, point: t }),
        J.polygon(n, p, t)
      );
    }),
    a
...
async function Mt(t, n) {
  ...
  let { shapeSvg: a } = await H(t, n, W(n)),
    o = Math.max(30, n?.width ?? 0),
...
async function Nt(t, n, { config: { themeVariables: r, flowchart: i } }) {
  ...
  let { shapeSvg: u, bbox: d, label: f } = await H(t, n, `icon-shape default`),
    p = n.pos === `t`,
    m = c,
    h = c,
    { nodeBorder: g } = r,
    ...
    w = n.label ? 8 : 0,
    T = V.svg(u),
    E = v(n, { stroke: `none`, fill: `none` });
  n.look !== `handDrawn` && ((E.roughness = 0), (E.fillStyle = `solid`));
  let D = T.rectangle(b, S, h, m, E),
  ...
  if (n.icon) {
    let e = u.append(`g`);
    e.html(
      `<g>${await C(n.icon, { height: c, width: c, fallbackPrefix: `` })}</g>`,
    );
      ...
      return (
        (o = p
          ? [
              ...
              { x: r + d.width / 2, y: i - a / 2 },
              { x: r + d.width / 2, y: i - a / 2 + d.height + w },
              { x: r + h / 2, y: i - a / 2 + d.height + w },
              { x: r + h / 2, y: i + a / 2 },
              { x: r - h / 2, y: i + a / 2 },
              { x: r - h / 2, y: i - a / 2 + d.height + w },
              { x: r - d.width / 2, y: i - a / 2 + d.height + w },
...
async function Ft(t, n, { config: { themeVariables: r, flowchart: i } }) {
  ...
  let {
      ...
      halfPadding: f,
      label: p,
    } = await H(t, n, `icon-shape default`),
    m = n.pos === `t`,
    h = c + f * 2,
    g = c + f * 2,
    { nodeBorder: _, mainBkg: b } = r,
    { stylesMap: S } = x(n),
    w = -g / 2,
    T = -h / 2,
    E = n.label ? 8 : 0,
      ...
      return (
        (o = m
          ? [
              { x: r - d.width / 2, y: i - a / 2 },
              { x: r + d.width / 2, y: i - a / 2 },
              { x: r + d.width / 2, y: i - a / 2 + d.height + E },
              { x: r + g / 2, y: i - a / 2 + d.height + E },
              { x: r + g / 2, y: i + a / 2 },
              { x: r - g / 2, y: i + a / 2 },
              { x: r - g / 2, y: i - a / 2 + d.height + E },
              { x: r - d.width / 2, y: i - a / 2 + d.height + E },
...
async function Lt(t, n, { config: { flowchart: r } }) {
  ...
  let { shapeSvg: f, bbox: p, label: m } = await H(t, n, `image-shape default`),
    h = n.pos === `t`,
    g = -u / 2,
    _ = -d / 2,
    b = n.label ? 8 : 0,
    ...
    S = v(n, {});
  n.look !== `handDrawn` && ((S.roughness = 0), (S.fillStyle = `solid`));
  let C = x.rectangle(g, _, u, d, S),
    w = Math.max(u, p.width),
    T = d + p.height + b,
    E = x.rectangle(-w / 2, -T / 2, w, T, {
      ...S,
      fill: `none`,
      stroke: `none`,
    }),
...
async function zt(e, t, n) {
  ...
  if ((n?.rx && n.ry && ((f = n.rx), (p = n.ry)), t.look === `handDrawn`)) {
    ...
    ((d = a.insert(() => r, `:first-child`)),
      d.attr(`class`, `basic label-container`).attr(`style`, h(m)));
  } else
...
async function Zt(e, t, { config: { themeVariables: n } }) {
  ...
  let { shapeSvg: a, bbox: o, label: s } = await H(e, t, W(t)),
    ...
    { cssStyles: p } = t,
    m = V.svg(a),
    h = v(t, { fill: n.noteBkgColor, stroke: n.noteBorderColor });
  t.look !== `handDrawn` && ((h.roughness = 0), (h.fillStyle = `solid`));
  let g = m.rectangle(u, d, c, l, h),
    _ = a.insert(() => g, `:first-child`);
  return (
    _.attr(`class`, `basic label-container`),
    p && t.look !== `handDrawn` && _.selectAll(`path`).attr(`style`, p),
...
async function en(e, t) {
  ...
  return (
    ...
    b.attr(`transform`, `translate(${-d / 2},0)`),
    o.attr(
      `transform`,
...
async function tn(t, r) {
  ...
  let s = t
      ...
      .attr(`id`, r.domId || r.id),
    l = s.insert(`g`),
    d = s.insert(`g`).attr(`class`, `label`).attr(`style`, a),
    f = r.description,
    p = r.label,
    m = d.node().appendChild(await qe(p, r.labelStyle, !0, !0)),
    h = { width: 0, height: 0 };
  if (u(c()?.flowchart?.htmlLabels)) {
    let e = m.children[0],
      t = n(m);
  ...
  let g = f || [],
    ...
    b = d
      .node()
      .appendChild(
        await qe(g.join ? g.join(`<br/>`) : g, r.labelStyle, !0, !0),
      ),
    x = b.children[0],
    S = n(b);
  ...
  let w = h.width + (r.padding || 0),
    T = h.height + (r.padding || 0),
    E = -h.width / 2 - C,
    D = -h.height / 2 - C,
    O,
    k;
...
async function an(e, t) {
  ...
  let g = [
    ...
    b = i.insert(() => _, `:first-child`);
  return (
    b.attr(`class`, `basic label-container`).attr(`style`, h(f)),
    r && t.look !== `handDrawn` && b.selectAll(`path`).attr(`style`, r),
    f && t.look !== `handDrawn` && b.selectAll(`path`).attr(`style`, r),
    o.attr(
      `transform`,
...
async function pn(e, t) {
  ...
  let _ = G(h),
    b = p.path(_, m),
    x = G(g),
    S = p.path(x, { ...m, fillStyle: `solid` }),
    C = i.insert(() => S, `:first-child`);
  return (
    C.insert(() => b, `:first-child`),
...
async function mn(e, t) {
  ...
  let g = [
    ...
    x = [
      ...
      { x: _ + s, y: b + c - d },
      { x: _ + s, y: (b + c) * 0.9 },
      ...K(_ + s, (b + c) * 1.3, _ + s - u, (b + c) * 1.5, -c * 0.03, 0.5),
    ],
    S = G(g),
    C = m.path(S, h),
    w = G(x),
...
async function yn(e, t) {
  let { labelStyles: n, nodeStyles: r } = y(t);
  t.labelStyle = n;
  let { shapeSvg: i, bbox: a, label: o, halfPadding: s } = await H(e, t, W(t)),
    c = t.look === `neo` ? s * 2 : s,
    l = a.height + c,
    u = l / 2,
    d = u / (2.5 + l / 50),
...
async function Sn(t, n) {
  ...
  return (
    ...
    i && n.look !== `handDrawn` && S.selectChildren(`path`).attr(`style`, i),
    (n.width = d),
    (n.height = f),
    U(n, S),
    s.attr(
...
async function Cn(e, t) {
  ...
  return (
    ...
    r && t.look !== `handDrawn` && x.selectAll(`path`).attr(`style`, r),
    x.attr(`transform`, `translate(0,${-l / 2})`),
    o.attr(
      `transform`,
...
async function En(e, t) {
  ...
  let a = i.er?.diagramPadding ?? 10,
    o = i.er?.entityPadding ?? 6,
    { cssStyles: s } = t,
    { labelStyles: c, nodeStyles: l } = y(t);
  if (r.attributes.length === 0 && t.label) {
    ...
    g(t.label, i) + n.labelPaddingX * 2 < i.er.minEntityWidth &&
  ...
  let p = e
      ...
      .attr(`class`, d)
      .attr(`id`, t.domId || t.id),
    m = await Dn(p, t.label ?? ``, i, 0, 0, [`name`], c);
  m.height += o;
  let h = 0,
    _ = [],
    b = [],
  ...
  for (let e of r.attributes) {
    ...
    (b.push({ yOffset: h, rowHeight: l }), (h += l));
  }
  let D = 4;
  ...
  let N = Math.max(O.width + a * 2, t?.width || 0, k),
    P = Math.max((M ?? 0) + m.height, t?.height || 0),
    F = -N / 2,
    I = -P / 2;
  (p.selectAll(`g:not(:first-child)`).each((e, t, r) => {
    ...
    i.attr(
      `transform`,
      `translate(${F + a / 2 + c}, ${l + I + m.height + o / 2})`,
    );
  }),
    p
      .select(`.name`)
      .attr(
        `transform`,
        `translate(` + -m.width / 2 + `, ` + (I + o / 2) + `)`,
      ));
  let ee = A.rectangle(F, I, N, P, j),
    te = p.insert(() => ee, `:first-child`).attr(`style`, s.join(``)),
    { themeVariables: ne } = f(),
    { rowEven: re, rowOdd: ie, nodeBorder: ae } = ne;
  _.push(0);
  for (let [e, t] of b.entries()) {
    let n = (e + 1) % 2 == 0 && t.yOffset !== 0,
      r = A.rectangle(F, m.height + I + t?.yOffset, N, t?.rowHeight, {
        ...j,
        fill: n ? re : ie,
        stroke: ae,
      });
  ...
  (p.insert(() => L).attr(`class`, `divider`),
    (L = A.line(x + F, m.height + I, x + F, P + I, j)),
    p.insert(() => L).attr(`class`, `divider`),
    T &&
      ((L = A.line(x + S + F, m.height + I, x + S + F, P + I, j)),
      p.insert(() => L).attr(`class`, `divider`)),
    E &&
      ((L = A.line(x + S + C + F, m.height + I, x + S + C + F, P + I, j)),
      p.insert(() => L).attr(`class`, `divider`)));
  for (let e of _)
    ((L = A.line(F, m.height + I + e, N + F, m.height + I + e, j)),
      p.insert(() => L).attr(`class`, `divider`));
  if ((U(t, te), l && t.look !== `handDrawn`)) {
    let e = l
      ...
      ?.map((e) => `${e}`)
      .join(`; `);
    (p.selectAll(`path`).attr(`style`, e ?? ``),
      p.selectAll(`.row-rect-even path`).attr(`style`, l));
  }
  return (
    (t.intersect = function (e) {
      return J.rect(t, e);
...
async function Dn(e, t, i, a = 0, o = 0, s = [], c = ``) {
  let l = e
    ...
    .attr(`style`, c);
  t !== r(t) &&
    ((t = r(t)), (t = t.replaceAll(`<`, `&lt;`).replaceAll(`>`, `&gt;`)));
  let d = l
    .node()
    .appendChild(
      await S(
        l,
        t,
        { width: g(t, i) + 100, style: c, useHtmlLabels: i.htmlLabels },
        i,
      ),
    );
...
async function kn(e, r, i, o = []) {
  let c = e.insert(`g`).attr(`class`, `label`).attr(`style`, o.join(`; `)),
    l = f(),
    d = `useHtmlLabels` in r ? r.useHtmlLabels : (u(l.htmlLabels) ?? !0),
    p = ``;
  ((p = `text` in r ? r.text : r.label),
    !d && p.startsWith(`\\`) && (p = p.substring(1)),
    s(p) && (d = !0));
  let h = await S(
      c,
      a(m(p)),
      { width: g(p, l) + 50, classes: `markdown-node-label`, useHtmlLabels: d },
      l,
    ),
    _,
    v = 1;
  if (d) {
    let e = h.children[0],
      r = n(h);
    ((v = e.innerHTML.split(`<br>`).length),
      e.innerHTML.includes(`</math>`) &&
        (v += e.innerHTML.split(`<mrow>`).length - 1));
    ...
    ((_ = e.getBoundingClientRect()),
      ...
      r.attr(`height`, _.height));
  } else {
    (o.includes(`font-weight: bolder`) &&
      n(h).selectAll(`tspan`).attr(`font-weight`, ``),
      (v = h.children.length));
    let e = h.children[0];
  ...
  return (
    c.attr(`transform`, `translate(0,` + (-_.height / (2 * v) + i) + `)`),
    _.height
  );
}
t(kn, `addText`);
async function An(e, t) {
  let r = c(),
    ...
    a = i,
    o = t.useHtmlLabels ?? u(r.htmlLabels) ?? !0,
    s = t;
  ((s.annotations = s.annotations ?? []),
    (s.members = s.members ?? []),
    (s.methods = s.methods ?? []));
  let { shapeSvg: l, bbox: d } = await On(e, t, r, o, a),
    { labelStyles: f, nodeStyles: p } = y(t);
  ...
  s.members.length === 0 && s.methods.length === 0
    ? (x += a)
    : s.members.length > 0 && s.methods.length === 0 && (x += a * 2);
  let S = -b / 2,
    C = -x / 2,
    w = g.rectangle(
      S - i,
      C -
        i -
        (h ? i : s.members.length === 0 && s.methods.length === 0 ? -i / 2 : 0),
      b + 2 * i,
      x +
        2 * i +
        (h ? i * 2 : s.members.length === 0 && s.methods.length === 0 ? -i : 0),
      _,
    ),
    T = l.insert(() => w, `:first-child`);
  ...
  l.selectAll(`.text`).each((e, t, r) => {
    ...
    ((a.attr(`class`).includes(`label-group`) ||
      ...
      l.selectAll(`text`).each(function (e, t, n) {
        window.getComputedStyle(n[t]).textAnchor === `middle` && (f = 0);
      })),
      a.attr(`transform`, `translate(${f}, ${d})`));
  });
  let D =
      l.select(`.annotation-group`).node().getBBox().height - (h ? i / 2 : 0) ||
      0,
    O = l.select(`.label-group`).node().getBBox().height - (h ? i / 2 : 0) || 0,
    k =
      l.select(`.members-group`).node().getBBox().height - (h ? i / 2 : 0) || 0;
  ...
  if (
    (s.look !== `handDrawn` && l.selectAll(`path`).attr(`style`, m),
    T.select(`:nth-child(2)`).attr(`style`, m),
    l.selectAll(`.divider`).select(`path`).attr(`style`, m),
    t.labelStyle
      ? l.selectAll(`span`).attr(`style`, t.labelStyle)
      : l.selectAll(`span`).attr(`style`, m),
    !o)
  ) {
...
async function jn(e, t) {
  ...
  let a = t,
    ...
    u;
  u = s
    ? await $(l, `&lt;&lt;${a.type}&gt;&gt;`, 0, t.labelStyle)
    : await $(l, `&lt;&lt;Element&gt;&gt;`, 0, t.labelStyle);
  let d = u,
    f = await $(l, a.name, d, t.labelStyle + `; font-weight: bold;`);
  if (((d += f + 20), s)) {
    let e = await $(
      l,
    ...
    ((d += e),
      await $(l, `${o.docRef ? `Doc Ref: ${o.docRef}` : ``}`, d, t.labelStyle));
  }
  ...
  let x = _.rectangle(h, g, p, m, b),
    S = l.insert(() => x, `:first-child`);
  if (
    (S.attr(`class`, `basic label-container`).attr(`style`, i),
    l.selectAll(`.label`).each((e, t, r) => {
      let i = n(r[t]),
        a = i.attr(`transform`),
        o = 0,
        s = 0;
...
async function $(e, t, r, i = ``) {
  if (t === ``) return 0;
  let o = e.insert(`g`).attr(`class`, `label`).attr(`style`, i),
    s = c(),
    l = s.htmlLabels ?? !0,
    u = await S(
      o,
  ...
  return (
    o.attr(`transform`, `translate(${-d.width / 2},${-d.height / 2 + r})`),
    d.height
  );
}
t($, `addText`);
...
async function Nn(e, t, { config: n }) {
  ...
  if (t.look === `handDrawn`) {
    let e = V.svg(o),
      n = v(t, {}),
      r =
        T || E ? e.path(q(S, C, _, x, T || 0), n) : e.rectangle(S, C, _, x, n);
...
async function Pn(t, n) {
  let { labelStyles: r, nodeStyles: i } = y(n);
  n.labelStyle = r;
  let { shapeSvg: a, bbox: o, halfPadding: s, label: c } = await H(t, n, W(n)),
    l = o.width + 10 * s,
    u = o.height + 8 * s,
    d = 0.15 * l,
    { cssStyles: f } = n,
  ...
  let b,
    x = `M0 0 
    a${d},${d} 1 0,0 ${g * 0.25},${-1 * _ * 0.1}
    a${d},${d} 1 0,0 ${g * 0.25},0
    a${d},${d} 1 0,0 ${g * 0.25},0
    a${d},${d} 1 0,0 ${g * 0.25},${_ * 0.1}

    a${d},${d} 1 0,0 ${g * 0.15},${_ * 0.33}
    a${d * 0.8},${d * 0.8} 1 0,0 0,${_ * 0.34}
    a${d},${d} 1 0,0 ${-1 * g * 0.15},${_ * 0.33}

    a${d},${d} 1 0,0 ${-1 * g * 0.25},${_ * 0.15}
    a${d},${d} 1 0,0 ${-1 * g * 0.25},0
    a${d},${d} 1 0,0 ${-1 * g * 0.25},0
    a${d},${d} 1 0,0 ${-1 * g * 0.25},${-1 * _ * 0.15}

    a${d},${d} 1 0,0 ${-1 * g * 0.1},${-1 * _ * 0.33}
    a${d * 0.8},${d * 0.8} 1 0,0 0,${-1 * _ * 0.34}
    a${d},${d} 1 0,0 ${g * 0.1},${-1 * _ * 0.33}
  H0 V0 Z`;
  if (n.look === `handDrawn`) {
    let e = V.svg(a),
      t = v(n, {}),
      r = e.path(x, t);
    ((b = a.insert(() => r, `:first-child`)),
      b.attr(`class`, `basic label-container`).attr(`style`, h(f)));
  } else
    b = a
      .insert(`path`, `:first-child`)
...
async function Fn(t, n) {
  ...
  if (n.look === `handDrawn`) {
    ...
    ((_ = a.insert(() => r, `:first-child`)),
      _.attr(`class`, `basic label-container`).attr(`style`, h(g)));
  } else
    _ = a
      .insert(`path`, `:first-child`)
      .attr(`class`, `basic label-container`)
  ...
  return (
    c.attr(`transform`, `translate(${-o.width / 2}, ${-o.height / 2})`),
    _.attr(`transform`, `translate(${-l / 2}, ${-u / 2})`),
    U(n, _),
    (n.calcIntersect = function (e, t) {
      return J.rect(e, t);
    }),
