...
import { k as t } from "./chunk-ABZYJK2D-BcBvUh_0.js";
import { t as n } from "./dist-sj4ly5hH.js";
var r = n(),
  i = e((e, t) => {
    let n = e.append(`rect`);
    if (
  ...
  o = e((e, n) => {
    let r = n.text.replace(t, ` `),
      i = e.append(`text`);
    (i.attr(`x`, n.x),
      i.attr(`y`, n.y),
      i.attr(`class`, `legend`),
      i.style(`text-anchor`, n.anchor),
      n.class && i.attr(`class`, n.class));
