  ...
  return (
    <div className="flex-1 h-full min-h-0 overflow-hidden animate-in fade-in duration-300">
      <div className="flex h-full min-h-0 flex-col overflow-hidden">
        ...
        >
          <div
            className={`mx-auto w-full max-w-7xl flex flex-col gap-4 animate-in fade-in slide-in-from-bottom-1 duration-300 ${childPadding ? "px-3 py-3 sm:px-4 sm:py-4 lg:px-5 lg:py-5" : ""} ${fillHeight ? "flex-1 min-h-0 overflow-hidden" : "min-h-full"}`}
          >
            {children}
          </div>
        </div>
