...
var n = t((e, t) => {
  ...
  s = { trace: 0, debug: 1, info: 2, warn: 3, error: 4, fatal: 5 },
  c = {
    trace: a((...e) => {}, `trace`),
    debug: a((...e) => {}, `debug`),
    info: a((...e) => {}, `info`),
  ...
  l = a(function (e = `fatal`) {
    let t = s.fatal;
    (typeof e == `string`
      ? e.toLowerCase() in s && (t = s[e])
      : typeof e == `number` && (t = e),
      (c.trace = () => {}),
      (c.debug = () => {}),
      (c.info = () => {}),
...
p.prototype = f.prototype = {
  ...
  on: function (e, t) {
    ...
    if (arguments.length < 2) {
      for (; ++a < o; )
        if ((i = (e = r[a]).type) && (i = h(n[i], e.name))) return i;
      return;
    }
    if (t != null && typeof t != `function`)
      throw Error(`invalid callback: ` + t);
    for (; ++a < o; )
      if ((i = (e = r[a]).type)) n[i] = g(n[i], e.name, t);
...
function de(e) {
  return this.selectAll(
    e == null ? le : ue(typeof e == `function` ? e : re(e)),
  );
}
function fe(e) {
...
function ge(e, t, n, r, i, a) {
  for (var o = 0, s, c = t.length, l = a.length; o < l; ++o)
    (s = t[o]) ? ((s.__data__ = a[o]), (r[o] = s)) : (n[o] = new O(e, a[o]));
...
function ye(e, t) {
  ...
  for (
    ...
    var u = r[l],
      d = i[l],
      f = d.length,
      p = be(e.call(u, u && u.__data__, l, r)),
      m = p.length,
      h = (s[l] = Array(m)),
      g = (o[l] = Array(m));
...
function We(e, t, n) {
  return arguments.length > 1
    ? this.each(
        (t == null ? Ve : typeof t == `function` ? Ue : He)(e, t, n ?? ``),
      )
    : k(this.node(), e);
}
function k(e, t) {
  return (
    ...
    Be(e).getComputedStyle(e, null).getPropertyValue(t)
  );
}
function Ge(e) {
  return function () {
...
function Je(e, t) {
  return arguments.length > 1
    ? this.each((t == null ? Ge : typeof t == `function` ? qe : Ke)(e, t))
    : this.node()[e];
}
function Ye(e) {
...
function rt(e, t) {
  var n = Ye(e + ``);
  if (arguments.length < 2) {
    for (var r = Xe(this.node()), i = -1, a = n.length; ++i < a; )
...
function st(e) {
  return arguments.length
    ? this.each(e == null ? it : (typeof e == `function` ? ot : at)(e))
...
function dt(e) {
  return arguments.length
    ? this.each(e == null ? ct : (typeof e == `function` ? ut : lt)(e))
    : this.node().innerHTML;
}
function ft() {
...
function vt(e, t) {
  var n = typeof e == `function` ? e : x(e),
    r = t == null ? _t : typeof t == `function` ? t : C(t);
  return this.select(function () {
...
function Lt(e) {
  return typeof e == `string`
    ? new A([[document.querySelector(e)]], [document.documentElement])
    : new A([[e]], Ft);
}
function Rt(e, t, n) {
...
var N = 0.7,
  ...
  Ht = RegExp(`^rgb\\(${P},${P},${P}\\)$`),
  Ut = RegExp(`^rgb\\(${I},${I},${I}\\)$`),
  Wt = RegExp(`^rgba\\(${P},${P},${P},${F}\\)$`),
  Gt = RegExp(`^rgba\\(${I},${I},${I},${F}\\)$`),
  Kt = RegExp(`^hsl\\(${F},${I},${I}\\)$`),
  qt = RegExp(`^hsla\\(${F},${I},${I},${F}\\)$`),
  Jt = {
    aliceblue: 15792383,
  ...
  return (
    ...
    (t = Vt.exec(e))
      ...
      : (t = Ht.exec(e))
        ? new z(t[1], t[2], t[3], 1)
        : (t = Ut.exec(e))
          ? new z((t[1] * 255) / 100, (t[2] * 255) / 100, (t[3] * 255) / 100, 1)
          : (t = Wt.exec(e))
            ? R(t[1], t[2], t[3], t[4])
            : (t = Gt.exec(e))
              ? R(
              ...
              : (t = Kt.exec(e))
                ? on(t[1], t[2] / 100, t[3] / 100, 1)
                : (t = qt.exec(e))
                  ? on(t[1], t[2] / 100, t[3] / 100, t[4])
                  : Jt.hasOwnProperty(e)
                    ? $t(Jt[e])
                    : e === `transparent`
                      ? new z(NaN, NaN, NaN, 0)
...
function en(e) {
  return (
    e instanceof M || (e = L(e)),
    e ? ((e = e.rgb()), new z(e.r, e.g, e.b, e.opacity)) : new z()
  );
}
function tn(e, t, n, r) {
...
Rt(
  ...
  zt(M, {
    brighter(e) {
      return (
        (e = e == null ? Bt : Bt ** +e),
        new z(this.r * e, this.g * e, this.b * e, this.opacity)
      );
    },
    darker(e) {
      return (
...
Rt(
  ...
  zt(M, {
    brighter(e) {
      return (
        (e = e == null ? Bt : Bt ** +e),
        new U(this.h, this.s, this.l * e, this.opacity)
      );
    },
    darker(e) {
      return (
    ...
    rgb() {
      var e = (this.h % 360) + (this.h < 0) * 360,
        ...
        i = 2 * n - r;
      return new z(
        dn(e >= 240 ? e - 240 : e + 120, i, r),
        dn(e, i, r),
        dn(e < 120 ? e + 240 : e - 120, i, r),
        this.opacity,
      );
    },
    clamp() {
...
function hn(e, t) {
  var n = t - e;
  return n
    ? pn(e, n > 180 || n < -180 ? n - 360 * Math.round(n / 360) : n)
    : fn(isNaN(e) ? t : e);
}
function gn(e) {
  return (e = +e) == 1
...
var vn = (function e(t) {
  var n = gn(t);
  function r(e, t) {
    var r = n((e = tn(e)).r, (t = tn(t)).r),
      i = n(e.g, t.g),
      a = n(e.b, t.b),
      o = _n(e.opacity, t.opacity);
    return function (t) {
      return (
        (e.r = r(t)),
        (e.g = i(t)),
...
function Cn(e, t) {
  var n = (yn.lastIndex = bn.lastIndex = 0),
    r,
    i,
    a,
    o = -1,
    s = [],
    c = [];
  for (e += ``, t += ``; (r = yn.exec(e)) && (i = bn.exec(t)); )
    ((a = i.index) > n &&
...
function kn(e) {
  return e == null ||
    ...
    ? Tn
    : ((e = e.matrix), En(e.a, e.b, e.c, e.d, e.e, e.f));
}
function An(e, t, n, r) {
  function i(e) {
  ...
  function a(e, r, i, a, o, s) {
    if (e !== i || r !== a) {
      ...
      s.push({ i: c - 4, x: W(e, i) }, { i: c - 2, x: W(r, a) });
  ...
  function o(e, t, n, a) {
    e === t
      ...
      : (e - t > 180 ? (t += 360) : t - e > 180 && (e += 360),
        a.push({ i: n.push(i(n) + `rotate(`, null, r) - 2, x: W(e, t) }));
  }
  function s(e, t, n, a) {
    e === t
      ? t && n.push(i(n) + `skewX(` + t + r)
      : a.push({ i: n.push(i(n) + `skewX(`, null, r) - 2, x: W(e, t) });
  }
  function c(e, t, n, r, a, o) {
    if (e !== n || t !== r) {
      var s = a.push(i(a) + `scale(`, null, `,`, null, `)`);
      o.push({ i: s - 4, x: W(e, n) }, { i: s - 2, x: W(t, r) });
...
Hn.prototype = Un.prototype = {
  ...
  restart: function (e, t, n) {
    ...
    ((n = (n == null ? Bn() : +n) + (t == null ? 0 : +t)),
      !this._next &&
        K !== this &&
        (K ? (K._next = this) : (In = this), (K = this)),
      (this._call = e),
      (this._time = n),
      Jn());
  },
...
function Wn() {
  (Bn(), ++G);
  for (var e = In, t; e; )
    ((t = q - e._time) >= 0 && e._call.call(void 0, t), (e = e._next));
  --G;
}
function Gn() {
...
function qn() {
  for (var e, t = In, n, r = 1 / 0; t; )
    t._call
      ? (r > t._time && (r = t._time), (e = t), (t = t._next))
      : ((n = t._next), (t._next = null), (t = e ? (e._next = n) : (In = n)));
  ((K = e), Jn(r));
}
function Jn(e) {
  G ||
    ((Nn &&= clearTimeout(Nn)),
    e - q > 24
      ? (e < 1 / 0 && (Nn = setTimeout(Gn, e - J.now() - Rn)),
        (Pn &&= clearInterval(Pn)))
      : ((Pn ||= ((Ln = J.now()), setInterval(Kn, Fn))), (G = 1), zn(Gn)));
}
function Yn(e, t, n) {
  var r = new Hn();
  return (
...
var Xn = f(`start`, `end`, `cancel`, `interrupt`),
  Zn = [];
...
function mr(e, t) {
  ...
  return this.attrTween(
    e,
    typeof t == `function`
      ? (n.local ? pr : fr)(n, r, or(this, `attr.` + e, t))
      : t == null
        ? (n.local ? lr : cr)(n)
        : (n.local ? dr : ur)(n, r, t),
  );
...
function Tr(e) {
  var t = this._id;
  return arguments.length
    ? this.each((typeof e == `function` ? Cr : wr)(t, e))
...
function Vr(e, t) {
  ...
  return function () {
    var a = k(this, e),
      o = (this.style.removeProperty(e), k(this, e));
...
function Wr(e, t, n) {
  ...
  return function () {
    var o = k(this, e),
      ...
      c = s + ``;
    return (
      s ?? (c = s = (this.style.removeProperty(e), k(this, e))),
...
function Gr(e, t) {
  ...
  return function () {
    var c = Y(this, e),
      l = c.on,
      u = c.value[a] == null ? (s ||= Hr(t)) : void 0;
...
function Kr(e, t, n) {
  ...
  return t == null
    ? this.styleTween(e, Vr(e, r)).on(`end.style.` + e, Hr(e))
    : typeof t == `function`
      ? this.styleTween(e, Wr(e, r, or(this, `style.` + e, t))).each(
          Gr(this._id, e),
        )
      : this.styleTween(e, Ur(e, r, t), n).on(`end.style.` + e, null);
}
function qr(e, t, n) {
  return function (r) {
...
var ci = { time: null, delay: 0, duration: 250, ease: si };
function li(e, t) {
...
function ui(e) {
  ...
  e instanceof Z
    ? ((t = e._id), (e = e._name))
    : ((t = oi()), ((n = ci).time = Bn()), (e = e == null ? null : e + ``));
  for (var r = this._groups, i = r.length, a = 0; a < i; ++a)
    for (var o = r[a], s = o.length, c, l = 0; l < s; ++l)
      (c = o[l]) && Qn(c, e, t, l, o, n || li(c, t));
