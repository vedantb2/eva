...
import { t as f } from "./chunk-FMBD7UC4-DPlkUf_Q.js";
import { a as p, i as m, o as h, t as g } from "./chunk-TZMSLE5B-sHjcHU8g.js";
var _ = (function () {
...
var v = _,
  ...
  j = {
    getConfig: e(() => s().journey, `getConfig`),
    clear: C,
    setDiagramTitle: i,
    getDiagramTitle: r,
    setAccTitle: n,
  ...
  z = e(function (e, t, n) {
    ...
    (R++,
      i
        ...
        .attr(`stroke`, `#666`),
      P(i, { cx: r, cy: 300 + (5 - t.score) * 30, score: t.score }));
    let a = h();
    ((a.x = t.x),
      (a.y = t.y),
      (a.fill = t.fill),
...
function K(e) {
  ...
  Object.keys(W).forEach((i) => {
    let a = W[i].color,
      o = { cx: 20, cy: r, r: 7, fill: a, stroke: `#000`, pos: W[i].position };
    H.drawCircle(e, o);
...
var q = s().journey,
  ...
  Y = e(function (e, n, r, i) {
    ...
    (_.forEach((e) => {
      ...
      K(m),
      (J = q.leftMargin + G),
      X.insert(0, 0, J, Object.keys(W).length * 50),
      te(m, h, 0));
    let y = X.getBounds();
    g &&
      m
  ...
  te = e(function (e, t, n) {
    ...
    for (let [n, s] of t.entries()) {
      ...
      ((s.x = n * r.taskMargin + n * r.width + J),
        (s.y = a),
        (s.width = r.diagramMarginX),
        (s.height = r.diagramMarginY),
        (s.colour = l),
        (s.fill = c),
        (s.num = u),
        (s.actors = d),
        H.drawTask(e, s, r),
        X.insert(s.x, s.y, s.x + s.width + r.taskMargin, 450));
    }
  }, `drawTasks`),
  $ = { setConf: U, draw: Y },
  ne = {
