...
export function QuickTaskDetailClient({ taskId }: QuickTaskDetailClientProps) {
  ...
  const handleBack = () => {
    router.push(`${basePath}/quick-tasks${viewParam}`);
  };

  const handleNavigatePrev = () => {
    if (prevTaskId)
      router.push(`${basePath}/quick-tasks/${prevTaskId}${viewParam}`);
  };

  const handleNavigateNext = () => {
    if (nextTaskId)
      router.push(`${basePath}/quick-tasks/${nextTaskId}${viewParam}`);
  };
