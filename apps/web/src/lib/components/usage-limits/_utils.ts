...
/**
 * Plan-usage is a Claude reading. Cursor/Codex/OpenCode chats still have a
 * sticky `providerAccountId` (often the last Claude account, or Team), and
 * scoping by that id would paint Claude's numbers beside the wrong picker.
 */
