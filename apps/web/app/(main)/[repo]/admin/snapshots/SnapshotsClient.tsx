      ...
      <div className="rounded-lg border border-border/70 p-4 space-y-4">
        ...
        <div className="grid gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-[11px] text-muted-foreground">
              Commands run during Docker build as the <code>eva</code> user. Use
              user-level setup commands, not root-only package installs like{" "}
              <code>apt-get</code>.
            </p>
          </div>
        ...
        <div className="flex items-center justify-between pt-2 border-t border-border/40">
          <p className="text-[11px] text-muted-foreground">
            ...
            workflow + <code className="font-mono">DAYTONA_API_KEY</code> secret
            in repo, and <code className="font-mono">SNAPSHOT_GITHUB_PAT</code>{" "}
            in Env Variables.
          </p>
