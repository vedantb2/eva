...
import { r as l, t as u } from "./chunk-N4CR4FBY-DlaUQgv4.js";
import { t as d } from "./chunk-55IACEB6-CSmwCh2U.js";
import { t as f } from "./chunk-QN33PNHL-DWym_BkC.js";
var p = [];
...
` + t,
      ...
      let a = i.db,
        o = a.getData(),
        s = d(n, o.config.securityLevel);
      ((o.type = i.type),
        (o.layoutAlgorithm = u(o.config.layout, { fallback: `cose-bilkent` })),
        (o.diagramId = n),
        a.getMindmap() &&
          (o.nodes.forEach((e) => {
            e.shape === `rounded`
          ...
          f(
            s,
            o.config.mindmap?.padding ?? c.mindmap.padding,
            `mindmapDiagram`,
            o.config.mindmap?.useMaxWidth ?? c.mindmap.useMaxWidth,
          )));
    }, `draw`),
  },
  T = t((e) => {
