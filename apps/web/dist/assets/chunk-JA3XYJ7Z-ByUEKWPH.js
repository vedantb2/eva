...
import { i as c } from "./chunk-S3R3BYOJ-qZRxmO84.js";
var l = Object.freeze({ left: 0, top: 0, width: 16, height: 16 }),
  u = Object.freeze({ rotate: 0, vFlip: !1, hFlip: !1 }),
  d = Object.freeze({ ...l, ...u }),
  f = Object.freeze({ ...d, body: ``, hidden: !1 }),
  p = Object.freeze({ width: null, height: null }),
  ee = Object.freeze({ ...p, ...u }),
  m = (e, t, n, r = ``) => {
    let i = e.split(`:`);
    if (e.slice(0, 1) === `@`) {
...
function pe(e, t) {
  ...
  [n, r].forEach((e) => {
    ...
    (o % 2 == 1 &&
      ...
      t.length && (a = de(a, `<g transform="` + t.join(` `) + `">`, `</g>`)));
  });
  let o = r.width,
    s = r.height,
    c = i.width,
    ...
    f;
  o === null
    ? ((f = s === null ? `1em` : s === `auto` ? l : s), (u = ce(f, c / l)))
    : ((u = o === `auto` ? c : o),
      (f = s === null ? ce(u, l / c) : s === `auto` ? l : s));
  let p = {},
    m = (e, t) => {
      fe(t) || (p[e] = t.toString());
    };
  (m(`width`, u), m(`height`, f));
  let h = [i.left, i.top, c, l];
  return ((p.viewBox = h.join(` `)), { attributes: p, viewBox: h, body: a });
}
var me = /\sid="(\S+)"/g,
  he = new Map();
function ge(e) {
...
var be = (() => {
  ...
  Ke = y(Ge, `u`).replace(/punct/g, k).getRegex(),
  qe = y(Ge, `u`).replace(/punct/g, Ve).getRegex(),
  Je = `^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)`,
  Ye = y(Je, `gu`)
  ...
  it = y(/^!?\[(ref)\](?:\[\])?/)
    .replace(`ref`, w)
    .getRegex(),
  at = y(`reflink|nolink(?!\\()`, `g`)
    .replace(`reflink`, rt)
    .replace(`nolink`, it)
    .getRegex(),
  ot = /[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,
  M = {
    _backpedal: v,
    anyPunctuation: Qe,
    autolink: $e,
  ...
  P = { normal: O, gfm: Ne, pedantic: Pe },
  F = { normal: M, gfm: N, breaks: ct, pedantic: st },
  lt = { "&": `&amp;`, "<": `&lt;`, ">": `&gt;`, '"': `&quot;`, "'": `&#39;` },
  ut = (e) => lt[e];
function I(e, t) {
  if (t) {
    if (b.escapeTest.test(e)) return e.replace(b.escapeReplace, ut);
  } else if (b.escapeTestNoEncode.test(e))
    return e.replace(b.escapeReplaceNoEncode, ut);
  return e;
}
function dt(e) {
  try {
...
`
  ...
  z = class e {
    ...
    constructor(e) {
      ...
      let t = { other: b, block: P.normal, inline: F.normal };
      (this.options.pedantic
...
`,
    ...
    blockTokens(e, t = [], n = !1) {
      for (
        this.options.pedantic &&
        (e = e.replace(b.tabCharGlobal, `    `).replace(b.spaceLine, ``));
        e;
      ) {
        let r;
        if (
...
` + r.text),
  ...
  B = class {
    ...
    code({ text: e, lang: t, escaped: n }) {
      let r = (t || ``).match(b.notSpaceStart)?.[0],
        i =
          e.replace(b.endingNewline, ``) +
          `
`;
      return r
...
var _t = {
  ...
  St = t(async (t, n, i) => {
    ...
    let o = pe(a, n);
    return r(ve(_e(o.body), { ...o.attributes, ...i }), s());
  }, `getIconSVG`);
...
`,
      ...
      : r(t.label, u),
    ee = t.isNode ? `nodeLabel` : `edgeLabel`,
    m = f.append(`span`);
  (m.html(p),
    X(m, t.labelStyle),
    m.attr(`class`, `${ee} ${c}`),
  ...
  return (
    h.width === n &&
      ...
      f.style(`width`, n + `px`),
      (h = f.node().getBoundingClientRect())),
    d.node()
  );
}
t(Ot, `addHtmlSpan`);
...
function jt(e, n, r, i = !1) {
  let a = 1.1,
    ...
    l = 0;
  for (let n of r) {
    let r = t((t) => kt(o, a, t) <= e, `checkWidth`),
      i = r(n) ? [n] : Dt(n, r);
    ...
    (e, i, a) => (
      n.push(
        (async () => {
          let n = `${i}:${a}`;
          return (await xt(n))
            ? await St(n, void 0, { class: `label-icon` })
            : `<i class='${r(e, t).replace(`:`, ` `)}'></i>`;
        })(),
      ),
      e
    ),
...
var Mt = t(
  async (
    ...
    if (
      (e.debug(`XYZ createText`, r, i, o, s, l, u, `addSvgBackground: `, f), l)
    ) {
      let e = await $(c(Tt(r, p)), p),
        n = r.replace(/\\\\/g, `\\`);
      return await Ot(
        t,
        {
      ...
      let e = jt(
        d,
        t,
        wt(r.replace(/<br\s*\/?>/g, `<br/>`).replace(`<br>`, `<br/>`), p),
        r ? f : !1,
      );
      if (u) {
