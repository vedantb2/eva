import { g as e, h as t, m as n, p as r } from "./src-BAB06iur.js";
import {
  B as i,
  C as a,
  U as o,
...
import { t as p } from "./channel-Sh0HKanG.js";
...
import { t as v } from "./chunk-55IACEB6-CSmwCh2U.js";
import { t as y } from "./chunk-QN33PNHL-DWym_BkC.js";
var b = (function () {
  var e = t(function (e, t, n, r) {
      for (n ||= {}, r = e.length; r--; n[e[r]] = t);
      return n;
    }, `o`),
    n = [6, 8, 10, 22, 24, 26, 28, 33, 34, 35, 36, 37, 40, 43, 44, 50],
    r = [1, 10],
    i = [1, 11],
    a = [1, 12],
    o = [1, 13],
...
var x = b,
  S = class {
    constructor() {
      ((this.entities = new Map()),
        ...
        (this.getConfig = t(() => l().er, `getConfig`)),
        this.clear(),
    ...
    getData() {
      ...
      for (let e of this.relationships) {
        let i = {
          id: h(e.entityA, e.entityB, { prefix: `id`, counter: r++ }),
          type: `normal`,
          curve: `basis`,
          start: e.entityA,
          end: e.entityB,
  ...
  C = {};
n(C, { draw: () => w });
var w = t(async function (t, n, i, a) {
    (e.info(`REF0:`), e.info(`Drawing er diagram (unified)`, n));
    let { securityLevel: o, er: s, layout: c } = l(),
      u = a.db.getData(),
      d = v(n, o);
    ((u.type = a.type),
      (u.layoutAlgorithm = _(c)),
      (u.config.flowchart.nodeSpacing = s?.nodeSpacing || 140),
      (u.config.flowchart.rankSpacing = s?.rankSpacing || 80),
      (u.direction = a.db.getDirection()),
      (u.markers = [`only_one`, `zero_or_one`, `one_or_more`, `zero_or_more`]),
      (u.diagramId = n),
      await g(u, d),
      u.layoutAlgorithm === `elk` && d.select(`.edges`).lower());
    let f = d.selectAll(`[id*="-background"]`);
    (Array.from(f).length > 0 &&
      f.each(function () {
        let e = r(this),
      ...
      y(d, 8, `erDiagram`, s?.useMaxWidth ?? !0));
  }, `draw`),
  T = t((e, t) => {
    let n = p;
