...
import { t as h } from "./linear-CavJTP_n.js";
var g = (function () {
    ...
    getDefaultConfig() {
      return {
        ...
        quadrantInternalBorderStrokeWidth:
          f.quadrantChart?.quadrantInternalBorderStrokeWidth || 1,
        quadrantExternalBorderStrokeWidth:
          f.quadrantChart?.quadrantExternalBorderStrokeWidth || 2,
      };
    }
...
` + r,
      ...
      let p = f.securityLevel,
        m;
      p === `sandbox` && (m = n(`#i` + i));
      let h = n(
          p === `sandbox` ? m.nodes()[0].contentDocument.body : `body`,
        ).select(`[id="${i}"]`),
        g = h.append(`g`).attr(`class`, `main`),
        _ = f.quadrantChart?.chartWidth ?? 500,
        v = f.quadrantChart?.chartHeight ?? 500;
      (d(h, v, _, f.quadrantChart?.useMaxWidth ?? !0),
