  ...
  return (
    <SettingsPage title="Experimental">
      ...
      >
        ...
        <SettingsToggleRow
          title="Simple view"
          description="Hide reviews, diffs, context usage, automations, sandbox Files / Console / Editor / Computer / New Preview, repo settings for Repository through Logs, global Sandboxes / Sync, and team Codebases / Env Variables. Chat plus Preview, Browser, Plan, and Designs."
          action={
            <Switch
