      ...
      {isExpanded && (
        <tr>
          <td colSpan={8} className="px-4 py-3">
            ...
            {build.logs ? (
              <pre className="max-h-64 overflow-y-auto overflow-x-hidden scrollbar scroll-fade rounded bg-muted/50 p-2 font-mono text-[10px] leading-relaxed whitespace-pre-wrap break-all sm:p-3 sm:text-[11px]">
                {build.logs}
              </pre>
            ) : (
