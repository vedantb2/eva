...
import { t as m } from "./channel-Sh0HKanG.js";
import { h, s as g } from "./chunk-S3R3BYOJ-qZRxmO84.js";
import { n as _, t as te } from "./chunk-MI3HLSF2-pv_-_-Zb.js";
...
import { o as ne } from "./chunk-JZLCHNYA-DexENr_S.js";
import "./chunk-QXUST7PY-B--XlkK4.js";
import { r as re, t as v } from "./chunk-N4CR4FBY-DlaUQgv4.js";
import { t as y } from "./chunk-FMBD7UC4-DPlkUf_Q.js";
import { t as b } from "./chunk-55IACEB6-CSmwCh2U.js";
import { t as x } from "./chunk-QN33PNHL-DWym_BkC.js";
var S = `flowchart-`,
  C = class {
    constructor() {
...
` +
    ...
    addSingleLink(t, n, r, i) {
      ...
      if (
        ...
        e.length === 0
          ? (a.id = g(a.start, a.end, { counter: 0, prefix: `L` }))
          : (a.id = g(a.start, a.end, { counter: e.length + 1, prefix: `L` }));
      }
      if (this.edges.length < (this.config.maxEdges ?? 500))
        (e.info(`Pushing edge...`), this.edges.push(a));
      else
...
You have to call mermaid.initialize.`);
    ...
    setLink(e, t, n) {
      (e.split(`,`).forEach((e) => {
        ...
        r !== void 0 &&
          ((r.link = h.formatUrl(t, this.config)), (r.linkTarget = n));
      }),
    ...
    addSubGraph(n, r, i) {
      ...
      if (
        ((u ??= d.inheritDir
          ? (this.getDirection() ?? l().direction ?? void 0)
          : void 0),
        this.version === `gen-1`)
      )
      ...
      return (
        e.info(`Adding`, f.id, f.nodes, f.dir),
    ...
    getData() {
      ...
      return (
        o.forEach((t, r) => {
          ...
          let c = {
            id: g(t.start, t.end, { counter: r, prefix: `L` }, t.id),
  ...
  w = {
    ...
    draw: t(async function (t, r, i, a) {
      ...
      let { securityLevel: o, flowchart: s, layout: c } = l(),
        u;
      o === `sandbox` && (u = n(`#i` + r));
      ...
      e.debug(`Data: `, f);
      let p = b(r, o),
        ee = a.db.getDirection();
      ((f.type = a.type),
        (f.layoutAlgorithm = v(c)),
        ...
        (f.direction = ee),
        (f.nodeSpacing = s?.nodeSpacing || 50),
        (f.rankSpacing = s?.rankSpacing || 50),
      ...
      (h.insertTitle(
        ...
        x(p, m, `flowchart`, s?.useMaxWidth || !1));
  ...
  T = (function () {
    var e = t(function (e, t, n, r) {
      ...
      Ze = [1, 156],
      F = [8, 9, 11],
      I = [8, 9, 10, 11, 14, 44, 60, 89, 105, 106, 109, 111, 114, 115, 116],
      L = [1, 176],
      R = [1, 172],
      z = [1, 173],
      B = [1, 177],
      ...
      $e = [10, 106],
      W = [31, 49, 51, 53, 55, 57, 62, 64, 66, 67, 69, 71, 116, 117, 118],
      G = [1, 247],
      K = [1, 245],
      q = [1, 249],
      J = [1, 243],
      ...
      nt = {
        ...
        table: [
          ...
          e(a, [2, 10]),
          e(a, [2, 11]),
          { 8: [1, 54], 9: [1, 55], 10: O, 15: 53, 18: 56 },
          e(k, [2, 3]),
          e(k, [2, 4]),
          e(k, [2, 5]),
          e(k, [2, 6]),
          ...
          { 8: A, 9: j, 11: M, 21: 70 },
          { 8: A, 9: j, 11: M, 21: 71 },
          { 8: A, 9: j, 10: [1, 72], 11: M, 21: 73 },
          e(k, [2, 36]),
          { 35: [1, 74] },
          { 37: [1, 75] },
          e(k, [2, 39]),
          e(se, [2, 50], { 18: 76, 39: 77, 10: O, 40: ce }),
          { 10: [1, 79] },
          { 10: [1, 80] },
          { 10: [1, 81] },
          { 10: [1, 82] },
          ...
          e(k, [2, 41]),
          e(k, [2, 42]),
          e(Se, [2, 76], { 73: 116, 62: [1, 118], 74: [1, 117] }),
          { 76: 119, 79: 120, 80: Ce, 81: we, 116: Te, 119: Ee },
          { 75: [1, 125], 77: [1, 126] },
          e(De, [2, 83]),
          e(k, [2, 28]),
          e(k, [2, 29]),
          ...
          { 30: 170, 67: L, 80: R, 81: z, 82: 171, 116: B, 117: V, 118: H },
          { 30: 178, 67: L, 80: R, 81: z, 82: 171, 116: B, 117: V, 118: H },
          {
            30: 180,
            50: [1, 179],
            67: L,
          ...
          { 30: 181, 67: L, 80: R, 81: z, 82: 171, 116: B, 117: V, 118: H },
          { 30: 182, 67: L, 80: R, 81: z, 82: 171, 116: B, 117: V, 118: H },
          { 30: 183, 67: L, 80: R, 81: z, 82: 171, 116: B, 117: V, 118: H },
          { 109: [1, 184] },
          { 30: 185, 67: L, 80: R, 81: z, 82: 171, 116: B, 117: V, 118: H },
          {
            30: 186,
            65: [1, 187],
            67: L,
          ...
          { 30: 188, 67: L, 80: R, 81: z, 82: 171, 116: B, 117: V, 118: H },
          { 30: 189, 67: L, 80: R, 81: z, 82: 171, 116: B, 117: V, 118: H },
          { 30: 190, 67: L, 80: R, 81: z, 82: 171, 116: B, 117: V, 118: H },
          e(P, [2, 182]),
          e(a, [2, 20]),
          e(xe, [2, 25]),
          e(se, [2, 46], { 39: 191, 18: 192, 10: O, 40: ce }),
          e(Se, [2, 73], { 10: [1, 193] }),
          { 10: [1, 194] },
          { 30: 195, 67: L, 80: R, 81: z, 82: 171, 116: B, 117: V, 118: H },
          { 77: [1, 196], 79: 197, 116: Te, 119: Ee },
          e(Qe, [2, 79]),
          e(Qe, [2, 81]),
          e(Qe, [2, 82]),
          e(Qe, [2, 168]),
          e(Qe, [2, 169]),
          { 76: 198, 79: 120, 80: Ce, 81: we, 116: Te, 119: Ee },
          e(De, [2, 84]),
          {
            8: A,
            9: j,
          ...
          { 31: [1, 217], 67: L, 82: 218, 116: B, 117: V, 118: H },
          e(W, [2, 86]),
          e(W, [2, 88]),
          e(W, [2, 89]),
          e(W, [2, 153]),
          ...
          e(W, [2, 155]),
          e(W, [2, 156]),
          { 49: [1, 219], 67: L, 82: 218, 116: B, 117: V, 118: H },
          { 30: 220, 67: L, 80: R, 81: z, 82: 171, 116: B, 117: V, 118: H },
          { 51: [1, 221], 67: L, 82: 218, 116: B, 117: V, 118: H },
          { 53: [1, 222], 67: L, 82: 218, 116: B, 117: V, 118: H },
          { 55: [1, 223], 67: L, 82: 218, 116: B, 117: V, 118: H },
          { 57: [1, 224], 67: L, 82: 218, 116: B, 117: V, 118: H },
          { 60: [1, 225] },
          { 64: [1, 226], 67: L, 82: 218, 116: B, 117: V, 118: H },
          { 66: [1, 227], 67: L, 82: 218, 116: B, 117: V, 118: H },
          { 30: 228, 67: L, 80: R, 81: z, 82: 171, 116: B, 117: V, 118: H },
          { 31: [1, 229], 67: L, 82: 218, 116: B, 117: V, 118: H },
          {
            67: L,
            69: [1, 230],
            71: [1, 231],
          ...
          e(se, [2, 45], { 18: 155, 10: O, 40: Ze }),
          e(se, [2, 47], { 44: Xe }),
          e(Se, [2, 75]),
          e(Se, [2, 74]),
          { 62: [1, 234], 67: L, 82: 218, 116: B, 117: V, 118: H },
          e(Se, [2, 77]),
          e(Qe, [2, 80]),
          { 77: [1, 235], 79: 197, 116: Te, 119: Ee },
          { 30: 236, 67: L, 80: R, 81: z, 82: 171, 116: B, 117: V, 118: H },
          e(Ye, o, { 5: 237 }),
          e(U, [2, 102]),
          e(k, [2, 35]),
          {
          ...
          e(W, [2, 87]),
          e(N, [2, 57]),
          { 51: [1, 262], 67: L, 82: 218, 116: B, 117: V, 118: H },
          e(N, [2, 64]),
          e(N, [2, 59]),
          e(N, [2, 60]),
          e(N, [2, 61]),
          ...
          e(N, [2, 63]),
          e(N, [2, 65]),
          { 66: [1, 264], 67: L, 82: 218, 116: B, 117: V, 118: H },
          e(N, [2, 67]),
          e(N, [2, 68]),
          e(N, [2, 70]),
          e(N, [2, 69]),
          ...
          e(Se, [2, 78]),
          { 31: [1, 265], 67: L, 82: 218, 116: B, 117: V, 118: H },
          {
            6: 11,
            7: 12,
            8: s,
          ...
          e(F, [2, 120]),
          e(N, [2, 58]),
          { 30: 282, 67: L, 80: R, 81: z, 82: 171, 116: B, 117: V, 118: H },
          e(N, [2, 66]),
          e(Ye, o, { 5: 283 }),
          e(tt, [2, 131], {
            108: 269,
          ...
          e(F, [2, 114]),
          { 31: [1, 286], 67: L, 82: 218, 116: B, 117: V, 118: H },
          {
            6: 11,
            7: 12,
            8: s,
...
`,
    ...
    init: t((e) => {
      ((e.flowchart ||= {}),
        ...
        a({ flowchart: { arrowMarkerAbsolute: e.arrowMarkerAbsolute } }));
    }, `init`),
  };
