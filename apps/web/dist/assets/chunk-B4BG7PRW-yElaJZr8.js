...
import { h as m, s as h } from "./chunk-S3R3BYOJ-qZRxmO84.js";
import { r as g, t as _ } from "./chunk-N4CR4FBY-DlaUQgv4.js";
import { t as v } from "./chunk-FMBD7UC4-DPlkUf_Q.js";
import { t as y } from "./chunk-55IACEB6-CSmwCh2U.js";
import { t as b } from "./chunk-QN33PNHL-DWym_BkC.js";
var x = (function () {
  var e = t(function (e, t, n, r) {
    ...
    I = [1, 8, 9, 41],
    ee = [1, 76],
    L = [1, 8, 9, 12, 13, 22, 39, 41, 44, 68, 69, 70, 71, 72, 73, 74, 79, 81],
    R = [
      1, 8, 9, 12, 13, 18, 20, 22, 39, 41, 44, 50, 60, 68, 69, 70, 71, 72, 73,
      74, 79, 81, 86, 100, 102, 103,
    ],
    z = [13, 60, 86, 100, 102, 103],
    B = [13, 60, 73, 74, 86, 100, 102, 103],
    te = [13, 60, 68, 69, 70, 71, 72, 86, 100, 102, 103],
    V = [1, 100],
    H = [1, 117],
    U = [1, 113],
    W = [1, 109],
    ...
    oe = {
      ...
      table: [
        ...
        e(O, [2, 54]),
        { 67: 92, 73: P, 74: F },
        e(z, [2, 73], { 66: 93, 68: k, 69: A, 70: j, 71: M, 72: N }),
        e(B, [2, 74]),
        e(B, [2, 75]),
        e(B, [2, 76]),
        e(B, [2, 77]),
        ...
        e(z, [2, 72], { 66: 131, 68: k, 69: A, 70: j, 71: M, 72: N }),
        e(z, [2, 71]),
        { 41: [1, 132] },
...
var S = x,
  ...
  w = class {
    ...
    getDisplayDetails() {
      ...
      (this.memberType === `method` &&
        ((e += `(${r(this.parameters.trim())})`),
        this.returnType && (e += ` : ` + r(this.returnType))),
        (e = e.trim()));
    ...
    parseMember(e) {
      ...
      if (this.memberType === `method`) {
        ...
        if (n) {
          let e = n[1] ? n[1].trim() : ``;
          if (
            (C.includes(e) && (this.visibility = e),
            (this.id = n[2]),
        ...
        let n = e.length,
          r = e.substring(0, 1),
          i = e.substring(n - 1);
        (C.includes(r) && (this.visibility = r),
          /[$*]/.exec(i) && (t = i),
          (this.id = e.substring(
            this.visibility === `` ? 0 : 1,
            t === `` ? n : n - 1,
      ...
      ((this.classifier = t),
        (this.id = this.id.startsWith(` `)
          ...
          : this.id.trim()),
        (this.text =
          `${this.visibility ? `\\` + this.visibility : ``}${r(this.id)}${this.memberType === `method` ? `(${r(this.parameters)})${this.returnType ? ` : ` + r(this.returnType) : ``}` : ``}`
            .replaceAll(`<`, `&lt;`)
            .replaceAll(`>`, `&gt;`)),
  ...
  T = `classId-`,
  E = 0,
  D = t((e) => d.sanitizeText(e, u()), `sanitizeText`),
  O = class {
    constructor() {
      ((this.relations = []),
        ...
        (this.getConfig = t(() => u().class, `getConfig`)),
    ...
    addRelation(t) {
      ...
      !n.includes(t.relation.type2)
        ...
        (t.relationTitle1 = d.sanitizeText(t.relationTitle1.trim(), u())),
        (t.relationTitle2 = d.sanitizeText(t.relationTitle2.trim(), u())),
    ...
    addMember(e, t) {
      ...
      if (typeof t == `string`) {
        ...
        e.startsWith(`<<`) && e.endsWith(`>>`)
          ? r.annotations.push(D(e.substring(2, e.length - 2)))
          : e.indexOf(`)`) > 0
            ? r.methods.push(new w(e, `method`))
            : e && r.members.push(new w(e, `attribute`));
      }
    }
    addMembers(e, t) {
    ...
    getData() {
      ...
      for (let e of this.relations) {
        r++;
        let i = {
          id: h(e.id1, e.id2, { prefix: `id`, counter: r }),
          start: e.id1,
          end: e.id2,
          type: `normal`,
          label: e.title,
  ...
  A = {
    ...
    draw: t(async function (t, n, r, i) {
      ...
      ((c.type = i.type),
        ...
        b(l, 8, `classDiagram`, o?.useMaxWidth ?? !0));
    }, `draw`),
    getDir: t((e, t = `TB`) => {
      if (!e.doc) return t;
      let n = t;
