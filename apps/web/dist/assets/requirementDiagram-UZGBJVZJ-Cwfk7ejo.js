import { g as e, h as t, m as n } from "./src-BAB06iur.js";
import {
  B as r,
  C as i,
  U as a,
...
import { h as d } from "./chunk-S3R3BYOJ-qZRxmO84.js";
...
import { r as f, t as p } from "./chunk-N4CR4FBY-DlaUQgv4.js";
...
var g = (function () {
  var e = t(function (e, t, n, r) {
    ...
    le = {
      ...
      table: [
        { 3: 1, 4: 2, 6: n, 9: r, 11: i, 13: a },
        { 1: [3] },
        { 3: 8, 4: 2, 5: [1, 7], 6: n, 9: r, 11: i, 13: a },
        { 5: [1, 9] },
        { 10: [1, 10] },
        { 12: [1, 11] },
        e(o, [2, 6]),
        { 3: 12, 4: 2, 6: n, 9: r, 11: i, 13: a },
        { 1: [2, 2] },
        {
          4: 17,
          5: s,
  ...
  v = class {
    constructor() {
      ((this.relations = []),
        ...
        (this.getConfig = t(() => c().requirement, `getConfig`)),
        this.clear(),
...
var x = t(async function (t, n, r, i) {
    ...
    ((l.type = i.type),
      ...
      h(u, 8, `requirementDiagram`, o?.useMaxWidth ?? !0));
  }, `draw`),
  S = {
    parser: _,
    get db() {
