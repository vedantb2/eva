...
export const GanttFeatureItem: FC<GanttFeatureItemProps> = ({
  ...
  const indicatorClass =
    "absolute top-1/2 z-[4] flex -translate-y-1/2 items-center gap-1 whitespace-nowrap rounded-control bg-background/95 px-2 py-0.5 text-[10px] font-medium text-muted-foreground smooth-shadow-ring-sm backdrop-blur transition-colors hover:text-foreground";
