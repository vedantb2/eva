...
import { g as p, n as m, t as h } from "./chunk-S3R3BYOJ-qZRxmO84.js";
import { t as g } from "./dist-sj4ly5hH.js";
import { i as _, o as v } from "./chunk-TZMSLE5B-sHjcHU8g.js";
var y = g(),
  b = (function () {
...
var x = b,
  ...
  ee = t(function (e, t, n, r, i, a, o, s, l, u, d) {
  ...
  Y = (function () {
    ...
    function n(e, t, n, r, a, o, s, l) {
      let { fontSize: d, fontFamily: f, fontWeight: p } = l,
        m = e.split(u.lineBreakRegex);
      for (let e = 0; e < m.length; e++) {
        let o = e * d - (d * (m.length - 1)) / 2,
          l = t
            .append(`text`)
            .attr(`x`, n + a / 2)
            .attr(`y`, r)
...
function Q(e, t, n, r, i) {
  if (!t[e].width)
    if (n)
      ((t[e].text = p(t[e].text, i, r)),
        (t[e].textLines = t[e].text.split(u.lineBreakRegex).length),
        (t[e].width = i),
        (t[e].height = h(t[e].text, r)));
    else {
      ...
      for (let a of n)
        ((t[e].width = Math.max(m(a, r), t[e].width)),
          (i = h(a, r)),
          (t[e].height = t[e].height + i));
    }
}
t(Q, `calcC4ShapeTextWH`);
var Pe = t(function (e, t, n) {
    ((t.x = n.data.startx),
      (t.y = n.data.starty),
    ...
    ((i.fontSize += 2),
      (i.fontWeight = `bold`),
      Q(`label`, t, r, i, m(t.label.text, i)),
  ...
  Fe = t(function (e, t, n, r) {
    ...
    for (let a of r) {
      i = 0;
      let r = n[a],
        o = je(Z, r.typeC4Shape.text);
      switch (
        ((o.fontSize -= 2),
        (r.typeC4Shape.width = m(`«` + r.typeC4Shape.text + `»`, o)),
      ...
      r.sprite &&
        ...
        (i = r.image.Y + r.image.height));
      let s = r.wrap && Z.wrap,
        l = Z.width - Z.c4ShapePadding * 2,
        u = je(Z, r.typeC4Shape.text);
      ((u.fontSize += 2),
        (u.fontWeight = `bold`),
        Q(`label`, r, s, u, l),
        (r.label.Y = i + 8),
        ...
        r.type && r.type.text !== ``
          ? ((r.type.text = `[` + r.type.text + `]`),
            Q(`type`, r, s, je(Z, r.typeC4Shape.text), l),
            (r.type.Y = i + 5),
            (i = r.type.Y + r.type.height))
          : r.techn &&
            r.techn.text !== `` &&
            ((r.techn.text = `[` + r.techn.text + `]`),
            Q(`techn`, r, s, je(Z, r.techn.text), l),
            (r.techn.Y = i + 5),
      ...
      (r.descr &&
        r.descr.text !== `` &&
        (Q(`descr`, r, s, je(Z, r.typeC4Shape.text), l),
        (r.descr.Y = i + 20),
        (i = r.descr.Y + r.descr.height),
        (f = Math.max(r.label.width, r.descr.width)),
        (d = i - r.descr.textLines * 5)),
        (f += Z.c4ShapePadding),
        (r.width = Math.max(r.width || Z.width, f, Z.width)),
        (r.height = Math.max(r.height || Z.height, d, Z.height)),
  ...
  Re = t(function (e, t, n, r) {
    ...
    for (let e of t) {
      ...
      (Q(`label`, e, t, a, o),
        e.techn &&
          e.techn.text !== `` &&
          ((o = m(e.techn.text, a)), Q(`techn`, e, t, a, o)),
        e.descr &&
          e.descr.text !== `` &&
          ((o = m(e.descr.text, a)), Q(`descr`, e, t, a, o)));
  ...
  for (let [o, s] of r.entries()) {
    ...
    if (
      ...
      s.type &&
        ...
        Q(`type`, s, l, Me(Z), a.data.widthLimit),
        (s.type.Y = r + 5),
    ...
    (p.length > 0 && ze(e, t, a, p, i),
      s.alias !== `global` && Pe(e, s, a),
      ...
      (Te = Math.max(Te, n.data.stopx)),
      (Ee = Math.max(Ee, n.data.stopy)));
  }
}
...
var Be = {
    ...
    draw: t(function (t, r, i, a) {
      ...
      (m.setData(
        ...
        (Ee = Z.diagramMarginY));
      let h = a.db.getTitle();
      (ze(p, ``, m, a.db.getBoundaries(``), a),
        X.insertArrowHead(p),
        X.insertArrowEnd(p),
        X.insertArrowCrossHead(p),
        X.insertArrowFilledHead(p),
        Re(p, a.db.getRels(), a.db.getC4Shape, a),
        (m.data.stopx = Te),
        (m.data.stopy = Ee));
      let g = m.data,
