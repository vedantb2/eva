...
function De() {
  ((this.size = 0),
    (this.__data__ = { hash: new b(), map: new (k || O)(), string: new b() }));
}
function Oe(e) {
  var t = typeof e;
...
((N.prototype.clear = Pe),
  (N.prototype.delete = Fe),
  (N.prototype.get = Ie),
  (N.prototype.has = Le),
  (N.prototype.set = ze));
function Be(e) {
...
var B = typeof exports == `object` && exports && !exports.nodeType && exports,
  V = B && typeof module == `object` && module && !module.nodeType && module,
  H = V && V.exports === B ? n.Buffer : void 0,
  U = (H ? H.isBuffer : void 0) || Ze,
  Qe = `[object Arguments]`,
  $e = `[object Array]`,
  et = `[object Boolean]`,
  tt = `[object Date]`,
  ...
  W = {};
((W[pt] = W[mt] = W[ht] = W[gt] = W[_t] = W[vt] = W[yt] = W[bt] = W[xt] = !0),
  (W[Qe] =
    W[$e] =
    W[dt] =
    W[et] =
...
var K = typeof exports == `object` && exports && !exports.nodeType && exports,
  q = K && typeof module == `object` && module && !module.nodeType && module,
  J = q && q.exports === K && e.process,
  Y = (function () {
    try {
      return (
        (q && q.require && q.require(`util`).types) ||
        (J && J.binding && J.binding(`util`))
      );
    } catch {}
  })(),
  X = Y && Y.isTypedArray,
