...
import { t as d } from "./arc-BTT0EZWp.js";
var f = (function () {
  var e = t(function (e, t, n, r) {
      for (n ||= {}, r = e.length; r--; n[e[r]] = t);
      return n;
    }, `o`),
    n = [6, 8, 10, 11, 12, 14, 16, 17, 20, 21],
    r = [1, 9],
    i = [1, 10],
    a = [1, 11],
    o = [1, 12],
...
var h = ``,
  ...
  D = t(function (e) {
    let t = { section: h, type: h, description: e, task: e, classes: [] };
    v.push(t);
  }, `addTaskOrg`),
  O = t(function () {
    let e = t(function (e) {
  ...
  R = t(function (e, t, n) {
    ...
    (L++,
      i
        ...
        .attr(`stroke`, `#666`),
      M(i, { cx: r, cy: 300 + (5 - t.score) * 30, score: t.score }));
    let a = V();
    ((a.x = t.x),
      (a.y = t.y),
      (a.fill = t.fill),
...
var G = t(function (e, t, n, r) {
  ...
  Y = t(function (t, n, i, o) {
    let s = l(),
      c = s.timeline?.leftMargin ?? 50;
    e.debug(`timeline`, o.db);
    let u = s.securityLevel,
      d;
    u === `sandbox` && (d = r(`#i` + n));
    let f = r(
    ...
    f.append(`g`);
    let p = o.db.getTasks(),
      m = o.db.getCommonDb().getDiagramTitle();
    ...
    (e.debug(`maxSectionHeight before draw`, g),
      e.debug(`maxTaskHeight before draw`, _),
      h && h.length > 0
        ? h.forEach((t) => {
            let n = p.filter((e) => e.section === t),
              r = {
                number: S,
                descr: t,
                section: S,
            ...
            let i = f.append(`g`),
              a = J.drawNode(i, r, S, s);
            (e.debug(`sectionNode output`, a),
              i.attr(`transform`, `translate(${b}, ${y})`),
              (x += g + 50),
              n.length > 0 && X(f, n, S, b, x, _, s, w, T, g, !1),
              (b += 200 * Math.max(n.length, 1)),
              (x = y),
              S++);
          })
    ...
    (e.debug(`bounds`, E),
      ...
      a(void 0, f, s.timeline?.padding ?? 50, s.timeline?.useMaxWidth ?? !1));
  }, `draw`),
  X = t(function (t, n, r, i, a, o, s, c, l, u, d) {
    for (let c of n) {
      let n = {
        descr: c.task,
        section: r,
      ...
      let u = t.append(`g`).attr(`class`, `taskWrapper`),
        f = J.drawNode(u, n, r, s).height;
      if (
        (e.debug(`taskHeight after draw`, f),
