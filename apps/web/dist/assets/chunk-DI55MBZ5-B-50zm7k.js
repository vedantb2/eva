...
import { h as d, o as f } from "./chunk-S3R3BYOJ-qZRxmO84.js";
import { r as p } from "./chunk-N4CR4FBY-DlaUQgv4.js";
import { t as m } from "./chunk-55IACEB6-CSmwCh2U.js";
import { t as h } from "./chunk-QN33PNHL-DWym_BkC.js";
var g = (function () {
    ...
    draw: t(async function (t, n, r, i) {
      ...
      try {
        (typeof i.db.getLinks == `function`
          ...
          let i = u.node()?.querySelectorAll(`g`),
            a;
          if (
            (i?.forEach((e) => {
    ...
    (e.trace(`items`, n),
      n.forEach((e) => {
        switch (e.stmt) {
          ...
          case C:
            {
              (X(t, e.state1, r, i, a, o, l, u),
                X(t, e.state2, r, i, a, o, l, u));
              let n = {
                id: `edge` + G,
                start: e.state1.id,
                end: e.state2.id,
...
var X = t((t, n, r, i, a, o, l, u) => {
    ...
    if ((e.info(`dataFetcher parsedItem`, n, f, m), d !== `root`)) {
      ...
      (n.description &&
        (Array.isArray(s.description)
          ? ((s.shape = F), s.description.push(n.description))
          : s.description?.length && s.description.length > 0
            ? ((s.shape = F),
              s.description === d
                ? (s.description = [n.description])
                : (s.description = [s.description, n.description]))
            : ((s.shape = P), (s.description = n.description)),
        (s.description = c.sanitizeTextOrArray(s.description, h))),
        s.description?.length === 1 &&
          s.shape === F &&
          (s.type === `group` ? (s.shape = L) : (s.shape = P)),
        !s.type &&
          n.doc &&
          (e.info(`Setting cluster for XCX`, d, q(n)),
          (s.type = `group`),
          (s.isGroup = !0),
          (s.dir = q(n)),
          (s.shape = n.type === O ? I : L),
          (s.cssClasses = `${s.cssClasses} ${le} ${o ? ue : ``}`)));
      let f = {
        labelStyle: ``,
        shape: s.shape,
        label: s.description,
      ...
      if (
        ...
        t &&
          t.id !== `root` &&
          (e.trace(`Setting node `, d, ` to be child of its parent `, t.id),
          (f.parentId = t.id)),
        (f.centerLabel = !0),
        n.note)
      ) {
        ...
        let o = d,
          c = e.id;
        (n.note.position === `left of` && ((o = e.id), (c = d)),
          a.push({
            id: o + `-` + c,
            start: o,
            end: c,
    ...
    n.doc &&
      (e.trace(`Adding nodes children `), me(n, n.doc, r, i, a, !o, l, u));
  }, `dataFetcher`),
  ge = t(() => {
    (W.clear(), (G = 0));
  }, `reset`),
  ...
  ve = class {
    constructor(e) {
      ((this.version = e),
        ...
        (this.getAccTitle = l),
        (this.setAccTitle = n),
        (this.getAccDescription = a),
        (this.setAccDescription = u),
        (this.setDiagramTitle = i),
        (this.getDiagramTitle = r),
        this.clear(),
    ...
    docTranslator(e, t, n) {
      ...
      if (r.length > 0 && i.length > 0) {
        let e = { stmt: x, id: f(), type: `divider`, doc: $(i) };
        (r.push($(e)), (t.doc = r));
      }
    ...
    addState(
      ...
      let d = t?.trim();
      if (!this.currentDocument.states.has(d))
        (e.info(`Adding state `, d, i),
          this.currentDocument.states.set(d, {
            stmt: x,
            id: d,
            descriptions: [],
            type: n,
      ...
      if (
        (i &&
          (e.info(`Setting state description`, d, i),
          (Array.isArray(i) ? i : [i]).forEach((e) =>
            this.addDescription(d, e.trim()),
          )),
        a)
      ) {
        let e = this.currentDocument.states.get(d);
      ...
      (o &&
        (e.info(`Setting state classes`, d, o),
        (Array.isArray(o) ? o : [o]).forEach((e) =>
          this.setCssClass(d, e.trim()),
        )),
        l &&
          (e.info(`Setting state styles`, d, l),
          (Array.isArray(l) ? l : [l]).forEach((e) =>
            this.setStyle(d, e.trim()),
          )),
        u &&
          (e.info(`Setting state styles`, d, l),
          (Array.isArray(u) ? u : [u]).forEach((e) =>
            this.setTextStyle(d, e.trim()),
          )));
    }
    clear(e) {
      ((this.nodes = []),
