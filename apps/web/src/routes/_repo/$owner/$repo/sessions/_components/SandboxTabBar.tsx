...
const TAB_TRIGGER_CLASS =
  "relative flex items-center gap-1.5 rounded-none rounded-t-md border border-b-0 px-3 py-1 text-xs font-medium data-[state=active]:z-10 data-[state=active]:border-border data-[state=active]:bg-card data-[state=active]:shadow-none data-[state=inactive]:border-transparent data-[state=inactive]:bg-transparent data-[state=inactive]:text-muted-foreground data-[state=inactive]:hover:text-foreground";
