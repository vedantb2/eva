import { r as e } from "./chunk-CFjPhJqf.js";
var t = e({
    ParseError: () => i,
    SETTINGS_SCHEMA: () => h,
    __defineFunction: () => K,
...
var a = function (e, t) {
  ...
  l = /[&><"']/g;
function u(e) {
  return String(e).replace(l, (e) => c[e]);
}
var d = function e(t) {
...
var _ = class {
    constructor(e) {
      ...
      h))
        if (h.hasOwnProperty(t)) {
          var n = h[t];
          this[t] =
            e[t] === void 0 ? g(n) : n.processor ? n.processor(e[t]) : e[t];
        }
    }
    reportNonstrict(e, t, n) {
      var r = this.strict;
      if (
        (typeof r == `function` && (r = r(e, t, n)), !(!r || r === `ignore`))
      ) {
        if (r === !0 || r === `error`)
          throw new i(
  ...
  te = [C, w, C, w, ee, T, ee, T],
  ne = [w, w, w, w, T, T, T, T],
  re = [x, S, C, w, ee, T, ee, T],
  ie = [S, S, w, w, T, T, T, T],
  ae = [b, b, S, S, w, w, T, T],
  oe = [y, b, x, S, x, S, x, S],
  D = { DISPLAY: E[y], TEXT: E[x], SCRIPT: E[C], SCRIPTSCRIPT: E[ee] },
  se = [
    {
      name: `latin`,
      blocks: [
...
function ce(e) {
  for (var t = 0; t < se.length; t++)
    for (var n = se[t], r = 0; r < n.blocks.length; r++) {
      var i = n.blocks[r];
...
var le = [];
se.forEach((e) => e.blocks.forEach((e) => le.push(...e)));
function ue(e) {
  for (var t = 0; t < le.length; t += 2)
    if (e >= le[t] && e <= le[t + 1]) return !0;
  return !1;
}
var de = 80,
  fe = function (e, t) {
...
function Oe(e, t, n) {
  ...
  var r = e.charCodeAt(0),
    i = we[t][r];
  if (
    (!i && e[0] in Ee && ((r = Ee[e[0]].charCodeAt(0)), (i = we[t][r])),
    !i && n === `text` && ue(r) && (i = we[t][77]),
    i)
  )
...
function Ae(e) {
  var t = e >= 5 ? 0 : e >= 3 ? 1 : 2;
  if (!ke[t]) {
    var n = (ke[t] = { cssEmPerMu: Te.quad[t] / 18 });
    for (var r in Te) Te.hasOwnProperty(r) && (n[r] = Te[r][t]);
  }
  return ke[t];
}
var je = [
  ...
  Ne = function (e, t) {
    return t.size < 2 ? e : je[e - 1][t.size - 1];
  },
  Pe = class e {
    constructor(t) {
      ((this.style = void 0),
    ...
    havingBaseStyle(t) {
      t ||= this.style.text();
      var n = Ne(e.BASESIZE, t);
      return this.size === n && this.textSize === e.BASESIZE && this.style === t
        ? this
    ...
    fontMetrics() {
      return ((this._fontMetrics ||= Ae(this.size)), this._fontMetrics);
    }
    getColor() {
...
var Fe = {
  ...
  Le = function (e) {
    return (
      ...
      e in Fe || e in Ie || e === `ex`
    );
  },
  O = function (e, t) {
    var n;
    if (e.unit in Fe)
      n = Fe[e.unit] / t.fontMetrics().ptPerEm / t.sizeMultiplier;
  ...
  Be = function (e) {
    ...
    for (var n in ((t.className = Re(this.classes)), this.style))
  ...
  He = function (e) {
    var t = `<` + e;
    this.classes.length && (t += ` class="` + m.escape(Re(this.classes)) + `"`);
    var n = ``;
    for (var r in this.style)
      this.style.hasOwnProperty(r) &&
        (n += m.hyphenate(r) + `:` + this.style[r] + `;`);
    for (var a in (n && (t += ` style="` + m.escape(n) + `"`), this.attributes))
      if (this.attributes.hasOwnProperty(a)) {
        if (Ve.test(a)) throw new i(`Invalid attribute name '` + a + `'`);
        t += ` ` + a + `="` + m.escape(this.attributes[a]) + `"`;
      }
    t += `>`;
  ...
  Ge = class {
    ...
    toMarkup() {
      var e =
          ...
          m.escape(this.src) +
          `"` +
          (` alt="` + m.escape(this.alt) + `"`),
        t = ``;
      for (var n in this.style)
        this.style.hasOwnProperty(n) &&
          (t += m.hyphenate(n) + `:` + this.style[n] + `;`);
      return (t && (e += ` style="` + m.escape(t) + `"`), (e += `'/>`), e);
    }
  },
  Ke = { î: `ı̂`, ï: `ı̈`, í: `ı́`, ì: `ı̀` },
  qe = class {
    constructor(e, t, n, r, i, a, o, s) {
      ((this.text = void 0),
        ...
        (this.style = s || {}),
        (this.maxFontSize = 0));
      var c = ce(this.text.charCodeAt(0));
      (c && this.classes.push(c + `_fallback`),
        /[îïíì]/.test(this.text) && (this.text = Ke[this.text]));
    }
    hasClass(e) {
      return this.classes.includes(e);
    }
    toNode() {
      ...
      for (var n in (this.italic > 0 &&
        ...
        (t.style.marginRight = k(this.italic))),
      this.classes.length > 0 &&
        ((t ||= document.createElement(`span`)),
        (t.className = Re(this.classes))),
      this.style))
        this.style.hasOwnProperty(n) &&
          ((t ||= document.createElement(`span`)),
    ...
    toMarkup() {
      ...
      this.style))
        this.style.hasOwnProperty(r) &&
          (n += m.hyphenate(r) + `:` + this.style[r] + `;`);
      n && ((e = !0), (t += ` style="` + m.escape(n) + `"`));
      var i = m.escape(this.text);
  ...
  Je = class {
    ...
    toMarkup() {
      ...
      for (var t in this.attributes)
        Object.prototype.hasOwnProperty.call(this.attributes, t) &&
          (e += ` ` + t + `="` + m.escape(this.attributes[t]) + `"`);
      e += `>`;
      for (var n = 0; n < this.children.length; n++)
    ...
    toNode() {
      ...
      return (
        this.alternate
          ...
          : e.setAttribute(`d`, xe[this.pathName]),
        e
      );
    }
    toMarkup() {
      return this.alternate
        ? `<path d="` + m.escape(this.alternate) + `"/>`
        : `<path d="` + m.escape(xe[this.pathName]) + `"/>`;
    }
  },
  Xe = class {
    constructor(e) {
...
var $e = { bin: 1, close: 1, inner: 1, open: 1, punct: 1, rel: 1 },
  et = { "accent-token": 1, mathord: 1, "op-token": 1, spacing: 1, textord: 1 },
  A = { math: {}, text: {} };
function j(e, t, n, r, i, a) {
  ((A[e][i] = { font: t, group: n, replace: r }),
    a && r && (A[e][r] = A[e][i]));
}
var M = `math`,
  N = `text`,
...
(j(M, P, B, `≡`, `\\equiv`, !0),
  ...
  j(M, P, B, `⋈`, `\\bowtie`, !0),
  j(M, P, B, `⌣`, `\\smile`, !0),
  j(M, P, B, `⊑`, `\\sqsubseteq`, !0),
  j(M, P, B, `⊒`, `\\sqsupseteq`, !0),
  j(M, P, B, `≐`, `\\doteq`, !0),
  j(M, P, B, `⌢`, `\\frown`, !0),
  j(M, P, B, `∋`, `\\ni`, !0),
  j(M, P, B, `∝`, `\\propto`, !0),
  ...
  j(M, P, V, `‡`, `\\ddag`),
  j(N, P, V, `‡`, `\\ddag`),
  j(N, P, V, `‡`, `\\textdaggerdbl`),
  j(M, P, tt, `⎱`, `\\rmoustache`, !0),
  j(M, P, rt, `⎰`, `\\lmoustache`, !0),
  j(M, P, tt, `⟯`, `\\rgroup`, !0),
  j(M, P, rt, `⟮`, `\\lgroup`, !0),
  j(M, P, L, `∓`, `\\mp`, !0),
  j(M, P, L, `⊖`, `\\ominus`, !0),
  ...
  j(M, P, L, `⨿`, `\\amalg`),
  j(M, P, L, `&`, `\\And`),
  j(M, P, B, `⟵`, `\\longleftarrow`, !0),
  j(M, P, B, `⇐`, `\\Leftarrow`, !0),
  j(M, P, B, `⟸`, `\\Longleftarrow`, !0),
  j(M, P, B, `⟶`, `\\longrightarrow`, !0),
  j(M, P, B, `⇒`, `\\Rightarrow`, !0),
  j(M, P, B, `⟹`, `\\Longrightarrow`, !0),
  j(M, P, B, `↔`, `\\leftrightarrow`, !0),
  j(M, P, B, `⟷`, `\\longleftrightarrow`, !0),
  j(M, P, B, `⇔`, `\\Leftrightarrow`, !0),
  j(M, P, B, `⟺`, `\\Longleftrightarrow`, !0),
  j(M, P, B, `↦`, `\\mapsto`, !0),
  j(M, P, B, `⟼`, `\\longmapsto`, !0),
  j(M, P, B, `↗`, `\\nearrow`, !0),
  j(M, P, B, `↩`, `\\hookleftarrow`, !0),
  j(M, P, B, `↪`, `\\hookrightarrow`, !0),
  j(M, P, B, `↘`, `\\searrow`, !0),
  j(M, P, B, `↼`, `\\leftharpoonup`, !0),
  j(M, P, B, `⇀`, `\\rightharpoonup`, !0),
  j(M, P, B, `↙`, `\\swarrow`, !0),
  j(M, P, B, `↽`, `\\leftharpoondown`, !0),
  j(M, P, B, `⇁`, `\\rightharpoondown`, !0),
  j(M, P, B, `↖`, `\\nwarrow`, !0),
  j(M, P, B, `⇌`, `\\rightleftharpoons`, !0),
  j(M, F, B, `≮`, `\\nless`, !0),
  j(M, F, B, ``, `\\@nleqslant`),
  j(M, F, B, ``, `\\@nleqq`),
  j(M, F, B, `⪇`, `\\lneq`, !0),
  ...
  j(M, F, B, `⋬`, `\\ntrianglelefteq`, !0),
  j(M, F, B, `⊊`, `\\subsetneq`, !0),
  j(M, F, B, ``, `\\@varsubsetneq`),
  j(M, F, B, `⫋`, `\\subsetneqq`, !0),
  j(M, F, B, ``, `\\@varsubsetneqq`),
  j(M, F, B, `≯`, `\\ngtr`, !0),
  j(M, F, B, ``, `\\@ngeqslant`),
  j(M, F, B, ``, `\\@ngeqq`),
  j(M, F, B, `⪈`, `\\gneq`, !0),
  ...
  j(M, F, B, `⋡`, `\\nsucceq`, !0),
  j(M, F, B, `⋩`, `\\succnsim`, !0),
  j(M, F, B, `⪺`, `\\succnapprox`, !0),
  j(M, F, B, `≆`, `\\ncong`, !0),
  j(M, F, B, ``, `\\@nshortparallel`),
  j(M, F, B, `∦`, `\\nparallel`, !0),
  j(M, F, B, `⊯`, `\\nVDash`, !0),
  j(M, F, B, `⋫`, `\\ntriangleright`),
  j(M, F, B, `⋭`, `\\ntrianglerighteq`, !0),
  j(M, F, B, ``, `\\@nsupseteqq`),
  j(M, F, B, `⊋`, `\\supsetneq`, !0),
  j(M, F, B, ``, `\\@varsupsetneq`),
  j(M, F, B, `⫌`, `\\supsetneqq`, !0),
  j(M, F, B, ``, `\\@varsupsetneqq`),
  j(M, F, B, `⊮`, `\\nVdash`, !0),
  j(M, F, B, `⪵`, `\\precneqq`, !0),
  j(M, F, B, `⪶`, `\\succneqq`, !0),
  j(M, F, B, ``, `\\@nsubseteqq`),
  ...
  j(M, F, V, `®`, `\\circledR`),
  j(N, F, V, `®`, `\\circledR`),
  j(M, F, V, `∡`, `\\measuredangle`, !0),
  j(M, F, V, `∄`, `\\nexists`),
  j(M, F, V, `℧`, `\\mho`),
  j(M, F, V, `Ⅎ`, `\\Finv`, !0),
  j(M, F, V, `⅁`, `\\Game`, !0),
  j(M, F, V, `‵`, `\\backprime`),
  j(M, F, V, `▲`, `\\blacktriangle`),
  j(M, F, V, `▼`, `\\blacktriangledown`),
  j(M, F, V, `■`, `\\blacksquare`),
  j(M, F, V, `⧫`, `\\blacklozenge`),
  j(M, F, V, `★`, `\\bigstar`),
  j(M, F, V, `∢`, `\\sphericalangle`, !0),
  j(M, F, V, `∁`, `\\complement`, !0),
  j(M, F, V, `ð`, `\\eth`, !0),
  j(N, P, V, `ð`, `ð`),
  j(M, F, V, `╱`, `\\diagup`),
  j(M, F, V, `╲`, `\\diagdown`),
  ...
  j(M, F, B, `≦`, `\\leqq`, !0),
  j(M, F, B, `⩽`, `\\leqslant`, !0),
  j(M, F, B, `⪕`, `\\eqslantless`, !0),
  j(M, F, B, `≲`, `\\lesssim`, !0),
  j(M, F, B, `⪅`, `\\lessapprox`, !0),
  j(M, F, B, `≊`, `\\approxeq`, !0),
  j(M, F, L, `⋖`, `\\lessdot`),
  j(M, F, B, `⋘`, `\\lll`, !0),
  j(M, F, B, `≶`, `\\lessgtr`, !0),
  j(M, F, B, `⋚`, `\\lesseqgtr`, !0),
  j(M, F, B, `⪋`, `\\lesseqqgtr`, !0),
  j(M, F, B, `≑`, `\\doteqdot`),
  j(M, F, B, `≓`, `\\risingdotseq`, !0),
  j(M, F, B, `≒`, `\\fallingdotseq`, !0),
  j(M, F, B, `∽`, `\\backsim`, !0),
  j(M, F, B, `⋍`, `\\backsimeq`, !0),
  j(M, F, B, `⫅`, `\\subseteqq`, !0),
  j(M, F, B, `⋐`, `\\Subset`, !0),
  j(M, F, B, `⊏`, `\\sqsubset`, !0),
  j(M, F, B, `≼`, `\\preccurlyeq`, !0),
  j(M, F, B, `⋞`, `\\curlyeqprec`, !0),
  j(M, F, B, `≾`, `\\precsim`, !0),
  j(M, F, B, `⪷`, `\\precapprox`, !0),
  j(M, F, B, `⊲`, `\\vartriangleleft`),
  j(M, F, B, `⊴`, `\\trianglelefteq`),
  j(M, F, B, `⊨`, `\\vDash`, !0),
  j(M, F, B, `⊪`, `\\Vvdash`, !0),
  j(M, F, B, `⌣`, `\\smallsmile`),
  j(M, F, B, `⌢`, `\\smallfrown`),
  ...
  j(M, F, B, `⋑`, `\\Supset`, !0),
  j(M, F, B, `⊐`, `\\sqsupset`, !0),
  j(M, F, B, `≽`, `\\succcurlyeq`, !0),
  j(M, F, B, `⋟`, `\\curlyeqsucc`, !0),
  j(M, F, B, `≿`, `\\succsim`, !0),
  j(M, F, B, `⪸`, `\\succapprox`, !0),
  j(M, F, B, `⊳`, `\\vartriangleright`),
  j(M, F, B, `⊵`, `\\trianglerighteq`),
  j(M, F, B, `⊩`, `\\Vdash`, !0),
  j(M, F, B, `∣`, `\\shortmid`),
  j(M, F, B, `∥`, `\\shortparallel`),
  j(M, F, B, `≬`, `\\between`, !0),
  j(M, F, B, `⋔`, `\\pitchfork`, !0),
  j(M, F, B, `∝`, `\\varpropto`),
  j(M, F, B, `◀`, `\\blacktriangleleft`),
  j(M, F, B, `∴`, `\\therefore`, !0),
  j(M, F, B, `∍`, `\\backepsilon`),
  j(M, F, B, `▶`, `\\blacktriangleright`),
  j(M, F, B, `∵`, `\\because`, !0),
  j(M, F, B, `⋘`, `\\llless`),
  j(M, F, B, `⋙`, `\\gggtr`),
  j(M, F, L, `⊲`, `\\lhd`),
  ...
  j(M, F, B, `≑`, `\\Doteq`, !0),
  j(M, F, L, `∔`, `\\dotplus`, !0),
  j(M, F, L, `∖`, `\\smallsetminus`),
  j(M, F, L, `⋒`, `\\Cap`, !0),
  j(M, F, L, `⋓`, `\\Cup`, !0),
  j(M, F, L, `⩞`, `\\doublebarwedge`, !0),
  j(M, F, L, `⊟`, `\\boxminus`, !0),
  j(M, F, L, `⊞`, `\\boxplus`, !0),
  j(M, F, L, `⋇`, `\\divideontimes`, !0),
  j(M, F, L, `⋉`, `\\ltimes`, !0),
  j(M, F, L, `⋊`, `\\rtimes`, !0),
  j(M, F, L, `⋋`, `\\leftthreetimes`, !0),
  j(M, F, L, `⋌`, `\\rightthreetimes`, !0),
  j(M, F, L, `⋏`, `\\curlywedge`, !0),
  j(M, F, L, `⋎`, `\\curlyvee`, !0),
  j(M, F, L, `⊝`, `\\circleddash`, !0),
  j(M, F, L, `⊛`, `\\circledast`, !0),
  j(M, F, L, `⋅`, `\\centerdot`),
  j(M, F, L, `⊺`, `\\intercal`, !0),
  j(M, F, L, `⋒`, `\\doublecap`),
  j(M, F, L, `⋓`, `\\doublecup`),
  j(M, F, L, `⊠`, `\\boxtimes`, !0),
  j(M, F, B, `⇢`, `\\dashrightarrow`, !0),
  j(M, F, B, `⇠`, `\\dashleftarrow`, !0),
  j(M, F, B, `⇇`, `\\leftleftarrows`, !0),
  j(M, F, B, `⇆`, `\\leftrightarrows`, !0),
  j(M, F, B, `⇚`, `\\Lleftarrow`, !0),
  j(M, F, B, `↞`, `\\twoheadleftarrow`, !0),
  j(M, F, B, `↢`, `\\leftarrowtail`, !0),
  j(M, F, B, `↫`, `\\looparrowleft`, !0),
  j(M, F, B, `⇋`, `\\leftrightharpoons`, !0),
  j(M, F, B, `↶`, `\\curvearrowleft`, !0),
  j(M, F, B, `↺`, `\\circlearrowleft`, !0),
  j(M, F, B, `↰`, `\\Lsh`, !0),
  j(M, F, B, `⇈`, `\\upuparrows`, !0),
  j(M, F, B, `↿`, `\\upharpoonleft`, !0),
  j(M, F, B, `⇃`, `\\downharpoonleft`, !0),
  j(M, P, B, `⊶`, `\\origof`, !0),
  j(M, P, B, `⊷`, `\\imageof`, !0),
  j(M, F, B, `⊸`, `\\multimap`, !0),
  j(M, F, B, `↭`, `\\leftrightsquigarrow`, !0),
  j(M, F, B, `⇉`, `\\rightrightarrows`, !0),
  j(M, F, B, `⇄`, `\\rightleftarrows`, !0),
  j(M, F, B, `↠`, `\\twoheadrightarrow`, !0),
  j(M, F, B, `↣`, `\\rightarrowtail`, !0),
  j(M, F, B, `↬`, `\\looparrowright`, !0),
  j(M, F, B, `↷`, `\\curvearrowright`, !0),
  j(M, F, B, `↻`, `\\circlearrowright`, !0),
  j(M, F, B, `↱`, `\\Rsh`, !0),
  j(M, F, B, `⇊`, `\\downdownarrows`, !0),
  j(M, F, B, `↾`, `\\upharpoonright`, !0),
  j(M, F, B, `⇂`, `\\downharpoonright`, !0),
  j(M, F, B, `⇝`, `\\rightsquigarrow`, !0),
  j(M, F, B, `⇝`, `\\leadsto`),
  j(M, F, B, `⇛`, `\\Rrightarrow`, !0),
  j(M, F, B, `↾`, `\\restriction`),
  j(M, P, V, `‘`, "`"),
  j(M, P, V, `$`, `\\$`),
  j(N, P, V, `$`, `\\$`),
  ...
  j(M, P, R, `ψ`, `\\psi`, !0),
  j(M, P, R, `ω`, `\\omega`, !0),
  j(M, P, R, `ε`, `\\varepsilon`, !0),
  j(M, P, R, `ϑ`, `\\vartheta`, !0),
  j(M, P, R, `ϖ`, `\\varpi`, !0),
  j(M, P, R, `ϱ`, `\\varrho`, !0),
  j(M, P, R, `ς`, `\\varsigma`, !0),
  j(M, P, R, `φ`, `\\varphi`, !0),
  j(M, P, L, `∗`, `*`, !0),
  j(M, P, L, `+`, `+`),
  j(M, P, L, `−`, `-`, !0),
  ...
  j(M, P, V, `∂`, `\\partial`, !0),
  j(M, P, L, `⊘`, `\\oslash`, !0),
  j(M, F, L, `⊚`, `\\circledcirc`, !0),
  j(M, F, L, `⊡`, `\\boxdot`, !0),
  j(M, P, L, `△`, `\\bigtriangleup`),
  j(M, P, L, `▽`, `\\bigtriangledown`),
  j(M, P, L, `†`, `\\dagger`),
  j(M, P, L, `⋄`, `\\diamond`),
  j(M, P, L, `⋆`, `\\star`),
  j(M, P, L, `◃`, `\\triangleleft`),
  j(M, P, L, `▹`, `\\triangleright`),
  j(M, P, rt, `{`, `\\{`),
  j(N, P, V, `{`, `\\{`),
  j(N, P, V, `{`, `\\textbraceleft`),
  j(M, P, tt, `}`, `\\}`),
  j(N, P, V, `}`, `\\}`),
  j(N, P, V, `}`, `\\textbraceright`),
  j(M, P, rt, `{`, `\\lbrace`),
  j(M, P, tt, `}`, `\\rbrace`),
  j(M, P, rt, `[`, `\\lbrack`, !0),
  j(N, P, V, `[`, `\\lbrack`, !0),
  ...
  j(M, P, V, `∥`, `\\Vert`),
  j(N, P, V, `∥`, `\\textbardbl`),
  j(N, P, V, `~`, `\\textasciitilde`),
  j(N, P, V, `\\`, `\\textbackslash`),
  j(N, P, V, `^`, `\\textasciicircum`),
  j(M, P, B, `↑`, `\\uparrow`, !0),
  j(M, P, B, `⇑`, `\\Uparrow`, !0),
  j(M, P, B, `↓`, `\\downarrow`, !0),
  j(M, P, B, `⇓`, `\\Downarrow`, !0),
  j(M, P, B, `↕`, `\\updownarrow`, !0),
  j(M, P, B, `⇕`, `\\Updownarrow`, !0),
  j(M, P, z, `∐`, `\\coprod`),
  j(M, P, z, `⋁`, `\\bigvee`),
  j(M, P, z, `⋀`, `\\bigwedge`),
  ...
  j(M, P, z, `⨆`, `\\bigsqcup`),
  j(M, P, z, `∫`, `\\smallint`),
  j(N, P, nt, `…`, `\\textellipsis`),
  j(M, P, nt, `…`, `\\mathellipsis`),
  j(N, P, nt, `…`, `\\ldots`, !0),
  j(M, P, nt, `…`, `\\ldots`, !0),
  j(M, P, nt, `⋯`, `\\@cdots`, !0),
  j(M, P, nt, `⋱`, `\\ddots`, !0),
...
(j(N, P, V, `–`, `--`, !0),
  ...
  j(N, P, V, `—`, `\\textemdash`),
  j(N, P, V, `‘`, "`", !0),
  j(N, P, V, `‘`, `\\textquoteleft`),
  j(N, P, V, `’`, `'`, !0),
  j(N, P, V, `’`, `\\textquoteright`),
  j(N, P, V, `“`, "``", !0),
  j(N, P, V, `“`, `\\textquotedblleft`),
  j(N, P, V, `”`, `''`, !0),
  j(N, P, V, `”`, `\\textquotedblright`),
  j(M, P, V, `°`, `\\degree`, !0),
  j(N, P, V, `°`, `\\degree`),
  j(N, P, V, `°`, `\\textdegree`, !0),
  j(M, P, V, `£`, `\\pounds`),
  j(M, P, V, `£`, `\\mathsterling`, !0),
  j(N, P, V, `£`, `\\pounds`),
  j(N, P, V, `£`, `\\textsterling`, !0),
  j(M, F, V, `✠`, `\\maltese`),
  j(N, F, V, `✠`, `\\maltese`));
for (var st = `0123456789/@."`, ct = 0; ct < st.length; ct++) {
  var lt = st.charAt(ct);
  j(M, P, V, lt, lt);
}
for (var ut = `0123456789!@*()-=+";:?/.,`, dt = 0; dt < ut.length; dt++) {
  var ft = ut.charAt(dt);
  j(N, P, V, ft, ft);
}
for (
  var pt = `ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz`, mt = 0;
  mt < pt.length;
  mt++
) {
  var ht = pt.charAt(mt);
  (j(M, P, R, ht, ht), j(N, P, V, ht, ht));
}
(j(M, F, V, `C`, `ℂ`),
  j(N, F, V, `C`, `ℂ`),
  j(M, F, V, `H`, `ℍ`),
  ...
  j(M, P, R, `h`, `ℎ`),
  j(N, P, R, `h`, `ℎ`));
for (var H = ``, gt = 0; gt < pt.length; gt++) {
  var U = pt.charAt(gt);
  ((H = String.fromCharCode(55349, 56320 + gt)),
    j(M, P, R, U, H),
    j(N, P, V, U, H),
    (H = String.fromCharCode(55349, 56372 + gt)),
    j(M, P, R, U, H),
    j(N, P, V, U, H),
    (H = String.fromCharCode(55349, 56424 + gt)),
    j(M, P, R, U, H),
    j(N, P, V, U, H),
    (H = String.fromCharCode(55349, 56580 + gt)),
    j(M, P, R, U, H),
    j(N, P, V, U, H),
    (H = String.fromCharCode(55349, 56684 + gt)),
    j(M, P, R, U, H),
    j(N, P, V, U, H),
    (H = String.fromCharCode(55349, 56736 + gt)),
    j(M, P, R, U, H),
    j(N, P, V, U, H),
    (H = String.fromCharCode(55349, 56788 + gt)),
    j(M, P, R, U, H),
    j(N, P, V, U, H),
    (H = String.fromCharCode(55349, 56840 + gt)),
    j(M, P, R, U, H),
    j(N, P, V, U, H),
    (H = String.fromCharCode(55349, 56944 + gt)),
    j(M, P, R, U, H),
    j(N, P, V, U, H),
    gt < 26 &&
      ((H = String.fromCharCode(55349, 56632 + gt)),
      j(M, P, R, U, H),
      j(N, P, V, U, H),
      (H = String.fromCharCode(55349, 56476 + gt)),
      j(M, P, R, U, H),
      j(N, P, V, U, H)));
}
((H = String.fromCharCode(55349, 56668)),
  j(M, P, R, `k`, H),
  j(N, P, V, `k`, H));
for (var _t = 0; _t < 10; _t++) {
  var vt = _t.toString();
  ((H = String.fromCharCode(55349, 57294 + _t)),
    j(M, P, R, vt, H),
    j(N, P, V, vt, H),
    (H = String.fromCharCode(55349, 57314 + _t)),
    j(M, P, R, vt, H),
    j(N, P, V, vt, H),
    (H = String.fromCharCode(55349, 57324 + _t)),
    j(M, P, R, vt, H),
    j(N, P, V, vt, H),
    (H = String.fromCharCode(55349, 57334 + _t)),
    j(M, P, R, vt, H),
    j(N, P, V, vt, H));
}
for (var yt = `ÐÞþ`, bt = 0; bt < yt.length; bt++) {
  var xt = yt.charAt(bt);
  (j(M, P, R, xt, xt), j(N, P, V, xt, xt));
}
var St = [
  ...
  wt = function (e, t) {
    var n = e.charCodeAt(0),
      r = e.charCodeAt(1),
      a = (n - 55296) * 1024 + (r - 56320) + 65536,
      o = t === `math` ? 0 : 1;
    if (119808 <= a && a < 120484) {
      var s = Math.floor((a - 119808) / 26);
      return [St[s][2], St[s][o]];
    } else if (120782 <= a && a <= 120831) {
      var c = Math.floor((a - 120782) / 10);
      return [Ct[c][2], Ct[c][o]];
    } else if (a === 120485 || a === 120486) return [St[0][2], St[0][o]];
    else if (120486 < a && a < 120782) return [``, ``];
    else throw new i(`Unsupported character: ` + e);
  },
  Tt = function (e, t, n) {
    return (
      A[n][e] && A[n][e].replace && (e = A[n][e].replace),
      { value: e, metrics: Oe(e, t, n) }
    );
  },
  Et = function (e, t, n, r, i) {
    ...
    if (o) {
      ...
      ((n === `text` || (r && r.font === `mathit`)) && (c = 0),
        (s = new qe(e, o.height, o.depth, c, o.skew, o.width, i)));
    } else
      (typeof console < `u` &&
        console.warn(
  ...
  Dt = function (e, t, n, r) {
    return (
      r === void 0 && (r = []),
      n.font === `boldsymbol` && Tt(e, `Main-Bold`, t).metrics
        ? Et(e, `Main-Bold`, t, n, r.concat([`mathbf`]))
        : e === `\\` || A[t][e].font === `main`
          ? Et(e, `Main-Regular`, t, n, r)
          : Et(e, `AMS-Regular`, t, n, r.concat([`amsrm`]))
    );
  },
  ...
  kt = function (e, t, n) {
    var r = e.mode,
      ...
      c = ``,
      l = ``;
    if ((i.charCodeAt(0) === 55349 && ([c, l] = wt(i, r)), c.length > 0))
      return Et(i, c, r, t, a.concat(l));
    if (s) {
      var u, d;
      if (s === `boldsymbol`) {
        var f = Ot(i, r, t, a, n);
        ...
        o
          ? ((u = Ut[s].fontName), (d = [s]))
          : ((u = Ht(s, t.fontWeight, t.fontShape)),
            (d = [s, t.fontWeight, t.fontShape]));
      if (Tt(i, u, r).metrics) return Et(i, u, r, t, a.concat(d));
      if (ot.hasOwnProperty(i) && u.slice(0, 10) === `Typewriter`) {
        for (var p = [], m = 0; m < i.length; m++)
          p.push(Et(i[m], u, r, t, a.concat(d)));
        return Lt(p);
      }
    }
    if (n === `mathord`)
      return Et(i, `Math-Italic`, r, t, a.concat([`mathnormal`]));
    if (n === `textord`) {
      var h = A[r][i] && A[r][i].font;
      if (h === `ams`)
        return Et(
          i,
          Ht(`amsrm`, t.fontWeight, t.fontShape),
          r,
          t,
      ...
      if (h === `main` || !h)
        return Et(
          i,
          Ht(`textrm`, t.fontWeight, t.fontShape),
          r,
          t,
          a.concat(t.fontWeight, t.fontShape),
        );
      var g = Ht(h, t.fontWeight, t.fontShape);
      return Et(i, g, r, t, a.concat(g, t.fontWeight, t.fontShape));
    } else throw Error(`unexpected type: ` + n + ` in makeOrd`);
  },
  At = (e, t) => {
    if (
      Re(e.classes) !== Re(t.classes) ||
      e.skew !== t.skew ||
  ...
  Nt = function (e, t, n, r) {
    var i = new Ue(e, t, n, r);
    return (Mt(i), i);
  },
  Pt = (e, t, n, r) => new Ue(e, t, n, r),
  Ft = function (e, t, n) {
    var r = Nt([e], [], t);
    return (
      (r.height = Math.max(
      ...
      (r.style.borderBottomWidth = k(r.height)),
      (r.maxFontSize = 1),
      r
    );
  },
  It = function (e, t, n, r) {
    var i = new We(e, t, n, r);
    return (Mt(i), i);
  },
  Lt = function (e) {
    var t = new Ce(e);
  ...
  Rt = function (e, t) {
    return e instanceof Ce ? Nt([], [e], t) : e;
  },
  zt = function (e) {
  ...
  Bt = function (e, t) {
    for (
      var { children: n, depth: r } = zt(e), i = 0, a = 0;
      a < n.length;
      a++
    ) {
      var o = n[a];
    ...
    if (u < 0) {
      ...
      ((x.style.height = k(-u)),
        (b = [
          Nt([`vlist-r`], [y, Nt([`vlist-s`], [new qe(`​`)])]),
          Nt([`vlist-r`], [x]),
        ]));
    } else b = [Nt([`vlist-r`], [y])];
    var S = Nt([`vlist-t`], b);
  ...
  Kt = { number: 5, unit: `mu` },
  qt = {
    mord: { mop: G, mbin: Gt, mrel: Kt, minner: G },
    mop: { mord: G, mop: G, mrel: Kt, minner: G },
    mbin: { mord: Gt, mop: Gt, mopen: Gt, minner: Gt },
    mrel: { mord: Kt, mop: Kt, mopen: Kt, minner: Kt },
    mopen: {},
    mclose: { mop: G, mbin: Gt, mrel: Kt, minner: G },
    mpunct: {
      mord: G,
      mop: G,
      mrel: Kt,
...
var $t = function (e) {
  ...
  nn = [`rightmost`, `mrel`, `mclose`, `mpunct`],
  rn = {
    display: D.DISPLAY,
    text: D.TEXT,
    script: D.SCRIPT,
  ...
  J = function (e, t, n, r) {
    ...
    if ((W.tryCombineChars(i), !n)) return i;
    var c = t;
    if (e.length === 1) {
      var l = e[0];
      l.type === `sizing`
        ? (c = t.havingSize(l.size))
        : l.type === `styling` && (c = t.havingStyle(rn[l.style]));
    }
    var u = en([r[0] || `leftmost`], [], t),
      d = en([r[1] || `rightmost`], [], t),
      f = n === `root`;
    return (
      on(
        i,
        (e, t) => {
          var n = t.classes[0],
            r = e.classes[0];
          n === `mbin` && nn.includes(r)
            ? (t.classes[0] = `mord`)
            : r === `mbin` && tn.includes(n) && (e.classes[0] = `mord`);
        },
        { node: u },
        d,
        f,
      ...
      on(
        ...
        (e, t) => {
          var n = ln(t),
            r = ln(e),
            i = n && r ? (e.hasClass(`mtight`) ? Jt[n][r] : qt[n][r]) : null;
          if (i) return W.makeGlue(i, c);
        },
        { node: u },
        d,
        f,
  ...
  on = function e(t, n, r, i, a) {
    ...
    for (var o = 0; o < t.length; o++) {
      ...
      (l
        ? (r.node = s)
        : a && s.hasClass(`newline`) && (r.node = en([`leftmost`])),
        (r.insertAfter = ((e) => (n) => {
          (t.splice(e + 1, 0, n), o++);
        })(o)));
    }
  ...
  sn = function (e) {
    return e instanceof Ce ||
      e instanceof We ||
      (e instanceof Ue && e.hasClass(`enclosing`))
      ? e
      : null;
  },
  cn = function e(t, n) {
  ...
  ln = function (e, t) {
    return e ? (t && (e = cn(e, t)), an[e.classes[0]] || null) : null;
  },
  un = function (e, t) {
    var n = [`nulldelimiter`].concat(e.baseSizingClasses());
    return en(t.concat(n));
  },
  Y = function (e, t, n) {
    if (!e) return en();
    if (Xt[e.type]) {
      var r = Xt[e.type](e, t);
      if (n && t.size !== n.size) {
        r = en(t.sizingClasses(n), [r], t);
        var a = t.sizeMultiplier / n.sizeMultiplier;
        ((r.height *= a), (r.depth *= a));
      }
      return r;
    } else throw new i(`Got group of unknown type: '` + e.type + `'`);
  };
function dn(e, t) {
  var n = en([`base`], e, t),
    r = en([`strut`]);
  return (
    (r.style.height = k(n.height + n.depth)),
    n.depth && (r.style.verticalAlign = k(-n.depth)),
  ...
  for (var a = [], o = [], s = 0; s < r.length; s++)
    if (
      ...
      r[s].hasClass(`newline`) &&
        (o.pop(), o.length > 0 && (a.push(dn(o, t)), (o = [])), a.push(r[s]));
  o.length > 0 && a.push(dn(o, t));
  var l;
  n
    ? ((l = dn(J(n, t, !0))), (l.classes = [`tag`]), a.push(l))
    : i && a.push(i);
  var u = en([`katex-html`], a);
  if ((u.setAttribute(`aria-hidden`, `true`), l)) {
    var d = l.children[0];
    ((d.style.height = k(u.height + u.depth)),
      u.depth && (d.style.verticalAlign = k(-u.depth)));
  }
  return u;
}
function pn(e) {
...
var mn = class {
    ...
    toNode() {
      ...
      for (var t in this.attributes)
        Object.prototype.hasOwnProperty.call(this.attributes, t) &&
          e.setAttribute(t, this.attributes[t]);
      this.classes.length > 0 && (e.className = Re(this.classes));
      for (var n = 0; n < this.children.length; n++)
        if (
          this.children[n] instanceof hn &&
          this.children[n + 1] instanceof hn
        ) {
          for (
    ...
    toMarkup() {
      ...
      for (var t in this.attributes)
        Object.prototype.hasOwnProperty.call(this.attributes, t) &&
          ((e += ` ` + t + `="`),
          (e += m.escape(this.attributes[t])),
          (e += `"`));
      (this.classes.length > 0 &&
        (e += ` class ="` + m.escape(Re(this.classes)) + `"`),
        (e += `>`));
      for (var n = 0; n < this.children.length; n++)
        e += this.children[n].toMarkup();
  ...
  vn = function (e, t) {
    ...
    A[r][i] && A[r][i].replace && (i = A[r][i].replace);
    var a = W.fontMap[n].fontName;
    return Oe(i, a, r) ? W.fontMap[n].variant : null;
  };
function yn(e) {
  if (!e) return !1;
  if (e.type === `mi` && e.children.length === 1) {
    var t = e.children[0];
    return t instanceof hn && t.text === `.`;
  } else if (
    e.type === `mo` &&
    e.children.length === 1 &&
...
var bn = function (e, t, n) {
    ...
    for (var i = [], a, o = 0; o < e.length; o++) {
      var s = Z(e[o], t);
      if (s instanceof mn && a instanceof mn) {
        if (
          s.type === `mtext` &&
          a.type === `mtext` &&
          ...
          a.children.push(...s.children);
          continue;
        } else if (yn(s) && a.type === `mn`) {
          a.children.push(...s.children);
          continue;
        } else if (s.type === `mn` && yn(a))
...
function Sn(e, t, n, r, i) {
  var a = bn(e, n),
    o =
      a.length === 1 &&
      a[0] instanceof mn &&
      [`mrow`, `mtable`].includes(a[0].type)
        ? a[0]
        : new X.MathNode(`mrow`, a),
    s = new X.MathNode(`annotation`, [new X.TextNode(t)]);
  s.setAttribute(`encoding`, `application/x-tex`);
  var c = new X.MathNode(`semantics`, [o, s]),
    l = new X.MathNode(`math`, [c]);
  (l.setAttribute(`xmlns`, `http://www.w3.org/1998/Math/MathML`),
    r && l.setAttribute(`display`, `block`));
  var u = i ? `katex` : `katex-mathml`;
  return W.makeSpan([u], [l]);
}
var Cn = function (e) {
    return new Pe({
  ...
  Tn = function (e, t, n) {
    var r = Cn(n),
      i;
    if (n.output === `mathml`) return Sn(e, t, r, n.displayMode, !0);
    if (n.output === `html`) {
      var a = fn(e, r);
      i = W.makeSpan([`katex`], [a]);
    } else {
      var o = Sn(e, t, r, n.displayMode, !1),
        s = fn(e, r);
      i = W.makeSpan([`katex`], [o, s]);
    }
    return wn(i, n);
  },
  En = function (e, t, n) {
    var r = fn(e, Cn(n));
    return wn(W.makeSpan([`katex`], [r]), n);
  },
  Dn = {
    widehat: `^`,
    widecheck: `ˇ`,
  ...
  On = function (e) {
    var t = new X.MathNode(`mo`, [new X.TextNode(Dn[e.replace(/^\\/, ``)])]);
  ...
  jn = {
    encloseSpan: function (e, t, n, r, i) {
      var a,
        o = e.height + e.depth + n + r;
      if (/fbox|color|angl/.test(t)) {
        if (((a = W.makeSpan([`stretchy`, t], [], i)), t === `fbox`)) {
        ...
        var l = new Je(c, { width: `100%`, height: k(o) });
        a = W.makeSvgSpan([], [l], i);
      }
    ...
    svgSpan: function (e, t) {
      function n() {
        ...
        if ([`widehat`, `widecheck`, `widetilde`, `utilde`].includes(r)) {
          ...
          var l = new Je([new Ye(o)], {
            width: `100%`,
            height: k(s),
            viewBox: `0 0 ` + n + ` ` + a,
            preserveAspectRatio: `none`,
          });
          return { span: W.makeSvgSpan([], [l], t), minWidth: 0, height: s };
        } else {
          var u = [],
            d = kn[r],
            [f, p, m] = d,
          ...
          for (var b = 0; b < g; b++) {
            var x = new Je([new Ye(f[b])], {
                width: `400em`,
                height: k(h),
                viewBox: `0 0 ` + n + ` ` + m,
                preserveAspectRatio: v[b] + ` slice`,
              }),
              S = W.makeSvgSpan([_[b]], [x], t);
            if (g === 1) return { span: S, minWidth: p, height: h };
            ((S.style.height = k(h)), u.push(S));
          }
          return {
            span: W.makeSpan([`stretchy`], u, t),
            minWidth: p,
            height: h,
          };
        }
...
function Nn(e) {
  return e && (e.type === `atom` || et.hasOwnProperty(e.type)) ? e : null;
}
var Pn = (e, t) => {
    var n, r, i;
    e && e.type === `supsub`
      ? ((r = Q(e.base, `accent`)),
        ...
        (i = Qe(Y(e, t))),
        (e.base = r))
      : ((r = Q(e, `accent`)), (n = r.base));
    var a = Y(n, t.havingCrampedStyle()),
      o = r.isShifty && m.isCharacterBox(n),
      s = 0;
    o && (s = Ze(Y(m.getBaseElem(n), t.havingCrampedStyle())).skew);
    var c = r.label === `\\c`,
      l = c ? a.height + a.depth : Math.min(a.height, t.fontMetrics().xHeight),
      u;
    if (r.isStretchy)
      ((u = jn.svgSpan(r, t)),
        (u = W.makeVList(
      ...
      var d, f;
      (r.label === `\\vec`
        ? ((d = W.staticSvg(`vec`, t)), (f = W.svgData.vec[1]))
        : ((d = W.makeOrd({ mode: r.mode, text: r.label }, t, `textord`)),
          (d = Ze(d)),
          (d.italic = 0),
          (f = d.width),
          c && (l += d.depth)),
        (u = W.makeSpan([`accent-body`], [d])));
    ...
    var g = W.makeSpan([`mord`, `accent`], [u], t);
    return i
      ? ((i.children[0] = g),
        (i.height = Math.max(g.height, i.height)),
        (i.classes[0] = `mord`),
        i)
      : g;
  },
  Fn = (e, t) => {
    var n = e.isStretchy
        ? jn.mathMLnode(e.label)
        : new X.MathNode(`mo`, [gn(e.label, e.mode)]),
      r = new X.MathNode(`mover`, [Z(e.base, t), n]);
...
(K({
  ...
  K({
    ...
    htmlBuilder: (e, t) => {
      ...
      return W.makeSpan([`mord`, `accentunder`], [a], t);
    },
    mathmlBuilder: (e, t) => {
      var n = jn.mathMLnode(e.label),
        r = new X.MathNode(`munder`, [Z(e.base, t), n]);
...
K({
  ...
  htmlBuilder(e, t) {
    ...
    var u;
    if (o) {
      var d = -t.fontMetrics().axisHeight + o.height + 0.5 * s.height + 0.111;
      u = W.makeVList(
        {
  ...
  mathmlBuilder(e, t) {
    ...
    if (e.body) {
      var i = Ln(Z(e.body, t));
      if (e.below) {
        var a = Ln(Z(e.below, t));
        r = new X.MathNode(`munderover`, [n, a, i]);
      } else r = new X.MathNode(`mover`, [n, i]);
    } else if (e.below) {
      var o = Ln(Z(e.below, t));
      r = new X.MathNode(`munder`, [n, o]);
    } else ((r = Ln()), (r = new X.MathNode(`mover`, [n, r])));
    return r;
  },
});
var Rn = W.makeSpan;
...
function Bn(e, t) {
  ...
  return (
    e.mclass === `minner`
      ? (n = new X.MathNode(`mpadded`, r))
      : e.mclass === `mord`
        ? e.isCharacterBox
          ? ((n = r[0]), (n.type = `mi`))
          : (n = new X.MathNode(`mi`, r))
        : (e.isCharacterBox
            ? ((n = r[0]), (n.type = `mo`))
...
K({
  ...
  handler(e, t) {
    ...
    return {
      ...
      mclass: `m` + r.slice(5),
      body: q(i),
      isCharacterBox: m.isCharacterBox(i),
    };
  },
  htmlBuilder: zn,
  mathmlBuilder: Bn,
...
(K({
  ...
  K({
    ...
    handler(e, t) {
      var { parser: n } = e;
      return { type: `pmb`, mode: n.mode, mclass: Vn(t[0]), body: q(t[0]) };
    },
    htmlBuilder(e, t) {
      var n = J(e.body, t, !0),
        r = W.makeSpan([e.mclass], n, t);
      return ((r.style.textShadow = `0.02em 0.01em 0.04px`), r);
    },
    mathmlBuilder(e, t) {
      var n = bn(e.body, t),
        r = new X.MathNode(`mstyle`, n);
...
var Hn = {
  ...
  Un = () => ({ type: `styling`, body: [], mode: `math`, style: `display` }),
  Wn = (e) => e.type === `textord` && e.text === `@`,
  Gn = (e, t) => (e.type === `mathord` || e.type === `atom`) && e.text === t;
function Kn(e, t, n) {
  var r = Hn[e];
  switch (r) {
    case `\\\\cdrightarrow`:
...
function qn(e) {
  ...
  for (var r = [], a = [r], o = 0; o < t.length; o++) {
    for (var s = t[o], c = Un(), l = 0; l < s.length; l++)
      if (!Wn(s[l])) c.body.push(s[l]);
      else {
        (r.push(c), (l += 1));
        var u = Mn(s[l]).text,
          d = [, ,];
        if (
          ...
          else throw new i(`Expected one of "<>AV=|." after @`, s[l]);
        var h = {
          type: `styling`,
          body: [Kn(u, d, e)],
          mode: `math`,
    ...
    (o % 2 == 0 ? r.push(c) : r.shift(), (r = []), a.push(r));
  }
  return (
    e.gullet.endGroup(),
    e.gullet.endGroup(),
...
(K({
  ...
  htmlBuilder(e, t) {
    var n = t.havingStyle(t.style.sup()),
      r = W.wrapFragment(Y(e.label, n, t), t);
    return (
      r.classes.push(`cd-label-` + e.side),
      (r.style.bottom = k(0.8 - r.depth)),
      (r.height = 0),
      (r.depth = 0),
      r
    );
  ...
  mathmlBuilder(e, t) {
    var n = new X.MathNode(`mrow`, [Z(e.label, t)]);
    return (
      (n = new X.MathNode(`mpadded`, [n])),
      n.setAttribute(`width`, `0`),
      e.side === `left` && n.setAttribute(`lspace`, `-1width`),
      n.setAttribute(`voffset`, `0.7em`),
      (n = new X.MathNode(`mstyle`, [n])),
  ...
  K({
    ...
    htmlBuilder(e, t) {
      var n = W.wrapFragment(Y(e.fragment, t), t);
      return (n.classes.push(`cd-vert-arrow`), n);
    },
    mathmlBuilder(e, t) {
      return new X.MathNode(`mrow`, [Z(e.fragment, t)]);
    },
  }),
  K({
    type: `textord`,
    ...
    handler(e, t) {
      for (
        var { parser: n } = e, r = Q(t[0], `ordgroup`).body, a = ``, o = 0;
        o < r.length;
        o++
      ) {
        var s = Q(r[o], `textord`);
      ...
      var c = parseInt(a),
        l;
      if (isNaN(c)) throw new i(`\\@char has non-numeric argument ` + a);
      if (c < 0 || c >= 1114111)
        throw new i(`\\@char with invalid code point ` + a);
      return (
        c <= 65535
          ? (l = String.fromCharCode(c))
          : ((c -= 65536),
            (l = String.fromCharCode((c >> 10) + 55296, (c & 1023) + 56320))),
        { type: `textord`, mode: n.mode, text: l }
      );
    },
  }));
var Jn = (e, t) => {
    var n = J(e.body, t.withColor(e.color), !1);
    return W.makeFragment(n);
  },
  Yn = (e, t) => {
    var n = bn(e.body, t.withColor(e.color)),
      r = new X.MathNode(`mstyle`, n);
...
(K({
  ...
  handler(e, t) {
    var { parser: n } = e,
      ...
      i = t[1];
    return { type: `color`, mode: n.mode, color: r, body: q(i) };
  },
  htmlBuilder: Jn,
  mathmlBuilder: Yn,
}),
  ...
  K({
    ...
    htmlBuilder(e, t) {
      var n = W.makeSpan([`mspace`], [], t);
      return (
        e.newLine &&
          (n.classes.push(`newline`),
          e.size && (n.style.marginTop = k(O(e.size, t)))),
        n
      );
    },
    mathmlBuilder(e, t) {
      var n = new X.MathNode(`mspace`);
      return (
        e.newLine &&
          (n.setAttribute(`linebreak`, `newline`),
          e.size && n.setAttribute(`height`, k(O(e.size, t)))),
        n
      );
    },
  }));
...
(K({
  ...
  handler(e) {
    ...
    if (Xn[r.text])
      return (
        (n === `\\global` || n === `\\\\globallong`) && (r.text = Xn[r.text]),
        Q(t.parseFunction(), `internal`)
      );
  ...
  K({
    ...
    handler(e) {
      ...
      for (var o = 0, s, c = [[]]; t.gullet.future().text !== `{`; )
        if (((r = t.gullet.popToken()), r.text === `#`)) {
          if (t.gullet.future().text === `{`) {
            ((s = t.gullet.future()), c[o].push(`{`));
            break;
          }
      ...
      return (
        ...
        t.gullet.macros.set(
          a,
          { tokens: l, numArgs: o, delimiters: c },
          n === Xn[n],
        ),
  ...
  K({
    ...
    handler(e) {
      var { parser: t, funcName: n } = e,
        r = Zn(t.gullet.popToken());
      return (
        t.gullet.consumeSpaces(),
        $n(t, r, Qn(t), n === `\\\\globallet`),
        { type: `internal`, mode: t.mode }
      );
    },
  }),
...
var er = function (e, t, n) {
    var r = Oe((A.math[e] && A.math[e].replace) || e, t, n);
    if (!r)
  ...
  tr = function (e, t, n, r) {
    var i = n.havingBaseStyle(t),
      a = W.makeSpan(r.concat(i.sizingClasses(n)), [e], n),
  ...
  nr = function (e, t, n) {
    var r = t.havingBaseStyle(n),
      i =
        (1 - t.sizeMultiplier / r.sizeMultiplier) * t.fontMetrics().axisHeight;
  ...
  rr = function (e, t, n, r, i, a) {
    var o = tr(W.makeSymbol(e, `Main-Regular`, i, r), t, r, a);
    return (n && nr(o, r, t), o);
  },
  ir = function (e, t, n, r) {
    return W.makeSymbol(e, `Size` + t + `-Regular`, n, r);
  },
  ar = function (e, t, n, r, i, a) {
    var o = ir(e, t, i, r),
      s = tr(W.makeSpan([`delimsizing`, `size` + t], [o], r), D.TEXT, r, a);
    return (n && nr(s, r, D.TEXT), s);
  },
  or = function (e, t, n) {
    ...
    return {
      ...
      elem: W.makeSpan(
        [`delimsizinginner`, r],
        [W.makeSpan([], [W.makeSymbol(e, t, n)])],
      ),
    };
  },
  sr = function (e, t, n) {
    var r = we[`Size4-Regular`][e.charCodeAt(0)]
        ? we[`Size4-Regular`][e.charCodeAt(0)][4]
        : we[`Size1-Regular`][e.charCodeAt(0)][4],
      i = new Je([new Ye(`inner`, be(e, Math.round(1e3 * t)))], {
        width: k(r),
        height: k(t),
        style: `width:` + k(r),
  ...
  fr = function (e, t, n, r, i, a) {
    ...
    if (u.length > 0) {
      var E = C - m - v,
        te = Math.round(C * 1e3),
        ne = Se(u, Math.round(E * 1e3)),
        re = new Ye(u, ne),
        ie = (d / 1e3).toFixed(3) + `em`,
        ae = (te / 1e3).toFixed(3) + `em`,
        oe = new Je([re], {
          width: ie,
          height: ae,
          viewBox: `0 0 ` + d + ` ` + te,
        }),
        se = W.makeSvgSpan([], [oe], r);
      ((se.height = te / 1e3),
        (se.style.width = ie),
        (se.style.height = ae),
        T.push({ type: `elem`, elem: se }));
    } else {
      if ((T.push(or(l, f, i)), T.push(lr), s === null)) {
        var ce = C - m - v + 2 * cr;
        T.push(sr(c, ce, r));
      } else {
        var le = (C - m - v - y) / 2 + 2 * cr;
        (T.push(sr(c, le, r)),
          T.push(lr),
          T.push(or(s, f, i)),
          T.push(lr),
      ...
      (T.push(lr), T.push(or(o, f, i)));
    }
    var ue = r.havingBaseStyle(D.TEXT),
      de = W.makeVList(
        { positionType: `bottom`, positionData: ee, children: T },
        ue,
      );
    return tr(W.makeSpan([`delimsizing`, `mult`], [de], ue), D.TEXT, r, a);
  },
  pr = 80,
  mr = 0.08,
  hr = function (e, t, n, r, i) {
    var a = new Je([new Ye(e, ye(e, r, n))], {
      width: `400em`,
      height: k(t),
      viewBox: `0 0 400000 ` + n,
      preserveAspectRatio: `xMinYMin slice`,
    });
    return W.makeSvgSpan([`hide-tail`], [a], i);
  },
  gr = function (e, t) {
    var n = t.havingBaseSizing(),
      r = Er(`\\surd`, e * n.sizeMultiplier, wr, n),
      i = n.sizeMultiplier,
      ...
      r.type === `small`
        ...
        : r.type === `large`
          ? ((l = (1e3 + pr) * br[r.size]),
            (c = (br[r.size] + a) / i),
            (s = (br[r.size] + a + mr) / i),
            (o = hr(`sqrtSize` + r.size, s, l, a, t)),
            (o.style.minWidth = `1.02em`),
            (u = 1 / i))
          : ((s = e + a + mr),
            (c = e + a),
            (l = Math.floor(1e3 * e + a) + pr),
            (o = hr(`sqrtTall`, s, l, a, t)),
  ...
  yr = [`<`, `>`, `\\langle`, `\\rangle`, `/`, `\\backslash`, `\\lt`, `\\gt`],
  br = [0, 1.2, 1.8, 2.4, 3],
  xr = function (e, t, n, r, a) {
    if (
      (e === `<` || e === `\\lt` || e === `⟨`
        ? (e = `\\langle`)
        : (e === `>` || e === `\\gt` || e === `⟩`) && (e = `\\rangle`),
      _r.includes(e) || yr.includes(e))
    )
      return ar(e, t, !1, n, r, a);
    if (vr.includes(e)) return fr(e, br[t], !1, n, r, a);
  ...
  Dr = function (e, t, n, r, i, a) {
    e === `<` || e === `\\lt` || e === `⟨`
      ? (e = `\\langle`)
      : (e === `>` || e === `\\gt` || e === `⟩`) && (e = `\\rangle`);
    var o = yr.includes(e) ? Sr : _r.includes(e) ? wr : Cr,
      s = Er(e, t, o, r);
    return s.type === `small`
      ? rr(e, s.style, n, r, i, a)
      : s.type === `large`
        ? ar(e, s.size, n, r, i, a)
        : fr(e, t, n, r, i, a);
  },
  Or = {
    ...
    sizeToMaxHeight: br,
    customSizedDelim: Dr,
    leftRightDelim: function (e, t, n, r, i, a) {
      var o = r.fontMetrics().axisHeight * r.sizeMultiplier,
        s = 901,
        c = 5 / r.fontMetrics().ptPerEm,
        l = Math.max(t - o, n + o);
      return Dr(e, Math.max((l / 500) * s, 2 * l - c), !0, r, i, a);
    },
  },
  kr = {
...
function jr(e, t) {
  var n = Nn(e);
  if (n && Ar.includes(n.text)) return n;
  throw n
    ? new i(`Invalid delimiter '` + n.text + `' after '` + t.funcName + `'`, e)
    : new i(`Invalid delimiter type '` + e.type + `'`, e);
}
K({
  type: `delimsizing`,
  names: [
  ...
  mathmlBuilder: (e) => {
    var t = [];
    e.delim !== `.` && t.push(gn(e.delim, e.mode));
    var n = new X.MathNode(`mo`, t);
    (e.mclass === `mopen` || e.mclass === `mclose`
      ? n.setAttribute(`fence`, `true`)
      : n.setAttribute(`fence`, `false`),
      n.setAttribute(`stretchy`, `true`));
    var r = k(Or.sizeToMaxHeight[e.size]);
...
(K({
  ...
  K({
    ...
    htmlBuilder: (e, t) => {
      Mr(e);
      for (
        var n = J(e.body, t, !0, [`mopen`, `mclose`]),
          r = 0,
          i = 0,
          a = !1,
          o = 0;
      ...
      var s =
        e.left === `.`
          ? un(t, [`mopen`])
          : Or.leftRightDelim(e.left, r, i, t, e.mode, [`mopen`]);
      if ((n.unshift(s), a))
        for (var c = 1; c < n.length; c++) {
          var l = n[c].isMiddle;
          l && (n[c] = Or.leftRightDelim(l.delim, r, i, l.options, e.mode, []));
        }
      var u;
      if (e.right === `.`) u = un(t, [`mclose`]);
      else {
        var d = e.rightColor ? t.withColor(e.rightColor) : t;
        u = Or.leftRightDelim(e.right, r, i, d, e.mode, [`mclose`]);
      }
      return (n.push(u), W.makeSpan([`minner`], n, t));
    },
    mathmlBuilder: (e, t) => {
      Mr(e);
      var n = bn(e.body, t);
      if (e.left !== `.`) {
        var r = new X.MathNode(`mo`, [gn(e.left, e.mode)]);
        (r.setAttribute(`fence`, `true`), n.unshift(r));
      }
      if (e.right !== `.`) {
        var i = new X.MathNode(`mo`, [gn(e.right, e.mode)]);
  ...
  K({
    ...
    handler: (e, t) => {
      ...
      if (!e.parser.leftrightDepth)
        throw new i(`\\middle without preceding \\left`, n);
    ...
    htmlBuilder: (e, t) => {
      ...
      if (e.delim === `.`) n = un(t, []);
        ...
        n = Or.sizedDelim(e.delim, 1, t, e.mode, []);
...
var Nr = (e, t) => {
    ...
    if (r === `sout`)
      ...
      var f = Math.floor(1e3 * d * i),
        p = new Je([new Ye(`phase`, _e(f))], {
          width: `400em`,
          height: k(f / 1e3),
          viewBox: `0 0 400000 ` + f,
          preserveAspectRatio: `xMinYMin slice`,
        });
      ((a = W.makeSvgSpan([`hide-tail`], [p], t)),
        (a.style.height = k(d)),
        (o = n.depth + c + l));
    } else {
      /cancel/.test(r)
      ...
      (/box/.test(r)
        ...
        : r === `angl`
          ...
          : ((h = s ? 0.2 : 0), (g = h)),
        (a = jn.encloseSpan(n, r, h, g, t)),
        /fbox|boxed|fcolorbox/.test(r)
          ? ((a.style.borderStyle = `solid`), (a.style.borderWidth = k(_)))
          : r === `angl` &&
            _ !== 0.049 &&
            ((a.style.borderTopWidth = k(_)),
            (a.style.borderRightWidth = k(_))),
        (o = n.depth + g),
        e.backgroundColor &&
    ...
    return (
      ...
      /cancel/.test(r) && !s
        ? W.makeSpan([`mord`, `cancel-lap`], [v], t)
        : W.makeSpan([`mord`], [v], t)
    );
  },
  Pr = (e, t) => {
    ...
    return (
      e.backgroundColor && r.setAttribute(`mathbackground`, e.backgroundColor),
      r
    );
  };
(K({
...
function Vr(e, t, n) {
  ...
  if (
    (e.gullet.beginGroup(), d || e.gullet.macros.set(`\\cr`, `\\\\\\relax`), !c)
  ) {
    var h = e.gullet.expandMacroAsText(`\\arraystretch`);
    if (h == null) c = 1;
    else if (((c = parseFloat(h)), !c || c < 0))
      throw new i(`Invalid \\arraystretch: ` + h);
  }
  e.gullet.beginGroup();
  var g = [],
    _ = [g],
  ...
  function S() {
    b &&
      (e.gullet.macros.get(`\\df@tag`)
        ? (b.push(e.subparse([new r(`\\df@tag`)])),
          e.gullet.macros.set(`\\df@tag`, void 0, !0))
        : b.push(!!u && e.gullet.macros.get(`\\@eqnsw`) === `1`));
  }
  for (x(), y.push(Rr(e)); ; ) {
    var C = e.parseExpression(!1, d ? `\\end` : `\\\\`);
    (e.gullet.endGroup(),
      e.gullet.beginGroup(),
      (C = { type: `ordgroup`, mode: e.mode, body: C }),
      n && (C = { type: `styling`, mode: e.mode, style: n, body: [C] }),
      g.push(C));
    var w = e.fetch().text;
    if (w === `&`) {
      if (p && g.length === p) {
        if (d || l) throw new i(`Too many tab characters: &`, e.nextToken);
      ...
      (S(),
        g.length === 1 &&
          C.type === `styling` &&
          C.body[0].body.length === 0 &&
          (_.length > 1 || !f) &&
          _.pop(),
        y.length < _.length + 1 && y.push([]));
      break;
    } else if (w === `\\\\`) {
      e.consume();
      var ee = void 0;
      (e.gullet.future().text !== ` ` && (ee = e.parseSizeGroup(!0)),
        v.push(ee ? ee.value : null),
        S(),
        y.push(Rr(e)),
        (g = []),
        _.push(g),
...
var Ur = function (e, t) {
    ...
    e.colSeparationType &&
      ...
      (f =
        0.2778 * (t.havingStyle(D.SCRIPT).sizeMultiplier / t.sizeMultiplier));
    var p =
        e.colSeparationType === `CD` ? O({ number: 3, unit: `ex` }, t) : 12 * d,
      h = 3 * d,
      g = e.arraystretch * p,
      _ = 0.7 * g,
      v = 0.3 * g,
    ...
    function b(e) {
      for (var t = 0; t < e.length; ++t)
        (t > 0 && (y += 0.25), l.push({ pos: y, isDashed: e[t] }));
    }
    for (b(o[0]), n = 0; n < e.body.length; ++n) {
      ...
      var w = Array(x.length);
      for (r = 0; r < x.length; ++r) {
        var ee = Y(x[r], t);
        (C < ee.depth && (C = ee.depth),
          S < ee.height && (S = ee.height),
          (w[r] = ee));
      }
      var T = e.rowGaps[n],
        E = 0;
      (T && ((E = O(T, t)), E > 0 && ((E += v), C < E && (C = E), (E = 0))),
        e.addJot && (C += h),
        (w.height = S),
        (w.depth = C),
        (y += S),
    ...
    var te = y / 2 + t.fontMetrics().axisHeight,
      ne = e.cols || [],
      re = [],
      ie,
      ae,
    ...
    if (e.tags && e.tags.some((e) => e))
      for (n = 0; n < a; ++n) {
        ...
        ((ue =
          le === !0
            ? W.makeSpan([`eqn-num`], [], t)
            : le === !1
              ? W.makeSpan([], [], t)
              : W.makeSpan([], J(le, t, !0), t)),
          (ue.depth = se.depth),
          (ue.height = se.height),
          oe.push({ type: `elem`, elem: ue, shift: ce }));
      }
    for (r = 0, ae = 0; r < s || ae < ne.length; ++r, ++ae) {
      for (var de = ne[ae] || {}, fe = !0; de.type === `separator`; ) {
        if (
          (fe ||
            ((ie = W.makeSpan([`arraycolsep`], [])),
            (ie.style.width = k(t.fontMetrics().doubleRuleSep)),
            re.push(ie)),
          de.separator === `|` || de.separator === `:`)
        ) {
          var pe = de.separator === `|` ? `solid` : `dashed`,
            me = W.makeSpan([`vertical-separator`], [], t);
          ((me.style.height = k(y)),
            (me.style.borderRightWidth = k(u)),
            (me.style.borderRightStyle = pe),
            (me.style.margin = `0 ` + k(-u / 2)));
          var he = y - te;
          (he && (me.style.verticalAlign = k(-he)), re.push(me));
        } else throw new i(`Invalid separator type: ` + de.separator);
        (ae++, (de = ne[ae] || {}), (fe = !1));
      }
      if (!(r >= s)) {
        var ge = void 0;
        (r > 0 || e.hskipBeforeAndAfter) &&
          ((ge = m.deflt(de.pregap, f)),
          ge !== 0 &&
            ((ie = W.makeSpan([`arraycolsep`], [])),
            (ie.style.width = k(ge)),
            re.push(ie)));
        ...
        for (n = 0; n < a; ++n) {
          ...
          if (ye) {
            ...
            ((ye.depth = ve.depth),
              (ye.height = ve.height),
              _e.push({ type: `elem`, elem: ye, shift: be }));
          }
        }
        ((_e = W.makeVList(
          { positionType: `individualShift`, children: _e },
          t,
        )),
          (_e = W.makeSpan([`col-align-` + (de.align || `c`)], [_e])),
          re.push(_e),
          (r < s - 1 || e.hskipBeforeAndAfter) &&
            ((ge = m.deflt(de.postgap, f)),
            ge !== 0 &&
              ((ie = W.makeSpan([`arraycolsep`], [])),
              (ie.style.width = k(ge)),
              re.push(ie))));
    ...
    if (((c = W.makeSpan([`mtable`], re)), l.length > 0)) {
      for (
        var xe = W.makeLineSpan(`hline`, t, u),
          Se = W.makeLineSpan(`hdashline`, t, u),
          Ce = [{ type: `elem`, elem: c, shift: 0 }];
        l.length > 0;
      ) {
        var we = l.pop(),
          Te = we.pos - te;
        we.isDashed
          ? Ce.push({ type: `elem`, elem: Se, shift: Te })
          : Ce.push({ type: `elem`, elem: xe, shift: Te });
      }
      c = W.makeVList({ positionType: `individualShift`, children: Ce }, t);
    }
    if (oe.length === 0) return W.makeSpan([`mord`], [c], t);
    var Ee = W.makeVList({ positionType: `individualShift`, children: oe }, t);
    return ((Ee = W.makeSpan([`tag`], [Ee], t)), W.makeFragment([c, Ee]));
  },
  Wr = { c: `center `, l: `left `, r: `right ` },
  Gr = function (e, t) {
    for (
      var n = [],
        r = new X.MathNode(`mtd`, [], [`mtr-glue`]),
        i = new X.MathNode(`mtd`, [], [`mml-eqn-num`]),
        a = 0;
      a < e.body.length;
      a++
    ) {
      for (var o = e.body[a], s = [], c = 0; c < o.length; c++)
        s.push(new X.MathNode(`mtd`, [Z(o[c], t)]));
      (e.tags &&
        e.tags[a] &&
        (s.unshift(r), s.push(r), e.leqno ? s.unshift(i) : s.push(i)),
        n.push(new X.MathNode(`mtr`, s)));
    }
    var l = new X.MathNode(`mtable`, n),
      u =
        e.arraystretch === 0.5
          ? 0.1
    ...
    if (e.cols && e.cols.length > 0) {
      ...
      for (var v = g; v < _; v++)
        p[v].type === `align`
          ? ((f += Wr[p[v].align]), h && (m += `none `), (h = !0))
          : p[v].type === `separator` &&
            (h &&= ((m += p[v].separator === `|` ? `solid ` : `dashed `), !1));
    ...
    for (var w = 1; w < C.length - 1; w++)
      S += C[w].length === 0 ? `none ` : C[w][0] ? `dashed ` : `solid `;
    return (
      /[sd]/.test(S) && l.setAttribute(`rowlines`, S.trim()),
      d !== `` &&
        ((l = new X.MathNode(`menclose`, [l])),
        l.setAttribute(`notation`, d.trim())),
      e.arraystretch &&
        e.arraystretch < 1 &&
        ((l = new X.MathNode(`mstyle`, [l])),
  ...
  Kr = function (e, t) {
    ...
    o.body.forEach(function (e) {
      for (var t = 1; t < e.length; t += 2)
        Q(Q(e[t], `styling`).body[0], `ordgroup`).body.unshift(l);
      if (p) c < e.length && (c = e.length);
      else {
        var n = e.length / 2;
        if (s < n)
          throw new i(
            `Too many math in a row: ` + (`expected ` + s + `, but got ` + n),
            e[0],
          );
      }
    });
    for (var m = 0; m < c; ++m) {
      var h = `r`,
        g = 0;
      (m % 2 == 1 ? (h = `l`) : m > 0 && p && (g = 1),
        (n[m] = { type: `align`, align: h, pregap: g, postgap: 0 }));
    }
...
(Ir({
  ...
  props: { numArgs: 1 },
  handler(e, t) {
    var n = (Nn(t[0]) ? [t[0]] : Q(t[0], `ordgroup`).body).map(function (e) {
        var t = Mn(e).text;
    ...
    return Vr(e.parser, r, Hr(e.envName));
  },
  htmlBuilder: Ur,
  mathmlBuilder: Gr,
}),
  Ir({
    ...
    handler(e) {
      ...
      var o = Vr(e.parser, r, Hr(e.envName)),
        s = Math.max(0, ...o.body.map((e) => e.length));
      return (
        (o.cols = Array(s).fill({ type: `align`, align: n })),
        t
          ? {
              type: `leftright`,
              mode: e.mode,
  ...
  Ir({
    ...
    props: { numArgs: 0 },
    handler(e) {
      var t = Vr(e.parser, { arraystretch: 0.5 }, `script`);
  ...
  Ir({
    ...
    props: { numArgs: 0 },
    handler(e) {
      [`gather`, `gather*`].includes(e.envName) && zr(e);
      var t = {
...
K({
  ...
  handler(e, t) {
    var { parser: n, funcName: r } = e,
      a = t[0];
    if (a.type !== `ordgroup`) throw new i(`Invalid environment name`, a);
    for (var o = ``, s = 0; s < a.body.length; ++s)
      o += Q(a.body[s], `textord`).text;
    if (r === `\\begin`) {
      if (!qr.hasOwnProperty(o)) throw new i(`No such environment: ` + o, a);
      var c = qr[o],
        { args: l, optArgs: u } = n.parseArguments(`\\begin{` + o + `}`, c),
        d = { mode: n.mode, envName: o, parser: n },
        f = c.handler(d, l, u);
      n.expect(`\\end`, !1);
      var p = n.nextToken,
        m = Q(n.parseFunction(), `environment`);
      if (m.name !== o)
        throw new i(
          `Mismatch: \\begin{` + o + `} matched by \\end{` + m.name + `}`,
          p,
        );
      return f;
    }
    return { type: `environment`, mode: n.mode, name: o, nameGroup: a };
  },
});
var Jr = (e, t) => {
    var n = e.font,
...
var Zr = (e, t) => {
    ...
    return (
      e === `display`
        ? (n = n.id >= D.SCRIPT.id ? n.text() : D.DISPLAY)
        : e === `text` && n.size === D.DISPLAY.size
          ? (n = D.TEXT)
          : e === `script`
            ? (n = D.SCRIPT)
            : e === `scriptscript` && (n = D.SCRIPTSCRIPT),
      n
    );
  },
  Qr = (e, t) => {
    var n = Zr(e.size, t.style),
      r = n.fracNum(),
      i = n.fracDen(),
      a = t.havingStyle(r),
      o = Y(e.numer, a, t);
    ...
    e.hasBarLine
      ? (e.barSize
          ? ((d = O(e.barSize, t)), (u = W.makeLineSpan(`frac-line`, t, d)))
          : (u = W.makeLineSpan(`frac-line`, t)),
        (d = u.height),
        (f = u.height))
      : ((u = null), (d = 0), (f = t.fontMetrics().defaultRuleThickness));
    var p, m, h;
    n.size === D.DISPLAY.size || e.size === `display`
    ...
    var b =
        n.size === D.DISPLAY.size
          ? t.fontMetrics().delim1
          : n.size === D.SCRIPTSCRIPT.size
            ? t.havingStyle(D.SCRIPT).fontMetrics().delim2
            : t.fontMetrics().delim2,
      x =
        e.leftDelim == null
          ? un(t, [`mopen`])
          : Or.customSizedDelim(e.leftDelim, b, !0, t.havingStyle(n), e.mode, [
              `mopen`,
            ]),
      S = e.continued
        ? W.makeSpan([])
...
var ei = [`display`, `text`, `script`, `scriptscript`],
  ti = function (e) {
    var t = null;
...
(K({
  ...
  handler(e, t) {
    var { parser: n } = e,
      ...
      i = t[5],
      a = $t(t[0]),
      o = a.type === `atom` && a.family === `open` ? ti(a.text) : null,
      s = $t(t[1]),
      c = s.type === `atom` && s.family === `close` ? ti(s.text) : null,
      l = Q(t[2], `size`),
      u,
      d = null;
    ...
    } else ((p = Q(p, `textord`)), (f = ei[Number(p.text)]));
    return {
      type: `genfrac`,
      mode: n.mode,
      numer: r,
...
var ni = (e, t) => {
  ...
  e.type === `supsub`
    ? ((r = e.sup
        ? Y(e.sup, t.havingStyle(n.sup()), t)
        : Y(e.sub, t.havingStyle(n.sub()), t)),
      (i = Q(e.base, `horizBrace`)))
    : (i = Q(e, `horizBrace`));
  var a = Y(i.base, t.havingBaseStyle(D.DISPLAY)),
    o = jn.svgSpan(i, t),
    s;
  if (
    (i.isOver
    ...
    var c = W.makeSpan([`mord`, i.isOver ? `mover` : `munder`], [s], t);
    s = i.isOver
      ? W.makeVList(
          {
            positionType: `firstBaseline`,
  ...
  return W.makeSpan([`mord`, i.isOver ? `mover` : `munder`], [s], t);
};
(K({
  type: `horizBrace`,
  ...
  mathmlBuilder: (e, t) => {
    var n = jn.mathMLnode(e.label);
    return new X.MathNode(e.isOver ? `mover` : `munder`, [Z(e.base, t), n]);
  },
}),
  K({
    type: `href`,
    ...
    handler: (e, t) => {
      ...
      return n.settings.isTrusted({ command: `\\href`, url: i })
        ? { type: `href`, mode: n.mode, href: i, body: q(r) }
        : n.formatUnsupportedCmd(`\\href`);
    },
    htmlBuilder: (e, t) => {
      var n = J(e.body, t, !1);
      return W.makeAnchor(e.href, [], n, t);
    },
    mathmlBuilder: (e, t) => {
      var n = xn(e.body, t);
      return (
        n instanceof mn || (n = new mn(`mrow`, [n])),
  ...
  K({
    ...
    handler: (e, t) => {
      ...
      return { type: `href`, mode: n.mode, href: r, body: q(s) };
    },
  }),
  K({
    type: `hbox`,
    ...
    handler(e, t) {
      var { parser: n } = e;
      return { type: `hbox`, mode: n.mode, body: q(t[0]) };
    },
    htmlBuilder(e, t) {
      var n = J(e.body, t, !1);
      return W.makeFragment(n);
    ...
    mathmlBuilder(e, t) {
      return new X.MathNode(`mrow`, bn(e.body, t));
    },
  }),
  K({
    type: `html`,
    ...
    handler: (e, t) => {
      ...
      switch (r) {
        case `\\htmlClass`:
          ((l.class = o), (c = { command: `\\htmlClass`, class: o }));
          break;
        case `\\htmlId`:
          ((l.id = o), (c = { command: `\\htmlId`, id: o }));
          break;
        case `\\htmlStyle`:
          ((l.style = o), (c = { command: `\\htmlStyle`, style: o }));
          break;
        case `\\htmlData`:
          for (var u = o.split(`,`), d = 0; d < u.length; d++) {
            ...
            if (p < 0)
              throw new i(
                `\\htmlData key/value '` + f + `' missing equals sign`,
              );
            var m = f.slice(0, p),
              h = f.slice(p + 1);
            l[`data-` + m.trim()] = h;
          }
          c = { command: `\\htmlData`, attributes: l };
          break;
        default:
          throw Error(`Unrecognized html command`);
      }
      return n.settings.isTrusted(c)
        ? { type: `html`, mode: n.mode, attributes: l, body: q(s) }
  ...
  K({
    ...
    mathmlBuilder: (e, t) => xn(e.mathml, t),
  }));
var ri = function (e) {
  ...
  if (!Le(n))
    throw new i(`Invalid unit: '` + n.unit + `' in \\includegraphics.`);
  return n;
};
(K({
  ...
  handler: (e, t, n) => {
    var { parser: r } = e,
      ...
      c = ``;
    if (n[0])
      for (var l = Q(n[0], `raw`).string.split(`,`), u = 0; u < l.length; u++) {
        var d = l[u].split(`=`);
        if (d.length === 2) {
          var f = d[1].trim();
          switch (d[0].trim()) {
  ...
  htmlBuilder: (e, t) => {
    ...
    var o = new Ge(e.src, e.alt, a);
    return ((o.height = n), (o.depth = r), o);
  },
  mathmlBuilder: (e, t) => {
    var n = new X.MathNode(`mglyph`, []);
    n.setAttribute(`alt`, e.alt);
    var r = O(e.height, t),
      i = 0;
    if (
      (e.totalheight.number > 0 &&
        ((i = O(e.totalheight, t) - r), n.setAttribute(`valign`, k(-i))),
      n.setAttribute(`height`, k(r + i)),
      e.width.number > 0)
    ) {
      var a = O(e.width, t);
  ...
  K({
    ...
    htmlBuilder(e, t) {
      return W.makeGlue(e.dimension, t);
    },
    mathmlBuilder(e, t) {
      var n = O(e.dimension, t);
      return new X.SpaceNode(n);
    },
  }),
  K({
    type: `lap`,
    ...
    htmlBuilder: (e, t) => {
      var n;
      e.alignment === `clap`
        ? ((n = W.makeSpan([], [Y(e.body, t)])),
          (n = W.makeSpan([`inner`], [n], t)))
        : (n = W.makeSpan([`inner`], [Y(e.body, t)]));
      var r = W.makeSpan([`fix`], []),
        i = W.makeSpan([e.alignment], [n, r], t),
        a = W.makeSpan([`strut`]);
      return (
        (a.style.height = k(i.height + i.depth)),
        i.depth && (a.style.verticalAlign = k(-i.depth)),
        i.children.unshift(a),
        (i = W.makeSpan([`thinbox`], [i], t)),
        W.makeSpan([`mord`, `vbox`], [i], t)
      );
    },
    mathmlBuilder: (e, t) => {
      var n = new X.MathNode(`mpadded`, [Z(e.body, t)]);
      if (e.alignment !== `rlap`) {
...
K({
  ...
  mathmlBuilder: (e, t) => xn(ii(e, t), t),
});
var ai = (e, t, n, r, i, a, o) => {
    e = W.makeSpan([], [e]);
    var s = n && m.isCharacterBox(n),
      c,
      l;
    if (t) {
      var u = Y(t, r.havingStyle(i.sup()), r);
      l = {
        elem: u,
        kern: Math.max(
    ...
    if (n) {
      var d = Y(n, r.havingStyle(i.sub()), r);
      c = {
        elem: d,
        kern: Math.max(
      ...
      f = W.makeVList(
        {
          ...
          children: [
            ...
            { type: `elem`, elem: c.elem, marginLeft: k(-a) },
            { type: `kern`, size: c.kern },
            { type: `elem`, elem: e },
            { type: `kern`, size: l.kern },
            { type: `elem`, elem: l.elem, marginLeft: k(a) },
            { type: `kern`, size: r.fontMetrics().bigOpSpacing5 },
          ],
        },
        r,
    ...
    var _ = [f];
    if (c && a !== 0 && !s) {
      var v = W.makeSpan([`mspace`], [], r);
      ((v.style.marginRight = k(a)), _.unshift(v));
    }
    return W.makeSpan([`mop`, `op-limits`], _, r);
  },
  oi = [`\\smallint`],
  si = (e, t) => {
    var n,
      ...
      a;
    e.type === `supsub`
      ? ((n = e.sup), (r = e.sub), (a = Q(e.base, `op`)), (i = !0))
      : (a = Q(e, `op`));
    var o = t.style,
      s = !1;
    o.size === D.DISPLAY.size && a.symbol && !oi.includes(a.name) && (s = !0);
    var c;
    if (a.symbol) {
      ...
      if (
        ...
        (c = W.makeSymbol(a.name, l, `math`, t, [
          `mop`,
          `op-symbol`,
          s ? `large-op` : `small-op`,
        ])),
      ...
      var p = J(a.body, t, !0);
      p.length === 1 && p[0] instanceof qe
        ? ((c = p[0]), (c.classes[0] = `mop`))
        : (c = W.makeSpan([`mop`], p, t));
    } else {
      for (var m = [], h = 1; h < a.name.length; h++)
        m.push(W.mathsym(a.name[h], a.mode, t));
      c = W.makeSpan([`mop`], m, t);
    }
    var g = 0,
      _ = 0;
    return (
      (c instanceof qe || a.name === `\\oiint` || a.name === `\\oiiint`) &&
        !a.suppressBaseShift &&
        ((g = (c.height - c.depth) / 2 - t.fontMetrics().axisHeight),
        (_ = c.italic)),
      i
        ? ai(c, n, r, t, o, _, g)
        : (g && ((c.style.position = `relative`), (c.style.top = k(g))), c)
    );
  },
  ci = (e, t) => {
    var n;
    if (e.symbol)
      ((n = new mn(`mo`, [gn(e.name, e.mode)])),
        oi.includes(e.name) && n.setAttribute(`largeop`, `false`));
    else if (e.body) n = new mn(`mo`, bn(e.body, t));
    else {
      n = new mn(`mi`, [new hn(e.name.slice(1))]);
      var r = new mn(`mo`, [gn(`⁡`, `text`)]);
      n = e.parentIsSupSub ? new mn(`mrow`, [n, r]) : pn([n, r]);
    }
    return n;
  },
  li = {
...
var di = (e, t) => {
  var n,
    ...
    a;
  e.type === `supsub`
    ? ((n = e.sup), (r = e.sub), (a = Q(e.base, `operatorname`)), (i = !0))
    : (a = Q(e, `operatorname`));
  var o;
  if (a.body.length > 0) {
    for (
    ...
    o = W.makeSpan([`mop`], s, t);
  } else o = W.makeSpan([`mop`], [], t);
  return i ? ai(o, n, r, t, t.style, 0, 0) : o;
};
(K({
  type: `operatorname`,
  ...
  mathmlBuilder: (e, t) => {
    for (
      var n = bn(e.body, t.withFont(`mathrm`)), r = !0, i = 0;
      i < n.length;
      i++
    ) {
      var a = n[i];
      if (!(a instanceof X.SpaceNode))
        if (a instanceof X.MathNode)
          switch (a.type) {
            ...
            case `mo`:
              var o = a.children[0];
              a.children.length === 1 && o instanceof X.TextNode
                ? (o.text = o.text
                    .replace(/\u2212/, `-`)
                    .replace(/\u2217/, `*`))
                : (r = !1);
    ...
    var c = new X.MathNode(`mi`, n);
    c.setAttribute(`mathvariant`, `normal`);
    var l = new X.MathNode(`mo`, [gn(`⁡`, `text`)]);
    return e.parentIsSupSub
      ? new X.MathNode(`mrow`, [c, l])
      : X.newDocumentFragment([c, l]);
  },
}),
  ...
  Qt({
    ...
    htmlBuilder(e, t) {
      return e.semisimple
        ? W.makeFragment(J(e.body, t, !1))
        : W.makeSpan([`mord`], J(e.body, t, !0), t);
    },
    mathmlBuilder(e, t) {
      return xn(e.body, t, !0);
    },
  }),
  K({
    type: `overline`,
    ...
    htmlBuilder(e, t) {
      var n = Y(e.body, t.havingCrampedStyle()),
        r = W.makeLineSpan(`overline-line`, t),
      ...
      return W.makeSpan([`mord`, `overline`], [a], t);
    },
    mathmlBuilder(e, t) {
      var n = new X.MathNode(`mo`, [new X.TextNode(`‾`)]);
      n.setAttribute(`stretchy`, `true`);
      var r = new X.MathNode(`mover`, [Z(e.body, t), n]);
      return (r.setAttribute(`accent`, `true`), r);
    },
  }),
  K({
    ...
    handler: (e, t) => {
      var { parser: n } = e,
        r = t[0];
      return { type: `phantom`, mode: n.mode, body: q(r) };
    },
    htmlBuilder: (e, t) => {
      var n = J(e.body, t.withPhantom(), !1);
      return W.makeFragment(n);
    },
    mathmlBuilder: (e, t) => {
      var n = bn(e.body, t);
      return new X.MathNode(`mphantom`, n);
    },
  }),
  K({
    type: `hphantom`,
    ...
    htmlBuilder: (e, t) => {
      var n = W.makeSpan([], [Y(e.body, t.withPhantom())]);
    ...
    mathmlBuilder: (e, t) => {
      var n = bn(q(e.body), t),
        r = new X.MathNode(`mphantom`, n),
        i = new X.MathNode(`mpadded`, [r]);
      return (
  ...
  K({
    ...
    htmlBuilder: (e, t) => {
      var n = W.makeSpan([`inner`], [Y(e.body, t.withPhantom())]),
        r = W.makeSpan([`fix`], []);
      return W.makeSpan([`mord`, `rlap`], [n, r], t);
    },
    mathmlBuilder: (e, t) => {
      var n = bn(q(e.body), t),
        r = new X.MathNode(`mphantom`, n),
  ...
  K({
    ...
    htmlBuilder(e, t) {
      var n = W.makeSpan([`mord`, `rule`], [], t),
        r = O(e.width, t),
        i = O(e.height, t),
        a = e.shift ? O(e.shift, t) : 0;
      return (
        (n.style.borderRightWidth = k(r)),
        (n.style.borderTopWidth = k(i)),
        (n.style.bottom = k(a)),
        (n.width = r),
        (n.height = i + a),
        (n.depth = -a),
    ...
    mathmlBuilder(e, t) {
      var n = O(e.width, t),
        ...
        o = new X.MathNode(`mspace`);
      (o.setAttribute(`mathbackground`, a),
        o.setAttribute(`width`, k(n)),
        o.setAttribute(`height`, k(r)));
      var s = new X.MathNode(`mpadded`, [o]);
      return (
        i >= 0
          ? s.setAttribute(`height`, k(i))
          : (s.setAttribute(`height`, k(i)), s.setAttribute(`depth`, k(-i))),
        s.setAttribute(`voffset`, k(i)),
        s
      );
    },
  }));
function fi(e, t, n) {
  for (
    var r = J(e, t, !1), i = t.sizeMultiplier / n.sizeMultiplier, a = 0;
    a < r.length;
    a++
  ) {
...
(K({
  ...
  handler: (e, t) => {
    ...
    return { type: `sizing`, mode: i.mode, size: pi.indexOf(r) + 1, body: a };
  },
  htmlBuilder: (e, t) => {
    var n = t.havingSize(e.size);
    return fi(e.body, n, t);
  },
  mathmlBuilder: (e, t) => {
    var n = t.havingSize(e.size),
      r = bn(e.body, n),
      i = new X.MathNode(`mstyle`, r);
    return (i.setAttribute(`mathsize`, k(n.sizeMultiplier)), i);
  },
}),
  K({
    type: `smash`,
  ...
  K({
    ...
    htmlBuilder(e, t) {
      ...
      if (e.index) {
        var p = t.havingStyle(D.SCRIPTSCRIPT),
          m = Y(e.index, p, t),
          ...
          _ = W.makeSpan([`root`], [g]);
        return W.makeSpan([`mord`, `sqrt`], [_, f], t);
      } else return W.makeSpan([`mord`, `sqrt`], [f], t);
    },
    mathmlBuilder(e, t) {
      var { body: n, index: r } = e;
      return r
        ? new X.MathNode(`mroot`, [Z(n, t), Z(r, t)])
        : new X.MathNode(`msqrt`, [Z(n, t)]);
    },
  }));
var mi = {
  display: D.DISPLAY,
...
var hi = function (e, t) {
  ...
  return n
    ? n.type === `op`
      ? n.limits && (t.style.size === D.DISPLAY.size || n.alwaysHandleSupSub)
        ? si
        : null
      : n.type === `operatorname`
        ? n.alwaysHandleSupSub && (t.style.size === D.DISPLAY.size || n.limits)
          ? di
          : null
        : n.type === `accent`
          ? m.isCharacterBox(n.base)
            ? Pn
            : null
...
(Qt({
  ...
  htmlBuilder(e, t) {
    ...
    if (i) {
      ...
      ((s = Y(i, p, t)),
        f ||
          (u =
            o.height -
            (p.fontMetrics().supDrop * p.sizeMultiplier) / t.sizeMultiplier));
    }
    if (a) {
      ...
      ((c = Y(a, h, t)),
        f ||
          (d =
            o.depth +
            (h.fontMetrics().subDrop * h.sizeMultiplier) / t.sizeMultiplier));
    }
    var g = t.style === D.DISPLAY ? l.sup1 : t.style.cramped ? l.sup3 : l.sup2,
      _ = t.sizeMultiplier,
      v = k(0.5 / l.ptPerEm / _),
      y = null;
    if (c) {
      ...
      (o instanceof qe || b) && (y = k(-o.italic));
    }
    var x;
    if (s && c) {
      ((u = Math.max(u, g, s.depth + 0.25 * l.xHeight)),
        (d = Math.max(d, l.sub2)));
      var S = 4 * l.defaultRuleThickness;
      if (u - s.depth - (c.height - d) < S) {
        d = S - (u - s.depth) + c.height;
        var C = 0.8 * l.xHeight - (u - s.depth);
        C > 0 && ((u += C), (d -= C));
      }
      var w = [
        { type: `elem`, elem: c, shift: d, marginRight: v, marginLeft: y },
        { type: `elem`, elem: s, shift: -u, marginRight: v },
      ];
      x = W.makeVList({ positionType: `individualShift`, children: w }, t);
    } else if (c) {
      d = Math.max(d, l.sub1, c.height - 0.8 * l.xHeight);
      var ee = [{ type: `elem`, elem: c, marginLeft: y, marginRight: v }];
      x = W.makeVList(
    ...
    var T = ln(o, `right`) || `mord`;
    return W.makeSpan([T], [o, W.makeSpan([`msupsub`], [x])], t);
  },
  mathmlBuilder(e, t) {
    var n = !1,
      r,
    ...
    (e.base &&
      ...
      ((i = !!e.sup), i === e.base.isOver && ((n = !0), (r = e.base.isOver))),
      e.base &&
    ...
    if (n) o = r ? `mover` : `munder`;
      ...
      o =
        (s &&
          s.type === `op` &&
          s.limits &&
          (t.style === D.DISPLAY || s.alwaysHandleSupSub)) ||
        (s &&
          s.type === `operatorname` &&
          s.alwaysHandleSupSub &&
          (s.limits || t.style === D.DISPLAY))
          ? `mover`
          : `msup`;
    } else if (e.sup) {
      var c = e.base;
      o =
        (c && c.type === `op` && c.limits && t.style === D.DISPLAY) ||
        (c &&
          c.type === `operatorname` &&
          c.alwaysHandleSupSub &&
          (t.style === D.DISPLAY || c.limits))
          ? `munderover`
          : `msubsup`;
    } else {
      var l = e.base;
    ...
    return new X.MathNode(o, a);
  },
}),
  Qt({
    type: `atom`,
    htmlBuilder(e, t) {
      return W.mathsym(e.text, e.mode, t, [`m` + e.family]);
    },
    mathmlBuilder(e, t) {
      var n = new X.MathNode(`mo`, [gn(e.text, e.mode)]);
      if (e.family === `bin`) {
        var r = vn(e, t);
...
var gi = { mi: `italic`, mn: `normal`, mtext: `normal` };
(Qt({
  type: `mathord`,
  htmlBuilder(e, t) {
    return W.makeOrd(e, t, `mathord`);
  },
  mathmlBuilder(e, t) {
    var n = new X.MathNode(`mi`, [gn(e.text, e.mode, t)]),
      r = vn(e, t) || `italic`;
    return (r !== gi[n.type] && n.setAttribute(`mathvariant`, r), n);
  },
}),
  Qt({
    type: `textord`,
    htmlBuilder(e, t) {
      return W.makeOrd(e, t, `textord`);
    },
    mathmlBuilder(e, t) {
      var n = gn(e.text, e.mode, t),
        r = vn(e, t) || `normal`,
        i =
          e.mode === `text`
            ? new X.MathNode(`mtext`, [n])
            : /[0-9]/.test(e.text)
              ? new X.MathNode(`mn`, [n])
              : e.text === `\\prime`
                ? new X.MathNode(`mo`, [n])
                : new X.MathNode(`mi`, [n]);
      return (r !== gi[i.type] && i.setAttribute(`mathvariant`, r), i);
    },
  }));
...
Qt({
  type: `spacing`,
  htmlBuilder(e, t) {
    if (vi.hasOwnProperty(e.text)) {
      var n = vi[e.text].className || ``;
      if (e.mode === `text`) {
        var r = W.makeOrd(e, t, `textord`);
        return (r.classes.push(n), r);
      } else
        return W.makeSpan([`mspace`, n], [W.mathsym(e.text, e.mode, t)], t);
    } else if (_i.hasOwnProperty(e.text))
      return W.makeSpan([`mspace`, _i[e.text]], [], t);
    else throw new i(`Unknown type of space "` + e.text + `"`);
  },
  mathmlBuilder(e, t) {
    var n;
    if (vi.hasOwnProperty(e.text))
      n = new X.MathNode(`mtext`, [new X.TextNode(`\xA0`)]);
    else if (_i.hasOwnProperty(e.text)) return new X.MathNode(`mspace`);
    else throw new i(`Unknown type of space "` + e.text + `"`);
    return n;
  },
});
...
Qt({
  type: `tag`,
  mathmlBuilder(e, t) {
    var n = new X.MathNode(`mtable`, [
      new X.MathNode(`mtr`, [
        yi(),
        new X.MathNode(`mtd`, [xn(e.body, t)]),
        yi(),
        new X.MathNode(`mtd`, [xn(e.tag, t)]),
      ]),
    ]);
...
var bi = {
  ...
  xi = { "\\textbf": `textbf`, "\\textmd": `textmd` },
  Si = { "\\textit": `textit`, "\\textup": `textup` },
  Ci = (e, t) => {
    var n = e.font;
    return n
      ? bi[n]
        ? t.withTextFontFamily(bi[n])
        : xi[n]
          ? t.withTextFontWeight(xi[n])
          : n === `\\emph`
            ? t.fontShape === `textit`
              ? t.withTextFontShape(`textup`)
              : t.withTextFontShape(`textit`)
            : t.withTextFontShape(Si[n])
      : t;
  };
(K({
  type: `text`,
  ...
  handler(e, t) {
    var { parser: n, funcName: r } = e,
      i = t[0];
    return { type: `text`, mode: n.mode, body: q(i), font: r };
  },
  htmlBuilder(e, t) {
    var n = Ci(e, t),
      r = J(e.body, n, !0);
  ...
  K({
    ...
    htmlBuilder(e, t) {
      var n = Y(e.body, t),
        r = W.makeLineSpan(`underline-line`, t),
        i = t.fontMetrics().defaultRuleThickness,
        a = W.makeVList(
          {
            positionType: `top`,
      ...
      return W.makeSpan([`mord`, `underline`], [a], t);
    },
    mathmlBuilder(e, t) {
      var n = new X.MathNode(`mo`, [new X.TextNode(`‾`)]);
      n.setAttribute(`stretchy`, `true`);
      var r = new X.MathNode(`munder`, [Z(e.body, t), n]);
      return (r.setAttribute(`accentunder`, `true`), r);
    },
  }),
  K({
    ...
    mathmlBuilder(e, t) {
      return new X.MathNode(`mpadded`, [Z(e.body, t)], [`vcenter`]);
    },
  }),
  K({
    type: `verb`,
    ...
    htmlBuilder(e, t) {
      for (
        var n = wi(e), r = [], i = t.havingStyle(t.style.text()), a = 0;
        a < n.length;
        a++
      ) {
        var o = n[a];
        (o === `~` && (o = `\\textasciitilde`),
          r.push(
            W.makeSymbol(o, `Typewriter-Regular`, e.mode, i, [
              `mord`,
              `texttt`,
            ]),
          ));
    ...
    mathmlBuilder(e, t) {
      var n = new X.TextNode(wi(e)),
        r = new X.MathNode(`mtext`, [n]);
      return (r.setAttribute(`mathvariant`, `monospace`), r);
    },
  }));
var wi = (e) => e.body.replace(/ /g, e.star ? `␣` : `\xA0`),
  Ti = Yt,
  Ei = `[ \r
	]`,
  Di = `\\\\[a-zA-Z@]+`,
  ...
  Pi = class {
    constructor(e, t) {
      ((this.input = void 0),
        ...
        (this.input = e),
        (this.settings = t),
        (this.tokenRegex = new RegExp(Ni, `g`)),
        (this.catcodes = { "%": 14, "~": 13 }));
    }
    setCatcode(e, t) {
      this.catcodes[e] = t;
    ...
    lex() {
      ...
      if (t === e.length) return new r(`EOF`, new n(this, t, t));
      var a = this.tokenRegex.exec(e);
      if (a === null || a.index !== t)
        throw new i(
          `Unexpected character: '` + e[t] + `'`,
          new r(e[t], new n(this, t, t + 1)),
        );
      var o = a[6] || a[3] || (a[2] ? `\\ ` : ` `);
...
`,
      ...
      return new r(o, new n(this, t, this.tokenRegex.lastIndex));
    }
  },
  Fi = class {
    constructor(e, t) {
...
$(`\\char`, function (e) {
  ...
  if (n) {
    if (((r = Li[t.text]), r == null || r >= n))
      throw new i(`Invalid base-` + n + ` digit ` + t.text);
    for (var a; (a = Li[e.future().text]) != null && a < n; )
      ((r *= n), (r += a), e.popToken());
  }
  return `\\@char{` + r + `}`;
});
var Ri = (e, t, n, r) => {
  ...
  if (((a = e.consumeArg().tokens), a.length === 1 && a[0].text === `[`)) {
    for (
      var l = ``, u = e.expandNextToken();
      u.text !== `]` && u.text !== `EOF`;
    )
      ((l += u.text), (u = e.expandNextToken()));
    if (!l.match(/^\s*[0-9]+\s*$/))
      throw new i(`Invalid number of arguments: ` + l);
    ((c = parseInt(l)), (a = e.consumeArg().tokens));
  }
  return ((s && r) || e.macros.set(o, { tokens: a, numArgs: c }), ``);
};
($(`\\newcommand`, (e) => Ri(e, !1, !0, !1)),
  $(`\\renewcommand`, (e) => Ri(e, !0, !1, !1)),
  $(`\\providecommand`, (e) => Ri(e, !0, !0, !0)),
  $(`\\message`, (e) => {
  ...
  $(`\\show`, (e) => {
    var t = e.popToken(),
      n = t.text;
    return (console.log(t, e.macros.get(n), Ti[n], A.math[n], A.text[n]), ``);
  }),
  $(`\\bgroup`, `{`),
  $(`\\egroup`, `}`),
  $(`~`, `\\nobreakspace`),
...
$(`\\dots`, function (e) {
  ...
  return (
    n in zi
      ? (t = zi[n])
      : (n.slice(0, 4) === `\\not` ||
          (n in A.math && [`bin`, `rel`].includes(A.math[n].group))) &&
        (t = `\\dotsb`),
    t
  );
});
...
($(`\\dotso`, function (e) {
  return e.future().text in Bi ? `\\ldots\\,` : `\\ldots`;
}),
  $(`\\dotsc`, function (e) {
    var t = e.future().text;
    return t in Bi && t !== `,` ? `\\ldots\\,` : `\\ldots`;
  }),
  $(`\\cdots`, function (e) {
    return e.future().text in Bi ? `\\@cdots\\,` : `\\@cdots`;
  }),
  $(`\\dotsb`, `\\cdots`),
  $(`\\dotsm`, `\\cdots`),
  $(`\\dotsi`, `\\!\\cdots`),
...
var Vi = k(we[`Main-Regular`][84][1] - 0.7 * we[`Main-Regular`][65][1]);
($(
  `\\LaTeX`,
  `\\textrm{\\html@mathml{` +
    (`L\\kern-.36em\\raisebox{` + Vi + `}{\\scriptstyle A}`) +
    `\\kern-.15em\\TeX}{LaTeX}}`,
),
  $(
    `\\KaTeX`,
    `\\textrm{\\html@mathml{` +
      (`K\\kern-.17em\\raisebox{` + Vi + `}{\\scriptstyle A}`) +
      `\\kern-.15em\\TeX}{KaTeX}}`,
  ),
  ...
  Wi = class {
    constructor(e, t, n) {
      ((this.settings = void 0),
        ...
        this.feed(e),
        (this.macros = new Fi(Ii, t.macros)),
        (this.mode = n),
        (this.stack = []));
    }
    feed(e) {
      this.lexer = new Pi(e, this.settings);
    }
    switchMode(e) {
      this.mode = e;
    }
    ...
    scanArgument(e) {
      ...
      if (e) {
        ...
        ((t = this.popToken()),
          ({ tokens: a, end: i } = this.consumeArg([`]`])));
      } else ({ tokens: a, start: t, end: i } = this.consumeArg());
      return (
        this.pushToken(new r(`EOF`, i.loc)),
        this.pushTokens(a),
        new r(``, n.range(t, i))
      );
    }
    ...
    consumeArg(e) {
      ...
      return (
        r.text === `{` && t[t.length - 1].text === `}` && (t.pop(), t.shift()),
        t.reverse(),
        { tokens: t, start: r, end: a }
      );
    }
    consumeArgs(e, t) {
      if (t) {
        ...
        for (var n = t[0], r = 0; r < n.length; r++) {
          var a = this.popToken();
          if (n[r] !== a.text)
            throw new i(`Use of the macro doesn't match its definition`, a);
        }
      }
      for (var o = [], s = 0; s < e; s++)
    ...
    expandOnce(e) {
      ...
      if (r == null || (e && r.unexpandable)) {
        if (e && r == null && n[0] === `\\` && !this.isDefined(n))
          throw new i(`Undefined control sequence: ` + n);
        return (this.pushToken(t), !1);
      }
      this.countExpansion(1);
      var a = r.tokens,
        o = this.consumeArgs(r.numArgs, r.delimiters);
      if (r.numArgs) {
        a = a.slice();
        for (var s = a.length - 1; s >= 0; --s) {
          ...
          if (c.text === `#`) {
            ...
            else throw new i(`Not a valid argument number`, c);
          }
        }
      }
      ...
      if (typeof r == `string`) {
        ...
        if (r.indexOf(`#`) !== -1)
          for (var a = r.replace(/##/g, ``); a.indexOf(`#` + (i + 1)) !== -1; )
            ++i;
        for (
          var o = new Pi(r, this.settings), s = [], c = o.lex();
          c.text !== `EOF`;
        )
          (s.push(c), (c = o.lex()));
    ...
    isDefined(e) {
      return (
        this.macros.has(e) ||
        Ti.hasOwnProperty(e) ||
        A.math.hasOwnProperty(e) ||
        A.text.hasOwnProperty(e) ||
        Ui.hasOwnProperty(e)
      );
    }
    isExpandable(e) {
      var t = this.macros.get(e);
      return t == null
        ? Ti.hasOwnProperty(e) && !Ti[e].primitive
        : typeof t == `string` || typeof t == `function` || !t.unexpandable;
    }
  },
  Gi = /^[₊₋₌₍₎₀₁₂₃₄₅₆₇₈₉ₐₑₕᵢⱼₖₗₘₙₒₚᵣₛₜᵤᵥₓᵦᵧᵨᵩᵪ]/,
  Ki = Object.freeze({
    "₊": `+`,
    "₋": `-`,
    "₌": `=`,
  ...
  Yi = class e {
    constructor(e, t) {
      ((this.mode = void 0),
        ...
        (this.mode = `math`),
        (this.gullet = new Wi(e, t, this.mode)),
        (this.settings = t),
        ...
        return (
          ...
          (o =
            c.length === 1 && c[0].type === `ordgroup`
              ? c[0]
              : { type: `ordgroup`, mode: this.mode, body: c }),
          [
            n === `\\\\abovefrac`
              ? this.callFunction(n, [a, e[t], o], [])
    ...
    parseAtom(e) {
      ...
      for (var n, a; ; ) {
        ...
        if (o.text === `\\limits` || o.text === `\\nolimits`) {
          if (t && t.type === `op`)
            ((t.limits = o.text === `\\limits`), (t.alwaysHandleSupSub = !0));
          else if (t && t.type === `operatorname`)
            t.alwaysHandleSupSub && (t.limits = o.text === `\\limits`);
          else throw new i(`Limit controls must follow a math operator`, o);
          this.consume();
        } else if (o.text === `^`) {
          if (n) throw new i(`Double superscript`, o);
          n = this.handleSupSubscript(`superscript`);
        } else if (o.text === `_`) {
          if (a) throw new i(`Double subscript`, o);
          ...
          (this.fetch().text === `^` &&
            ...
            (n = { type: `ordgroup`, mode: this.mode, body: c }));
        } else if (Ki[o.text]) {
          var l = Gi.test(o.text),
            u = [];
          for (u.push(new r(Ki[o.text])), this.consume(); ; ) {
            var d = this.fetch().text;
            if (!Ki[d] || Gi.test(d) !== l) break;
            (u.unshift(new r(Ki[d])), this.consume());
          }
          var f = this.subparse(u);
          l
            ? (a = { type: `ordgroup`, mode: `math`, body: f })
            : (n = { type: `ordgroup`, mode: `math`, body: f });
        } else break;
      }
      return n || a
    ...
    parseFunction(e, t) {
      ...
      if ((this.consume(), t && t !== `atom` && !a.allowedInArgument))
        throw new i(
          `Got function '` + r + `' with no arguments` + (t ? ` as ` + t : ``),
          n,
        );
      if (this.mode === `text` && !a.allowedInText)
        throw new i(`Can't use function '` + r + `' in text mode`, n);
      if (this.mode === `math` && a.allowedInMath === !1)
        throw new i(`Can't use function '` + r + `' in math mode`, n);
      var { args: o, optArgs: s } = this.parseArguments(r, a);
      return this.callFunction(r, o, s, n, e);
    }
    callFunction(e, t, n, r, a) {
      var o = { funcName: e, parser: this, token: r, breakOnTokenText: a },
        s = Ti[e];
    ...
    parseGroupOfType(e, t, n) {
      switch (t) {
        ...
        case `primitive`:
          ...
          if (o == null) throw new i(`Expected group as ` + e, this.fetch());
          return o;
        case `original`:
        case null:
        case void 0:
    ...
    parseRegexGroup(e, t) {
      for (
        var n = this.fetch(), r = n, a = ``, o;
        (o = this.fetch()).text !== `EOF` && e.test(a + o.text);
      )
        ((r = o), (a += r.text), this.consume());
      if (a === ``) throw new i(`Invalid ` + t + `: '` + n.text + `'`, n);
      return n.range(r, a);
    }
    parseColorGroup(e) {
    ...
    parseSizeGroup(e) {
      ...
      if (!Le(a)) throw new i(`Invalid unit: '` + a.unit + `'`, t);
    ...
    parseGroup(e, t) {
      ...
      if (a === `{` || a === `\\begingroup`) {
        ...
        var c = this.parseExpression(!1, s),
          l = this.fetch();
        (this.expect(s),
        ...
        ((o = this.parseFunction(t, e) || this.parseSymbol()),
        o == null && a[0] === `\\` && !Ui.hasOwnProperty(a))
      ) {
    ...
    parseSymbol() {
      ...
      if (A[this.mode][t]) {
        ...
        var c = A[this.mode][t].group,
          l = n.range(e),
          u;
        if ($e.hasOwnProperty(c)) {
          var d = c;
          u = { type: `atom`, mode: this.mode, family: d, loc: l, text: t };
        } else u = { type: c, mode: this.mode, loc: l, text: t };
        s = u;
        ...
        (this.settings.strict &&
          ...
          (s = { type: `textord`, mode: `text`, loc: n.range(e), text: t }));
      else return null;
      if ((this.consume(), o))
        for (var f = 0; f < o[0].length; f++) {
          var p = o[0][f];
          if (!qi[p]) throw new i(`Unknown accent ' ` + p + `'`, e);
          var m = qi[p][this.mode] || qi[p].text;
          if (!m)
            throw new i(
...
Yi.endOfExpression = [`}`, `\\endgroup`, `\\end`, `\\right`, `&`];
var Xi = function (e, t) {
...
var Qi = function (e, t) {
  ...
  ea = function (e, t, n) {
    ...
    var r = W.makeSpan([`katex-error`], [new qe(t)]);
    return (
