import { l as e, n as t, o as n, r, t as i } from "./src-BAB06iur.js";
import { i as a, n as o, r as s, t as c } from "./defaultLocale-DDc-wkW1.js";
import { t as l } from "./init-6zo3nO5-.js";
function u(e, t) {
...
function f(e) {
  let t, n, r;
  e.length === 2
    ? ((t = e === u || e === d ? e : p), (n = e), (r = e))
    : ((t = u), (n = (t, n) => u(e(t), n)), (r = (t, n) => e(t) - n));
...
function M(e, t) {
  return Math.max(
    0,
    Math.max(-8, Math.min(8, Math.floor(a(t) / 3))) * 3 - a(Math.abs(e)),
  );
}
function N(e, t) {
  return (
...
function B(e, t, n) {
  var r = e[0],
    ...
    o = t[1];
  return (
    i < r ? ((r = R(i, r)), (a = n(o, a))) : ((r = R(r, i)), (a = n(a, o))),
    function (e) {
      return a(r(e));
    }
  );
...
function V(e, t, n) {
  ...
  for (
    ...
    ((i[o] = R(e[o], e[o + 1])), (a[o] = n(t[o], t[o + 1])));
  return function (t) {
    var n = g(e, t, 1, r) - 1;
    return a[n](i[n](t));
  };
...
function G(e, t, n, r) {
  ...
  switch (((r = s(r ?? `,f`)), r.type)) {
    case `s`:
      ...
      return (
        r.precision == null && !isNaN((a = M(i, l))) && (r.precision = a),
        o(r, l)
      );
    case ``:
    case `e`:
    ...
    case `r`:
      r.precision == null &&
        !isNaN((a = N(i, Math.max(Math.abs(e), Math.abs(t))))) &&
