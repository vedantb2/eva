...
/**
 * Chrome launch flags for Vercel Xvnc :1 (and legacy Xvfb :0).
 ...
 * exits (same failure mode as Xvnc/websockify). Provider execDetached is a
  ...
  try {
    ...
    await sandbox.exec(
      [
        ...
        // Resolve display: Vercel Xvnc is :1, legacy Xvfb is :0.
