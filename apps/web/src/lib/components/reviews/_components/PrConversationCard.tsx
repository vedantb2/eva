...
export function PrConversationCard({
  ...
  return (
    <section className="space-y-2">
      ...
      {comments.length === 0 ? (
        <p className="rounded-lg bg-card p-3 text-sm text-muted-foreground smooth-shadow-ring-sm">
          No comments yet.
        </p>
      ) : (
        <ul className="space-y-2">
          {comments.map((comment) => (
            <li
              ...
              className="overflow-hidden rounded-lg bg-card smooth-shadow-ring-sm"
            >
