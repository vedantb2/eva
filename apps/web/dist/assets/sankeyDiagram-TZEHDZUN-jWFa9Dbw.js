...
function P() {
  ...
  ((m.update = function (e) {
    ...
    (m.nodeId = function (e) {
      return arguments.length
        ? ((s = typeof e == `function` ? e : w(e)), m)
        : s;
    }),
    (m.nodeAlign = function (e) {
      return arguments.length
        ? ((c = typeof e == `function` ? e : w(e)), m)
        : c;
    }),
    ...
    (m.nodes = function (e) {
      return arguments.length
        ? ((d = typeof e == `function` ? e : w(e)), m)
        : d;
    }),
    (m.links = function (e) {
      return arguments.length
        ? ((f = typeof e == `function` ? e : w(e)), m)
        : f;
    }),
  ...
  function h({ nodes: e, links: t }) {
    ...
    for (let [e, r] of t.entries()) {
      ...
      (typeof t != `object` && (t = r.source = M(n, t)),
        typeof i != `object` && (i = r.target = M(n, i)),
  ...
  function y({ nodes: e }) {
    for (let t of e)
      t.value =
        t.fixedValue === void 0
          ? Math.max(v(t.sourceLinks, O), v(t.targetLinks, O))
          : t.fixedValue;
  }
  function b({ nodes: e }) {
    let t = e.length,
  ...
  function H(e) {
    if (u === void 0)
      for (let { sourceLinks: t, targetLinks: n } of e) (t.sort(E), n.sort(T));
  }
  function U(e, t) {
...
z.prototype = B.prototype = {
  ...
  arc: function (e, t, n, r, i, a) {
    ...
    (this._x1 === null
      ? (this._ += `M` + c + `,` + l)
      : (Math.abs(this._x1 - c) > L || Math.abs(this._y1 - l) > L) &&
        (this._ += `L` + c + `,` + l),
      n &&
        (d < 0 && (d = (d % I) + I),
        d > R
...
function K(e) {
  ...
  return (
    ...
    (o.x = function (e) {
      return arguments.length
        ? ((r = typeof e == `function` ? e : V(+e)), o)
        : r;
    }),
    (o.y = function (e) {
      return arguments.length
        ? ((i = typeof e == `function` ? e : V(+e)), o)
        : i;
    }),
...
var Y = J,
  ...
  le = {
    nodesMap: Q,
    getConfig: e(() => c().sankey, `getConfig`),
    getNodes: e(() => Z, `getNodes`),
    getLinks: e(() => X, `getLinks`),
    getGraph: e(
      () => ({
  ...
  ue = { left: b, right: x, center: C, justify: S },
  de = {
    draw: e(function (n, r, a, o) {
      let { securityLevel: s, sankey: l } = c(),
        d = u.sankey,
        f;
      s === `sandbox` && (f = t(`#i` + r));
      let m = t(s === `sandbox` ? f.nodes()[0].contentDocument.body : `body`),
        g = s === `sandbox` ? m.select(`[id="${r}"]`) : t(`[id="${r}"]`),
        _ = l?.width ?? d.width,
        v = l?.height ?? d.width,
        y = l?.useMaxWidth ?? d.useMaxWidth,
        b = l?.nodeAlignment ?? d.nodeAlignment,
        x = l?.prefix ?? d.prefix,
        S = l?.suffix ?? d.suffix,
        C = l?.showValues ?? d.showValues,
        w = o.db.getGraph(),
        T = ue[b];
      P()
        .nodeId((e) => e.id)
...
${x}${Math.round(t * 100) / 100}${S}`
      ...
      let O = g
        ...
        k = l?.linkColor ?? `gradient`;
      if (k === `gradient`) {
        let e = O.append(`linearGradient`)
          .attr(`id`, (e) => (e.uid = $.next(`linearGradient-`)).id)
...
`,
  ...
  me = Y.parse.bind(Y);
Y.parse = (e) => me(fe(e));
var he = { styles: pe, parser: Y, db: le, renderer: de };
