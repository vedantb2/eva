...
import { b as r, h as i } from "./chunk-ABZYJK2D-BcBvUh_0.js";
import {
  B as a,
  F as o,
  G as s,
...
import { t as v } from "./line-xAZ3WWpC.js";
import { n as y, r as b, t as x } from "./chunk-HN2XXSSU-C17-XOpQ.js";
import { t as S } from "./chunk-CVBHYZKI-pVtBnPKQ.js";
import { i as C, n as w } from "./chunk-ATLVNIR6-BjpTnV3z.js";
import { n as T } from "./chunk-JA3XYJ7Z-ByUEKWPH.js";
import { d as E, r as D } from "./chunk-JZLCHNYA-DexENr_S.js";
var ee = t((e, t, n, r, i, a) => {
  ...
  P = t(async (t, a) => {
    let o = i(r().flowchart.htmlLabels),
      { labelStyles: s } = C(a);
    a.labelStyle = s;
    ...
    let l = t.insert(`g`).attr(`class`, `edgeLabel`),
      u = l.insert(`g`).attr(`class`, `label`).attr(`data-id`, a.id);
    ...
    let f;
    if (a.startLabelLeft) {
      let e = await D(a.startLabelLeft, N(a.labelStyle)),
        n = t.insert(`g`).attr(`class`, `edgeTerminals`),
        r = n.insert(`g`).attr(`class`, `inner`);
      ...
      (r.attr(
        ...
        j.get(a.id) || j.set(a.id, {}),
        (j.get(a.id).startLeft = n),
        F(f, a.startLabelLeft));
    }
    if (a.startLabelRight) {
      let e = await D(a.startLabelRight, N(a.labelStyle)),
        n = t.insert(`g`).attr(`class`, `edgeTerminals`),
        r = n.insert(`g`).attr(`class`, `inner`);
      ...
      (r.attr(
        ...
        j.get(a.id) || j.set(a.id, {}),
        (j.get(a.id).startRight = n),
        F(f, a.startLabelRight));
    }
    if (a.endLabelLeft) {
      let e = await D(a.endLabelLeft, N(a.labelStyle)),
        n = t.insert(`g`).attr(`class`, `edgeTerminals`),
        r = n.insert(`g`).attr(`class`, `inner`);
      f = r.node().appendChild(e);
      let i = e.getBBox();
      (r.attr(
        ...
        j.get(a.id) || j.set(a.id, {}),
        (j.get(a.id).endLeft = n),
        F(f, a.endLabelLeft));
    }
    if (a.endLabelRight) {
      let e = await D(a.endLabelRight, N(a.labelStyle)),
        n = t.insert(`g`).attr(`class`, `edgeTerminals`),
        r = n.insert(`g`).attr(`class`, `inner`);
      f = r.node().appendChild(e);
      let i = e.getBBox();
...
var I = t((t, n) => {
    ...
    let i = n.updatedPath ? n.updatedPath : n.originalPath,
      { subGraphTitleTotalMargin: a } = S(r());
    if (t.label) {
      let r = A.get(t.id),
        o = t.x,
        s = t.y;
      if (i) {
        ...
        (e.debug(
          ...
          n.updatedPath && ((o = r.x), (s = r.y)));
      }
      r.attr(`transform`, `translate(${o}, ${s + a / 2})`);
    }
    if (t.startLabelLeft) {
      let e = j.get(t.id).startLeft,
        n = t.x,
        r = t.y;
      if (i) {
        let e = g.calcTerminalLabelPosition(
...
var V = t(function (e, t, n) {
  ...
  H = t(function (t) {
    let { cornerPointPositions: n } = B(t),
      r = [];
  ...
  W = t(function (t, i, y, S, C, T, D, O = !1) {
    let { handDrawnSeed: k } = r(),
      A = i.points,
      j = !1,
      M = C;
    var N = T;
    ...
    (e.debug(`UIO intersect check`, i.points, N.x, M.x),
      N.intersect &&
        M.intersect &&
        !O &&
        ((A = A.slice(1, i.points.length - 1)),
    ...
    (i.toCluster &&
      (e.info(`to cluster abc88`, y.get(i.toCluster)),
      (A = z(i.points, y.get(i.toCluster).node)),
      (j = !0)),
      i.fromCluster &&
        (e.debug(
          `from cluster abc88`,
        ...
        (A = z(A.reverse(), y.get(i.fromCluster).node).reverse()),
        (j = !0)));
    ...
    let K,
      J = i.curve === `rounded` ? G(q(I, i), 5) : V(I),
      Y = Array.isArray(i.style) ? i.style : [i.style],
      X = Y.find((e) => e?.startsWith(`stroke:`)),
      Z = !1;
    if (i.look === `handDrawn`) {
      let e = E.svg(t);
      Object.assign([], I);
      let r = e.path(J, { roughness: 0.3, seed: k });
      ((W += ` transition`),
        (K = n(r)
          .select(`path`)
          .attr(`id`, i.id)
          .attr(`class`, ` ` + W + (i.classes ? ` ` + i.classes : ``))
          .attr(`style`, Y ? Y.reduce((e, t) => e + `;` + t, ``) : ``)));
      let a = K.attr(`d`);
      (K.attr(`d`, a), t.node().appendChild(K.node()));
    } else {
      let e = P.join(`;`),
        n = Y ? Y.reduce((e, t) => e + t + `;`, ``) : ``,
        r = ``;
      (i.animate && (r = ` edge-animation-fast`),
        i.animation && (r = ` edge-animation-` + i.animation));
      let a =
        (e ? e + `;` + n + `;` : n) +
        `;` +
        (Y ? Y.reduce((e, t) => e + `;` + t, ``) : ``);
      ((K = t
        ...
        .attr(`d`, J)
        .attr(`id`, i.id)
        .attr(`class`, ` ` + W + (i.classes ? ` ` + i.classes : ``) + (r ?? ``))
        .attr(`style`, a)),
        (X = a.match(/stroke:([^;]+)/)?.[1]),
        (Z = i.animate === !0 || !!i.animation || e.includes(`animation`)));
      let o = K.node(),
        s = typeof o.getTotalLength == `function` ? o.getTotalLength() : 0,
        c = b[i.arrowTypeStart] || 0,
        l = b[i.arrowTypeEnd] || 0;
      if (i.look === `neo` && !Z) {
    ...
    let Q = ``;
    ((r().flowchart.arrowMarkerAbsolute || r().state.arrowMarkerAbsolute) &&
      ((Q =
      ...
      e.info(`arrowTypeStart`, i.arrowTypeStart),
      e.info(`arrowTypeEnd`, i.arrowTypeEnd),
      ee(K, i, Q, D, S, X));
