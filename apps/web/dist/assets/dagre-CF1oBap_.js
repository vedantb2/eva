import {
  ...
  x as s,
  y as c,
} from "./chunk-S3R3BYOJ-qZRxmO84.js";
import {
  E as l,
  O as u,
  T as d,
...
import { i as ie, n as ae } from "./isEmpty-D802w2WA.js";
import {
  E as g,
  _ as oe,
  c as _,
...
import {
  ...
  r as be,
  t as w,
} from "./flatten-CUhNQmdn.js";
import { i as xe, n as T, r as E, t as D } from "./graphlib-BolwGYrB.js";
var Se = /\s/;
function Ce(e) {
...
var Ve = function () {
  ...
  We = c(function (t, n) {
    ...
    var r = -1,
      i = n.length,
      a = i > 2 ? n[2] : void 0;
    for (a && o(n[0], n[1], a) && (i = 1); ++r < i; )
      for (var s = n[r], c = e(s), l = -1, u = c.length; ++l < u; ) {
        var d = c[l],
          f = t[d];
...
var ct = se(`length`),
  ...
  vt = pt + `?`,
  yt = `[` + dt + `]?`,
  bt = `(?:` + _t + `(?:` + [mt, ht, gt].join(`|`) + `)` + yt + vt + `)*`,
  xt = yt + vt + bt,
  St = `(?:` + [mt + P + `?`, P, ht, gt, ft].join(`|`) + `)`,
  Ct = RegExp(F + `(?=` + F + `)|` + St + xt, `g`);
function wt(e) {
...
var I = Fe(function (e, t) {
  ...
  Ot = Math.max;
function kt(e, t, n, r) {
  for (var i = -1, a = Ot(Dt((t - e) / (n || 1)), 0), o = Array(a); a--; )
    ((o[r ? a : ++i] = e), (e += n));
  return o;
}
function At(e) {
  return function (t, n, r) {
    return (
      r && typeof r != `number` && o(t, n, r) && (n = r = void 0),
      (t = O(t)),
      n === void 0 ? ((n = t), (t = 0)) : (n = O(n)),
      (r = r === void 0 ? (t < n ? 1 : -1) : O(r)),
      kt(t, n, r, e)
    );
  };
}
...
var Lt = class {
  ...
  toString() {
    for (var e = [], t = this._sentinel, n = t._prev; n !== t; )
      (e.push(JSON.stringify(n, zt)), (n = n._prev));
    return `[` + e.join(`, `) + `]`;
  }
};
function Rt(e) {
...
function Vt(e, t) {
  ...
  var n = Ut(e, t || Bt);
  return w(
    S(Ht(n.graph, n.buckets, n.zeroIdx), function (t) {
...
function B(e, t, n, r, i) {
  var a = i ? [] : void 0;
  return (
    y(e.inEdges(r.v), function (r) {
      var o = e.edge(r),
        s = e.node(r.v);
      (i && a.push({ v: r.v, w: r.w }), (s.out -= o), V(t, n, s));
    }),
...
function rn(e) {
  function t(n) {
    var r = e.children(n),
      i = e.node(n);
    if (
      (r.length && y(r, t), Object.prototype.hasOwnProperty.call(i, `minRank`))
    ) {
      ((i.borderLeft = []), (i.borderRight = []));
      for (var a = i.minRank, o = i.maxRank + 1; a < o; ++a)
        (an(e, `borderLeft`, `_bl`, n, i, a),
          an(e, `borderRight`, `_br`, n, i, a));
    }
  }
  y(e.children(), t);
}
...
function hn(e) {
  var t = new D({ directed: !1 }),
    ...
    r = e.nodeCount();
  t.setNode(n, {});
  for (var i, a; gn(t, e) < r; )
    ((i = _n(t, e)), (a = t.hasNode(i.v) ? q(e, i) : -q(e, i)), vn(t, e, a));
  return t;
}
function gn(e, t) {
  function n(r) {
...
function Xn(e) {
  ...
  function n(e) {
    return function (t) {
      t.merged ||
        ((T(t.barycenter) || T(e.barycenter) || t.barycenter >= e.barycenter) &&
          Zn(e, t));
    };
  }
  function r(t) {
...
function tr(e, t, n, r) {
  ...
  y(l, function (t) {
    if (e.children(t.v).length) {
      var i = tr(e, t.v, n, r);
      ((c[t.v] = i),
        Object.prototype.hasOwnProperty.call(i, `barycenter`) && rr(t, i));
    }
  });
  var u = Yn(l, n);
  nr(u, c);
  var d = Qn(u, r);
  if (o && ((d.vs = w([o, d.vs, s])), e.predecessors(o).length)) {
    var f = e.node(e.predecessors(o)[0]),
      p = e.node(e.predecessors(s)[0]);
    (Object.prototype.hasOwnProperty.call(d, `barycenter`) ||
      ((d.barycenter = 0), (d.weight = 0)),
      (d.barycenter =
        (d.barycenter * d.weight + f.order + p.order) / (d.weight + 2)),
      (d.weight += 2));
  }
  return d;
}
...
function ir(e) {
  var t = $t(e),
    n = ar(e, L(1, t + 1), `inEdges`),
    r = ar(e, L(t - 1, -1, -1), `outEdges`),
    i = qn(e);
  sr(e, i);
...
function ur(e) {
  ...
  function r(i) {
    var a = n;
    (y(e.children(i), r), (t[i] = { low: a, lim: n++ }));
  }
    ...
    y([`u`, `d`], function (i) {
      ((a = i === `u` ? t : E(t).reverse()),
        y([`l`, `r`], function (t) {
          ...
          var o = (i === `u` ? e.predecessors : e.successors).bind(e),
            s = gr(e, a, n, o),
            c = _r(e, a, s.root, s.align, t === `r`);
          (t === `r` &&
            (c = j(c, function (e) {
              return -e;
            })),
...
function Or(e, t) {
  (t(`    makeSpaceForEdgeLabels`, () => zr(e)),
    t(`    removeSelfEdges`, () => Jr(e)),
    t(`    acyclic`, () => Wt(e)),
    t(`    nestingGraph.run`, () => Ln(e)),
    t(`    rank`, () => Nn(Jt(e))),
    t(`    injectEdgeLabelProxies`, () => Br(e)),
    t(`    removeEmptyRanks`, () => Zt(e)),
    t(`    nestingGraph.cleanup`, () => Vn(e)),
    t(`    normalizeRanks`, () => Xt(e)),
    t(`    assignRankMinMax`, () => Vr(e)),
    t(`    removeEdgeLabelProxies`, () => Hr(e)),
    t(`    normalize.run`, () => fn(e)),
    t(`    parentDummyChains`, () => cr(e)),
    t(`    addBorderSegments`, () => rn(e)),
    t(`    order`, () => ir(e)),
    t(`    insertSelfEdges`, () => Yr(e)),
    t(`    adjustCoordinateSystem`, () => on(e)),
    t(`    position`, () => Tr(e)),
    t(`    positionSelfEdges`, () => Xr(e)),
    t(`    removeBorderNodes`, () => qr(e)),
    t(`    normalize.undo`, () => mn(e)),
    t(`    fixupEdgeLabelCoords`, () => Gr(e)),
    t(`    undoCoordinateSystem`, () => sn(e)),
    t(`    translateGraph`, () => Ur(e)),
    t(`    assignNodeIntersects`, () => Wr(e)),
    t(`    reversePoints`, () => Kr(e)),
    t(`    acyclic.undo`, () => Kt(e)));
}
function kr(e, t) {
  (y(e.nodes(), function (n) {
...
var Ar = [`nodesep`, `edgesep`, `ranksep`, `marginx`, `marginy`],
  jr = { ranksep: 50, edgesep: 20, nodesep: 50, rankdir: `tb` },
  Mr = [`acyclicer`, `ranker`, `rankdir`, `align`],
  Nr = [`width`, `height`],
  Pr = { width: 0, height: 0 },
  Fr = [`minlen`, `weight`, `width`, `height`, `labeloffset`],
  Ir = {
    minlen: 1,
    weight: 1,
    width: 0,
...
function Wr(e) {
  y(e.edges(), function (t) {
    ...
    (n.points
      ...
      : ((n.points = []), (a = i), (o = r)),
      n.points.unshift(Yt(r, a)),
      n.points.push(Yt(i, o)));
  });
}
function Gr(e) {
  y(e.edges(), function (t) {
  ...
  (y(e.nodes(), function (t) {
    if (e.children(t).length) {
      var n = e.node(t),
        ...
        a = e.node(k(n.borderLeft)),
        o = e.node(k(n.borderRight));
