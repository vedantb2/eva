...
function u(e, n) {
  ...
  var i = r[0],
    a = r[1],
    o = a - (l = Math.max(-8, Math.min(8, Math.floor(a / 3))) * 3) + 1,
    s = i.length;
  return o === s
    ? i
    : o > s
...
function g(e) {
  var t =
      e.grouping === void 0 || e.thousands === void 0
        ? p
        : r(m.call(e.grouping, Number), e.thousands + ``),
    a = e.currency === void 0 ? `` : e.currency[0] + ``,
    s = e.currency === void 0 ? `` : e.currency[1] + ``,
    u = e.decimal === void 0 ? `.` : e.decimal + ``,
    d = e.numerals === void 0 ? p : i(m.call(e.numerals, String)),
    g = e.percent === void 0 ? `%` : e.percent + ``,
    _ = e.minus === void 0 ? `−` : e.minus + ``,
  ...
  function y(e, n) {
    ...
    (w === `n`
      ? ((x = !0), (w = `g`))
      : f[w] || (S === void 0 && (S = 12), (C = !0), (w = `g`)),
      (y || (r === `0` && i === `=`)) && ((y = !0), (r = `0`), (i = `=`)));
    var T =
        (n && n.prefix !== void 0 ? n.prefix : ``) +
        (m === `$`
          ? a
          : m === `#` && /[boxX]/.test(w)
            ? `0` + w.toLowerCase()
    ...
    function k(e) {
      ...
      if (w === `c`) ((a = D(e) + a), (e = ``));
        ...
        var m = e < 0 || 1 / e < 0;
        if (
          ((e = isNaN(e) ? v : D(Math.abs(e), S)),
          C && (e = c(e)),
          m && +e == 0 && p !== `+` && (m = !1),
          (n = (m ? (p === `(` ? p : _) : p === `-` || p === `(` ? `` : p) + n),
          (a =
            (w === `s` && !isNaN(e) && l !== void 0 ? h[8 + l / 3] : ``) +
            a +
            (m && p === `(` ? `)` : ``)),
          O)
        ) {
          for (o = -1, s = e.length; ++o < s; )
            if (((f = e.charCodeAt(o)), 48 > f || f > 57)) {
              ((a = (f === 46 ? u + e.slice(o + 1) : e.slice(o)) + a),
                (e = e.slice(0, o)));
              break;
            }
        }
      ...
      x && !y && (e = t(e, 1 / 0));
      var g = n.length + e.length + a.length,
        k = g < b ? Array(b - g + 1).join(r) : ``;
      switch (
        (x && y && ((e = t(k + e, k.length ? b - a.length : 1 / 0)), (k = ``)),
        i)
      ) {
        case `<`:
          e = n + e + a + k;
  ...
  function b(e, t) {
    var r = Math.max(-8, Math.min(8, Math.floor(n(t) / 3))) * 3,
      i = 10 ** -r,
      a = y(((e = o(e)), (e.type = `f`), e), { suffix: h[8 + r / 3] });
    return function (e) {
      return a(i * e);
    };
  }
  return { format: y, formatPrefix: b };
}
var _, v, y;
