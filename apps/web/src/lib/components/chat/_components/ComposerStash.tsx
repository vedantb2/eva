  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="reveal-on-hover hit-target shrink-0 rounded-md p-1 text-muted-foreground hover:bg-muted hover:text-foreground"
        onClick={(event) => {
        ...
        >
          {entries.length > 0 ? (
            <m.button
              ...
              className="hit-target inline-flex h-7 items-center gap-1 rounded-md bg-muted px-2 text-xs text-muted-foreground hover:bg-muted/80 hover:text-foreground"
